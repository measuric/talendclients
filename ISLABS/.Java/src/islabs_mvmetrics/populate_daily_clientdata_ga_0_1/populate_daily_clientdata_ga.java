...
package islabs_mvmetrics.populate_daily_clientdata_ga_0_1;
...
/**
 * Job: populate_daily_clientdata_ga Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.3.1.r104014
 * @status 
 */
public class populate_daily_clientdata_ga implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (CONNHOST != null) {
				...
				this.setProperty("CONNHOST", CONNHOST.toString());
	...
	private final String jobName = "populate_daily_clientdata_ga";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					populate_daily_clientdata_ga.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(populate_daily_clientdata_ga.this,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				 ...
				 * 
				 * 
				 * System.out.println("Start Date : "+context.START_DATE);
				 * System.out.println("End Date : "+ context.END_DATE);
				 */
				...
				context.END_DATE = TalendDate.formatDate("yyyy-MM-dd",
						TalendDate.getCurrentDate());
				System.out.println("startdate : " + context.START_DATE);
				System.out.println("enddate : " + context.START_DATE);
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_ISLABS_MVMETRICS_populate_daily_clientdata_ga = new byte[0];
		static byte[] commonByteArray_ISLABS_MVMETRICS_populate_daily_clientdata_ga = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ISLABS_MVMETRICS_populate_daily_clientdata_ga.length) {
					if (length < 1024
							&& commonByteArray_ISLABS_MVMETRICS_populate_daily_clientdata_ga.length == 0) {
						commonByteArray_ISLABS_MVMETRICS_populate_daily_clientdata_ga = new byte[1024];
					} else {
						commonByteArray_ISLABS_MVMETRICS_populate_daily_clientdata_ga = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_ISLABS_MVMETRICS_populate_daily_clientdata_ga,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ISLABS_MVMETRICS_populate_daily_clientdata_ga) {
				...
				try {
					...
					this.gaprofileid = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.gaprofileid, dos);
		...
		public String toString() {
			...
			sb.append(",gaprofileid=" + gaprofileid);
			sb.append("]");
	...
	public void tMysqlInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_2 = "SELECT    `daily_jobs_ga`.`profileid`,    `daily_jobs_ga`.`gaprofileid` FROM `daily_jobs_ga`";
				...
				while (rs_tMysqlInput_2.next()) {
					...
					if (colQtyInRs_tMysqlInput_2 < column_index_tMysqlInput_2) {
						...
						if (tmpContent_tMysqlInput_2 != null) {
							row1.profileid = tmpContent_tMysqlInput_2;
						} else {
							row1.profileid = null;
						}
					...
					if (colQtyInRs_tMysqlInput_2 < column_index_tMysqlInput_2) {
						...
						tmpContent_tMysqlInput_2 = rs_tMysqlInput_2
								.getString(column_index_tMysqlInput_2);
						if (tmpContent_tMysqlInput_2 != null) {
							row1.gaprofileid = tmpContent_tMysqlInput_2;
						} else {
							row1.gaprofileid = null;
						}
					...
					globalMap.put("row1.profileid", row1.profileid);
					nb_line_tFlowToIterate_1++;
					globalMap.put("row1.gaprofileid", row1.gaprofileid);
					nb_line_tFlowToIterate_1++;
					...
					parentContextMap_tRunJob_1.put("START_DATE",
							context.START_DATE);
					parentContextMap_tRunJob_1
							.put("CONNHOST", context.CONNHOST);
					parentContextMap_tRunJob_1.put("PORT", context.PORT);
					parentContextMap_tRunJob_1
							.put("DATABASE", context.DATABASE);
					parentContextMap_tRunJob_1.put("USER_NAME",
							context.USER_NAME);
					parentContextMap_tRunJob_1
					...
					parentContextMap_tRunJob_1.put("LOG_FILE_DIR",
							context.LOG_FILE_DIR);
					parentContextMap_tRunJob_1.put("GAPROFILE_ID",
							context.GAPROFILE_ID);

					Object obj_tRunJob_1 = null;

					obj_tRunJob_1 = ((String) globalMap.get("row1.gaprofileid"));
					paraList_tRunJob_1
							.add("--context_param GAPROFILE_ID="
									+ RuntimeUtils
											.tRunJobConvertContext(obj_tRunJob_1));
					parentContextMap_tRunJob_1.put("GAPROFILE_ID",
							obj_tRunJob_1);
					obj_tRunJob_1 = ((String) globalMap.get("row1.profileid"));
					paraList_tRunJob_1
							.add("--context_param PROFILE_ID="
									+ RuntimeUtils
											.tRunJobConvertContext(obj_tRunJob_1));
					parentContextMap_tRunJob_1.put("PROFILE_ID", obj_tRunJob_1);
					islabs_mvmetrics.dymanically_fetching_ga_data_0_1.Dymanically_Fetching_GA_Data childJob_tRunJob_1 = new islabs_mvmetrics.dymanically_fetching_ga_data_0_1.Dymanically_Fetching_GA_Data();
					// pass DataSources
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
						...
						row2.moment = java.util.Calendar.getInstance()
								.getTime();
	...
	public static void main(String[] args) {
		final populate_daily_clientdata_ga populate_daily_clientdata_gaClass = new populate_daily_clientdata_ga();

		int exitCode = populate_daily_clientdata_gaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = populate_daily_clientdata_ga.class
					.getClassLoader().getResourceAsStream(
							"islabs_mvmetrics/populate_daily_clientdata_ga_0_1/contexts/"
			...
			context.CONNHOST = (String) context.getProperty("CONNHOST");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("CONNHOST")) {
				context.CONNHOST = (String) parentContextMap.get("CONNHOST");
			}
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : populate_daily_clientdata_ga");
		}
...
/************************************************************************************************
 * 69786 characters generated by Talend Open Studio for Data Integration on the
