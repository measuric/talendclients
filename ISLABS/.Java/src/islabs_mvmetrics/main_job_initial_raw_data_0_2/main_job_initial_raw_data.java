...
package islabs_mvmetrics.main_job_initial_raw_data_0_2;
...
/**
 * Job: main_job_initial_raw_data Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 5.3.1.r104014
 * @status 
 */
public class main_job_initial_raw_data implements TalendJob {
	...
	private final String jobName = "main_job_initial_raw_data";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					main_job_initial_raw_data.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(main_job_initial_raw_data.this,
	...
	public static class exceptionStruct implements
		...
		final static byte[] commonByteArrayLock_ISLABS_MVMETRICS_main_job_initial_raw_data = new byte[0];
		static byte[] commonByteArray_ISLABS_MVMETRICS_main_job_initial_raw_data = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ISLABS_MVMETRICS_main_job_initial_raw_data.length) {
					if (length < 1024
							&& commonByteArray_ISLABS_MVMETRICS_main_job_initial_raw_data.length == 0) {
						commonByteArray_ISLABS_MVMETRICS_main_job_initial_raw_data = new byte[1024];
					} else {
						commonByteArray_ISLABS_MVMETRICS_main_job_initial_raw_data = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_ISLABS_MVMETRICS_main_job_initial_raw_data,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ISLABS_MVMETRICS_main_job_initial_raw_data) {
	...
	public static void main(String[] args) {
		final main_job_initial_raw_data main_job_initial_raw_dataClass = new main_job_initial_raw_data();

		int exitCode = main_job_initial_raw_dataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main_job_initial_raw_data.class
					.getClassLoader().getResourceAsStream(
							"islabs_mvmetrics/main_job_initial_raw_data_0_2/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : main_job_initial_raw_data");
		}
...
/************************************************************************************************
 * 92354 characters generated by Talend Open Studio for Data Integration on the
