...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_82 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_83 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_84 = " = tableNameForSearch_";
  protected final String TEXT_85 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_86 = " = tableNameForSearch_";
  protected final String TEXT_87 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_140 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_141 = ".execute(\"";
  protected final String TEXT_142 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_143 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_149 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_152 = ".executeUpdate(\"";
  protected final String TEXT_153 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_154 = ".close();";
  protected final String TEXT_155 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_156 = " = conn_";
  protected final String TEXT_157 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_158 = " = stmtTruncCount_";
  protected final String TEXT_159 = ".executeQuery(\"";
  protected final String TEXT_160 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_161 = " = conn_";
  protected final String TEXT_162 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_163 = ".executeUpdate(\"";
  protected final String TEXT_164 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_165 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_166 = " += rsTruncCount_";
  protected final String TEXT_167 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_168 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_169 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_170 = ".close();            ";
  protected final String TEXT_171 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_172 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_173 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_174 = NL + "\t";
  protected final String TEXT_175 = NL + NL + "StringBuilder command_";
  protected final String TEXT_176 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_177 = ".append(";
  protected final String TEXT_178 = " + \" \");";
  protected final String TEXT_179 = NL + "    String tmpTableName_";
  protected final String TEXT_180 = " = tableName_";
  protected final String TEXT_181 = ";" + NL + "    tableName_";
  protected final String TEXT_182 = " = \"tmp_";
  protected final String TEXT_183 = "\" + \"_\" + pid;";
  protected final String TEXT_184 = NL + "if(dbschema_";
  protected final String TEXT_185 = " != null && dbschema_";
  protected final String TEXT_186 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_187 = ".append(db_";
  protected final String TEXT_188 = " + \".\" + tableName_";
  protected final String TEXT_189 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_190 = ".append(db_";
  protected final String TEXT_191 = " + \"..\" + tableName_";
  protected final String TEXT_192 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_193 = ".append(\" in \" + ";
  protected final String TEXT_194 = ");" + NL + "String headRow_";
  protected final String TEXT_195 = " = ";
  protected final String TEXT_196 = ";" + NL + "if(headRow_";
  protected final String TEXT_197 = " != null && headRow_";
  protected final String TEXT_198 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_199 = ".append(\" -F \" + headRow_";
  protected final String TEXT_200 = ");" + NL + "}" + NL;
  protected final String TEXT_201 = NL + "\tcommand_";
  protected final String TEXT_202 = ".append(\" -b \" + ";
  protected final String TEXT_203 = ");";
  protected final String TEXT_204 = NL + NL + "command_";
  protected final String TEXT_205 = ".append(\" -t \" + ";
  protected final String TEXT_206 = ");" + NL + "command_";
  protected final String TEXT_207 = ".append(\" -r \" + ";
  protected final String TEXT_208 = ");" + NL + "command_";
  protected final String TEXT_209 = ".append(\" -c -U \" + user_";
  protected final String TEXT_210 = " + \" -P \" + pass_";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "command_";
  protected final String TEXT_213 = ".append(\" -I \" + ";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "    command_";
  protected final String TEXT_216 = ".append(\" -S \" + ";
  protected final String TEXT_217 = ");";
  protected final String TEXT_218 = NL + "\tcommand_";
  protected final String TEXT_219 = ".append(\" -S \" + host_";
  protected final String TEXT_220 = ");";
  protected final String TEXT_221 = NL + "String encoding_";
  protected final String TEXT_222 = " = \"";
  protected final String TEXT_223 = "\";" + NL + "if(encoding_";
  protected final String TEXT_224 = " != null && encoding_";
  protected final String TEXT_225 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_226 = ".append(\" -J \" + encoding_";
  ...
  protected final String TEXT_230 = " = runtime_";
  protected final String TEXT_231 = ".exec(command_";
  protected final String TEXT_232 = ".toString());";
  protected final String TEXT_233 = NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_234 = " = conn_";
  protected final String TEXT_235 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_236 = ".execute(\"";
  protected final String TEXT_237 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_238 = ".close();            " + NL + "        Runtime runtime_";
  protected final String TEXT_239 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_240 = " = runtime_";
  protected final String TEXT_241 = ".exec(command_";
  protected final String TEXT_242 = ".toString());       ";
  protected final String TEXT_243 = NL + NL + "Thread normal_";
  protected final String TEXT_244 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_245 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_246 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_247 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_248 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_249 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_250 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_251 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_252 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_253 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_254 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_255 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_256 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_257 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_258 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_259 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_260 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_261 = ".interrupt();" + NL + "error_";
  protected final String TEXT_262 = ".interrupt();";
