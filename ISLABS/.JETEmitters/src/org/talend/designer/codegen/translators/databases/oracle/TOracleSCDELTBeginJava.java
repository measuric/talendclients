...
public class TOracleSCDELTBeginJava {
  ...
  protected final String TEXT_33 = NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_38 = NL + "\tString atnParams_";
  protected final String TEXT_39 = " = ";
  protected final String TEXT_40 = ";" + NL + "\tatnParams_";
  protected final String TEXT_41 = " = atnParams_";
  protected final String TEXT_42 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_43 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_44 = ".put(\"user\",dbUser_";
  protected final String TEXT_45 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_46 = ".put(\"password\",dbPwd_";
  protected final String TEXT_47 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_48 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_49 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_50 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_51 = ", atnParamsPrope_";
  protected final String TEXT_52 = ");";
  protected final String TEXT_53 = NL + "        " + NL + "        String schema_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";";
  protected final String TEXT_56 = NL + "    String tableName_";
  protected final String TEXT_57 = " = null;" + NL + "    String sourceTable_";
  protected final String TEXT_58 = " = null;" + NL + "    String schema4search_";
  protected final String TEXT_59 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_60 = " != null && schema_";
  protected final String TEXT_61 = ".trim().length() != 0) {" + NL + "        tableName_";
  protected final String TEXT_62 = " = schema_";
  protected final String TEXT_63 = " + \".\" + ";
  protected final String TEXT_64 = ";" + NL + "        sourceTable_";
  protected final String TEXT_65 = " = schema_";
  protected final String TEXT_66 = " + \".\" + ";
  protected final String TEXT_67 = ";" + NL + "        schema4search_";
  protected final String TEXT_68 = " = schema_";
  protected final String TEXT_69 = ".toUpperCase();" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_70 = " = ";
  protected final String TEXT_71 = ";" + NL + "        sourceTable_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "        schema4search_";
  protected final String TEXT_74 = " = dbUser_";
  protected final String TEXT_75 = ".toUpperCase();" + NL + "    }";
  ...
  protected final String TEXT_89 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_95 = ".getMetaData();" + NL + "            String tableName4Search_";
  protected final String TEXT_96 = " = ";
  protected final String TEXT_97 = ";" + NL + "            if(tableName4Search_";
  protected final String TEXT_98 = ".indexOf(\"\\\"\")==-1){" + NL + "            \ttableName4Search_";
  protected final String TEXT_99 = " = tableName4Search_";
  protected final String TEXT_100 = ".toUpperCase();" + NL + "            }else{" + NL + "            \ttableName4Search_";
  protected final String TEXT_101 = " = tableName4Search_";
  protected final String TEXT_102 = ".replaceAll(\"\\\"\",\"\");" + NL + "            }" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_103 = " = dbMetaData_";
  protected final String TEXT_104 = ".getTables(null, schema4search_";
  protected final String TEXT_105 = ", tableName4Search_";
  ...
  protected final String TEXT_140 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_141 = ".close();";
  protected final String TEXT_142 = NL + "        System.out.println(\"[";
  protected final String TEXT_143 = "] table action ";
  protected final String TEXT_144 = " done\\n\");";
  protected final String TEXT_145 = NL + "    java.util.Date currentDate_";
  protected final String TEXT_146 = " = new java.util.Date((Long)start_Hash.get(\"";
  protected final String TEXT_147 = "\"));" + NL + "    String dateString_";
  protected final String TEXT_148 = " = routines.system.FormatterUtils.format_Date(currentDate_";
  protected final String TEXT_149 = ", \"yyyy-MM-dd HH:mm:ss\");" + NL + "    String dateValue_";
  protected final String TEXT_150 = " = \"to_date('\" + dateString_";
  protected final String TEXT_151 = " + \"', 'yyyy-mm-dd HH24:MI:SS')\";    ";
  protected final String TEXT_152 = NL + "        String updateForType1_";
  protected final String TEXT_153 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_154 = " + \" d SET (";
  protected final String TEXT_155 = ") = (SELECT ";
  protected final String TEXT_156 = " FROM \" + sourceTable_";
  protected final String TEXT_157 = " + \" t WHERE ";
  protected final String TEXT_158 = " AND (";
  protected final String TEXT_159 = ")) WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_160 = " + \" t WHERE ";
  protected final String TEXT_161 = " AND (";
  protected final String TEXT_162 = "))\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_165 = ".executeUpdate(updateForType1_";
  protected final String TEXT_166 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_167 = ".close();";
  protected final String TEXT_168 = NL + "            System.out.println(\"[";
  protected final String TEXT_169 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_170 = " + \"\\ndone\");";
  protected final String TEXT_171 = NL + "        String updateForType2_";
  protected final String TEXT_172 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_173 = " + \" d SET ";
  protected final String TEXT_174 = " = \" + ";
  protected final String TEXT_175 = NL + "\t        \"(SELECT t.";
  protected final String TEXT_176 = " FROM \" + sourceTable_";
  protected final String TEXT_177 = " + " + NL + "\t        \" t WHERE ";
  protected final String TEXT_178 = ")\"";
  protected final String TEXT_179 = NL + "        \tdateValue_";
  protected final String TEXT_180 = " " + NL + "        + \"";
  protected final String TEXT_181 = ", ";
  protected final String TEXT_182 = " = 0";
  protected final String TEXT_183 = " WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_184 = " + " + NL + "        \" t WHERE ";
  protected final String TEXT_185 = " AND (";
  protected final String TEXT_186 = ")) AND d.";
  protected final String TEXT_187 = " \"" + NL + "        +";
  protected final String TEXT_188 = NL + "         \" IS NULL\";";
  protected final String TEXT_189 = NL + "         \"= to_date ('\" + ";
  protected final String TEXT_190 = " +\"-01-01', 'yyyy-mm-dd')\";";
  protected final String TEXT_191 = "        " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_194 = ".executeUpdate(updateForType2_";
  protected final String TEXT_195 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_196 = ".close();";
  protected final String TEXT_197 = NL + "            System.out.println(\"[";
  protected final String TEXT_198 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_199 = " + \"\\ndone\");";
  protected final String TEXT_200 = NL + "        String insertForType2_";
  protected final String TEXT_201 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_202 = " + \"(";
  protected final String TEXT_203 = ", ";
  protected final String TEXT_204 = ") SELECT ";
  protected final String TEXT_205 = "\" + ";
  protected final String TEXT_206 = " + \".NEXTVAL, ";
  protected final String TEXT_207 = "t.";
  protected final String TEXT_208 = ", \" " + NL + "        + ";
  protected final String TEXT_209 = NL + "        dateValue_";
  protected final String TEXT_210 = NL + "        \"t.";
  protected final String TEXT_211 = "\"  ";
  protected final String TEXT_212 = "                " + NL + "         + ";
  protected final String TEXT_213 = NL + "         \", NULL\"";
  protected final String TEXT_214 = NL + "         \", to_date('\"+";
  protected final String TEXT_215 = "+\"-01-01', 'yyyy-mm-dd')\" ";
  protected final String TEXT_216 = NL + "         +\"";
  protected final String TEXT_217 = ", 1";
  protected final String TEXT_218 = ", d.";
  protected final String TEXT_219 = " + 1";
  protected final String TEXT_220 = " FROM \" + " + NL + "        sourceTable_";
  protected final String TEXT_221 = " + \" t, \" + tableName_";
  protected final String TEXT_222 = " + \" d WHERE ";
  protected final String TEXT_223 = " AND (";
  protected final String TEXT_224 = ") AND d.";
  protected final String TEXT_225 = " = \"" + NL + "        " + NL + "                 " + NL + "        + ";
  protected final String TEXT_226 = NL + "\t        \"(SELECT t.";
  protected final String TEXT_227 = " FROM \" + sourceTable_";
  protected final String TEXT_228 = " + " + NL + "\t        \" t WHERE ";
  protected final String TEXT_229 = ")\"";
  protected final String TEXT_230 = NL + "        \tdateValue_";
  protected final String TEXT_231 = " " + NL + "        ;  " + NL + "     \t" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_234 = ".executeUpdate(insertForType2_";
  protected final String TEXT_235 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_236 = ".close();";
  protected final String TEXT_237 = NL + "            System.out.println(\"[";
  protected final String TEXT_238 = "] type2 new active row slq\\n\" + insertForType2_";
  ...
  protected final String TEXT_244 = ") SELECT ";
  protected final String TEXT_245 = "\" + ";
  protected final String TEXT_246 = " + \".NEXTVAL, ";
  protected final String TEXT_247 = "t.";
  protected final String TEXT_248 = "\"" + NL + "    ";
  protected final String TEXT_249 = " + \", \"" + NL + "    \t+\t " + NL + "    \t";
  protected final String TEXT_250 = NL + "    \t dateValue_";
  protected final String TEXT_251 = NL + "    \t";
  protected final String TEXT_252 = NL + "    \t\"t.";
  protected final String TEXT_253 = "\"" + NL + "    \t";
  protected final String TEXT_254 = NL + "    \t+" + NL + "    \t";
  protected final String TEXT_255 = NL + "    \t\t\", NULL\"\t" + NL + "    \t";
  protected final String TEXT_256 = NL + "    \t\t \", to_date('\"+";
  protected final String TEXT_257 = "+\"-01-01', 'yyyy-mm-dd')\"" + NL + "    \t";
  protected final String TEXT_258 = "     " + NL + "     ";
  protected final String TEXT_259 = NL + "    " + NL + "    + \"";
  protected final String TEXT_260 = ", 1";
  protected final String TEXT_261 = ", 1";
  protected final String TEXT_262 = " FROM \" +" + NL + "     " + NL + "    sourceTable_";
  protected final String TEXT_263 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_264 = " + \" d ON ";
  protected final String TEXT_265 = " WHERE (";
  protected final String TEXT_266 = ")\";" + NL + "    " + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_267 = " = conn_";
  protected final String TEXT_268 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_269 = ".executeUpdate(insert_";
  protected final String TEXT_270 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_271 = ".close();";
  protected final String TEXT_272 = NL + "        System.out.println(\"[";
  protected final String TEXT_273 = "] new rows sql\\n\" + insert_";
