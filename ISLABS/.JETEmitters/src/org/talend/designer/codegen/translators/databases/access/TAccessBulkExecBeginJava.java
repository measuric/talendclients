...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_72 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_73 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_74 = " = tableNameForSearch_";
  protected final String TEXT_75 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_76 = " = tableNameForSearch_";
  protected final String TEXT_77 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_116 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_117 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_130 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_131 = ".execute(\"";
  protected final String TEXT_132 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_133 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_139 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_140 = " = conn_";
  protected final String TEXT_141 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_142 = ".executeUpdate(\"";
  protected final String TEXT_143 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_144 = ".close();";
  protected final String TEXT_145 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_148 = " = stmtTruncCount_";
  protected final String TEXT_149 = ".executeQuery(\"";
  protected final String TEXT_150 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_153 = ".executeUpdate(\"";
  protected final String TEXT_154 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_155 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_156 = " += rsTruncCount_";
  protected final String TEXT_157 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_158 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_159 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_160 = ".close();            ";
  protected final String TEXT_161 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_162 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_163 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_164 = " " + NL;
  protected final String TEXT_165 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_166 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_167 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_168 = " + \";HDR=";
  protected final String TEXT_169 = "].[\" + fileName_";
  protected final String TEXT_170 = " + \"]\";";
  protected final String TEXT_171 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_174 = ".execute(bulkInsert_";
  protected final String TEXT_175 = ");" + NL + "" + NL + "\tstmt_";
  protected final String TEXT_176 = ".close();";
