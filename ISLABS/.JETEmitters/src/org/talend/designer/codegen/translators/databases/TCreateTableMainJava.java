...
public class TCreateTableMainJava
{
  ...
  protected final String TEXT_11 = NL + "\t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_12 = " = conn_";
  protected final String TEXT_13 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_14 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_15 = " = tableNameForSearch_";
  protected final String TEXT_16 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_17 = " = tableNameForSearch_";
  protected final String TEXT_18 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_19 = " = dbMetaData_";
  protected final String TEXT_20 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_21 = ", tableNameForSearch_";
  protected final String TEXT_22 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_23 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_24 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_25 = " = true;" + NL + "\t            }     ";
  protected final String TEXT_26 = NL + "\t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_27 = " = conn_";
  protected final String TEXT_28 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_29 = " = dbMetaData_";
  protected final String TEXT_30 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_31 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_32 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_33 = " = rsTable_";
  protected final String TEXT_34 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_35 = ".equals";
  protected final String TEXT_36 = "IgnoreCase";
  protected final String TEXT_37 = "(";
  protected final String TEXT_38 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_39 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }     ";
  protected final String TEXT_40 = NL + "            rsTable_";
  protected final String TEXT_41 = ".close();";
  protected final String TEXT_42 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_49 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_54 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmt_";
  protected final String TEXT_55 = " = conn_";
  protected final String TEXT_56 = ".createStatement();" + NL + "                stmt_";
  protected final String TEXT_57 = ".execute(\"";
  protected final String TEXT_58 = "\");            " + NL + "\t            ";
  protected final String TEXT_59 = NL + "        ";
  protected final String TEXT_60 = NL + "        globalMap.put(\"";
  protected final String TEXT_61 = "_QUERY\", \"";
  protected final String TEXT_62 = "\");        " + NL + "    } catch(java.lang.Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_63 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        throw new RuntimeException(\"Creating table failed\", e);" + NL + "    }";
