...
public class TXMLMapOutBeginJava {
  ...
  protected final String TEXT_181 = ").equals(FormatterUtils.format(";
  protected final String TEXT_182 = ",";
  protected final String TEXT_183 = ")) : FormatterUtils.format(";
  protected final String TEXT_184 = ",";
  protected final String TEXT_185 = ")!=null )";
  protected final String TEXT_186 = NL + "\t\t\t\t\t){" + NL;
  protected final String TEXT_187 = "\t" + NL + "\t\t\t\t\tif(groupbyList.size()<=";
  protected final String TEXT_188 = "){" + NL + "\t\t\t\t\t\tgroupbyList.add(new java.util.ArrayList<String>());" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_189 = ").clear();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_190 = NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_191 = ").add(FormatterUtils.format(";
  ...
  protected final String TEXT_213 = "();" + NL + "\t" + NL + "\t//do some work after document has been generated" + NL + "\tvoid generateOk(routines.system.Document doc) {" + NL + "\t\tif(doc == null || doc.getDocument() == null) {" + NL + "\t\t\treturn;" + NL + "\t\t}" + NL + "\t\tnestXMLTool.replaceDefaultNameSpace(doc.getDocument().getRootElement(),null);";
  ...
  protected final String TEXT_222 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\troutines.system.DocumentGenerateOrderHelper orderHelper = new routines.system.DocumentGenerateOrderHelper(";
  ...
  protected final String TEXT_226 = NL + "\t\torg.dom4j.Element ";
  protected final String TEXT_227 = " = null;" + NL + "\t\tpublic boolean  ";
  protected final String TEXT_228 = " = false;";
  protected final String TEXT_229 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_230 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tnestXMLTool = new NestXMLTool_";
  ...
  protected final String TEXT_232 = "TreeNode_API_";
  protected final String TEXT_233 = " treeNodeAPI,";
  protected final String TEXT_234 = "boolean isInnerJoin";
  protected final String TEXT_235 = ", ";
  protected final String TEXT_236 = " ";
  protected final String TEXT_237 = NL + "\t";
  protected final String TEXT_238 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_239 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_240 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_241 = NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_242 = ") {";
  protected final String TEXT_243 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_244 = NL + "\t\t}" + NL + "    }" + NL + "" + NL + "\tGenerateDocument_";
  protected final String TEXT_245 = " gen_Doc_";
  protected final String TEXT_246 = "_";
  protected final String TEXT_247 = " = new GenerateDocument_";
  protected final String TEXT_248 = "();" + NL + "\tboolean docAlreadyInstanciate_";
  protected final String TEXT_249 = " = false;";
  protected final String TEXT_250 = NL;
  protected final String TEXT_251 = NL + "\t            class SortableRow_";
  protected final String TEXT_252 = " implements Comparable<SortableRow_";
  protected final String TEXT_253 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_254 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  protected final String TEXT_255 = " exprKey_";
  ...
  protected final String TEXT_263 = NL + "\t\t\t        public void fillFrom(";
  ...
  protected final String TEXT_278 = " = exprKey_";
  protected final String TEXT_279 = "__";
  protected final String TEXT_280 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        public void copyDataTo(";
  ...
  protected final String TEXT_288 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_289 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_290 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_292 = "__";
  protected final String TEXT_293 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_294 = "__";
  protected final String TEXT_295 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_296 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_297 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_298 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_299 = "__";
  protected final String TEXT_300 = ", other.exprKey_";
  protected final String TEXT_301 = "__";
  protected final String TEXT_302 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  protected final String TEXT_303 = NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "\t\t\t                returnValue = ((Comparable) object1).compareTo(object2);" + NL + "\t\t\t            } else if (object1 != null && object2 != null) {" + NL + "\t\t\t                returnValue = compareStrings(object1.toString(), object2" + NL + "\t\t\t                        .toString());" + NL + "\t\t\t            } else if (object1 == null && object2 != null) {" + NL + "\t\t\t                returnValue = 1;" + NL + "\t\t\t            } else if (object1 != null && object2 == null) {" + NL + "\t\t\t                returnValue = -1;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                returnValue = 0;" + NL + "\t\t\t            }" + NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int compareStrings(String string1, String string2) {" + NL + "\t\t\t            return string1.compareTo(string2);" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t\t\tpublic void readData(ObjectInputStream dis) {" + NL + "\t\t\t\t\t\tsynchronized(";
  protected final String TEXT_304 = "Struct.commonByteArrayLock_";
  protected final String TEXT_305 = "_";
  protected final String TEXT_306 = ") {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t            this.";
  protected final String TEXT_308 = "__";
  protected final String TEXT_309 = " = dis.read";
  protected final String TEXT_310 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_311 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_312 = "__";
  protected final String TEXT_313 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_314 = "Struct.commonByteArray_";
  protected final String TEXT_315 = "_";
  protected final String TEXT_316 = ".length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_317 = "Struct.commonByteArray_";
  protected final String TEXT_318 = "_";
  protected final String TEXT_319 = ".length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_320 = "Struct.commonByteArray_";
  protected final String TEXT_321 = "_";
  protected final String TEXT_322 = " = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_323 = "Struct.commonByteArray_";
  protected final String TEXT_324 = "_";
  protected final String TEXT_325 = " = new byte[2 * length];" + NL + "\t\t\t           \t\t\t\t}" + NL + "\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_326 = "Struct.commonByteArray_";
  protected final String TEXT_327 = "_";
  protected final String TEXT_328 = ", 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_329 = "__";
  protected final String TEXT_330 = " = new String(";
  protected final String TEXT_331 = "Struct.commonByteArray_";
  protected final String TEXT_332 = "_";
  protected final String TEXT_333 = ", 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_335 = "__";
  protected final String TEXT_336 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.";
  protected final String TEXT_337 = "__";
  protected final String TEXT_338 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_339 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_340 = "__";
  protected final String TEXT_341 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_342 = "__";
  protected final String TEXT_343 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_345 = "__";
  protected final String TEXT_346 = " = (";
  protected final String TEXT_347 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_348 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_349 = "__";
  protected final String TEXT_350 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.";
  protected final String TEXT_351 = "__";
  protected final String TEXT_352 = " = dis.read";
  protected final String TEXT_353 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t            ";
  protected final String TEXT_355 = NL + "\t\t\t\t            this.exprKey_";
  protected final String TEXT_356 = "__";
  protected final String TEXT_357 = " = dis.read";
  protected final String TEXT_358 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_360 = "__";
  protected final String TEXT_361 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.exprKey_";
  protected final String TEXT_362 = "__";
  protected final String TEXT_363 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_365 = "__";
  protected final String TEXT_366 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_367 = "Struct.commonByteArray_";
  protected final String TEXT_368 = "_";
  protected final String TEXT_369 = ".length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_370 = "Struct.commonByteArray_";
  protected final String TEXT_371 = "_";
  protected final String TEXT_372 = ".length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_373 = "Struct.commonByteArray_";
  protected final String TEXT_374 = "_";
  protected final String TEXT_375 = " = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_376 = "Struct.commonByteArray_";
  protected final String TEXT_377 = "_";
  protected final String TEXT_378 = " = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_379 = "Struct.commonByteArray_";
  protected final String TEXT_380 = "_";
  protected final String TEXT_381 = ", 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_382 = "__";
  protected final String TEXT_383 = " = new String(";
  protected final String TEXT_384 = "Struct.commonByteArray_";
  protected final String TEXT_385 = "_";
  protected final String TEXT_386 = ", 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_388 = "__";
  protected final String TEXT_389 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_390 = "__";
  protected final String TEXT_391 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_393 = "__";
  protected final String TEXT_394 = " = (";
  protected final String TEXT_395 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_397 = "__";
  protected final String TEXT_398 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_399 = "__";
  protected final String TEXT_400 = " = dis.read";
  protected final String TEXT_401 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_403 = NL + "\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_412 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  ...
  protected final String TEXT_417 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_418 = "__";
  protected final String TEXT_419 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_421 = "__";
  protected final String TEXT_422 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_423 = "__";
  protected final String TEXT_424 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_425 = "__";
  protected final String TEXT_426 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_428 = "__";
  protected final String TEXT_429 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\t\tif(this.";
  ...
  protected final String TEXT_433 = "(this.";
  protected final String TEXT_434 = "__";
  protected final String TEXT_435 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\t            ";
  protected final String TEXT_437 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_438 = "(this.exprKey_";
  protected final String TEXT_439 = "__";
  protected final String TEXT_440 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_441 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_442 = "__";
  protected final String TEXT_443 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_444 = "__";
  protected final String TEXT_445 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_446 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_447 = "__";
  protected final String TEXT_448 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_449 = "__";
  protected final String TEXT_450 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_452 = "__";
  protected final String TEXT_453 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_454 = "__";
  protected final String TEXT_455 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_456 = "__";
  protected final String TEXT_457 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_458 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  protected final String TEXT_459 = "__";
  protected final String TEXT_460 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_461 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_462 = "__";
  protected final String TEXT_463 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_464 = "(this.exprKey_";
  protected final String TEXT_465 = "__";
  protected final String TEXT_466 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_467 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_468 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
