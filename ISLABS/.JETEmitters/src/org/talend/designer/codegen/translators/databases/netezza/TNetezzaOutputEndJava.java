...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_13 = "                " + NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_14 = " != null && batchSizeCounter_";
  protected final String TEXT_15 = " > 0 ) {" + NL + "\t\t\tpstmt_";
  protected final String TEXT_16 = ".executeBatch(); " + NL + "\t\t\tpstmt_";
  protected final String TEXT_17 = ".clearBatch(); " + NL + "\t    \t";
  ...
  protected final String TEXT_27 = NL + "\t    }\t                \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_28 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_29 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_30 = "                \t" + NL + "\t}catch (java.sql.SQLException e){" + NL + "\t\t";
  protected final String TEXT_31 = NL + "\t\t\tthrow(e);" + NL + "\t\t";
  protected final String TEXT_32 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t";
  protected final String TEXT_33 = NL + "\t}                                  ";
  protected final String TEXT_34 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_35 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_36 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_37 = NL;
  protected final String TEXT_38 = NL + "    \t\tconn_";
  protected final String TEXT_39 = ".commit();" + NL + "    \t\t";
  protected final String TEXT_40 = "\t" + NL + "    \tconn_";
  protected final String TEXT_41 = " .close();" + NL + "    \t";
  protected final String TEXT_42 = NL + NL + "\tnb_line_deleted_";
