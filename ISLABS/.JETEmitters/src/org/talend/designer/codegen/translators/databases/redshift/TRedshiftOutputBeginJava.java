...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_37 = "=0;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_38 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_39 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_40 = " = calendar_";
  protected final String TEXT_41 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_42 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_43 = " = calendar_";
  protected final String TEXT_44 = ".getTime().getTime();" + NL + "long date_";
  protected final String TEXT_45 = ";" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_46 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_51 = "\t" + NL + "" + NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");    " + NL + "    String url_";
  protected final String TEXT_52 = " = \"jdbc:postgresql://\"+";
  ...
  protected final String TEXT_64 = ".setAutoCommit(false);" + NL + "\t";
  ...
  protected final String TEXT_89 = ".equals(";
  ...
  protected final String TEXT_108 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_109 = " = conn_";
  protected final String TEXT_110 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_111 = " = stmtClearCount_";
  protected final String TEXT_112 = ".executeQuery(\"";
  protected final String TEXT_113 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_116 = ".executeUpdate(\"";
  protected final String TEXT_117 = "\");" + NL + "            while(rsClearCount_";
  protected final String TEXT_118 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_119 = " += rsClearCount_";
  protected final String TEXT_120 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_121 = "\t\t" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_124 = " + \"\\\" (";
  protected final String TEXT_125 = ") VALUES (";
  protected final String TEXT_126 = ")\");";
  protected final String TEXT_127 = NL + "\t\t\tint rowCount";
  protected final String TEXT_128 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_129 = " {";
  protected final String TEXT_130 = NL + "                            ";
  protected final String TEXT_131 = " ";
  protected final String TEXT_132 = ";                ";
  protected final String TEXT_133 = "   " + NL + "\t            " + NL + "\t            public BufferLine_";
  ...
  protected final String TEXT_142 = "   \t                " + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t            " + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_143 = "> exInsertColValueList";
  protected final String TEXT_144 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_145 = " exInsertColValue";
  protected final String TEXT_146 = " = null; " + NL + "\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_147 = " = new StringBuilder();" + NL + "\t\t\tfor(int i=0;i < ";
  protected final String TEXT_148 = ";i++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_149 = ".append(\"(";
  protected final String TEXT_150 = ")\");" + NL + "\t\t\t\t if (i!=";
  protected final String TEXT_151 = "-1) extendInsertValueStmt_";
  protected final String TEXT_152 = ".append(\",\");" + NL + "\t\t\t}" + NL + "            " + NL + "\t\t\tString insert_";
  protected final String TEXT_153 = " = \"INSERT INTO \"+";
  protected final String TEXT_154 = "+\" (";
  protected final String TEXT_155 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_156 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_157 = " =  conn_";
  protected final String TEXT_158 = ".prepareStatement(insert_";
  protected final String TEXT_159 = ");";
  protected final String TEXT_160 = "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_161 = " = conn_";
  protected final String TEXT_162 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_168 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_172 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_173 = " + \"\\\" (";
  protected final String TEXT_174 = ") VALUES (";
  protected final String TEXT_175 = ")\");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_183 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_184 = " + \"\\\" SET ";
  protected final String TEXT_185 = " WHERE ";
  protected final String TEXT_186 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_194 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_195 = " + \"\\\" WHERE ";
  protected final String TEXT_196 = "\");" + NL + "\t    ";
  protected final String TEXT_197 = "    " + NL + "            int commitEvery_";
  protected final String TEXT_198 = " = ";
  protected final String TEXT_199 = ";            " + NL + "            int commitCounter_";
