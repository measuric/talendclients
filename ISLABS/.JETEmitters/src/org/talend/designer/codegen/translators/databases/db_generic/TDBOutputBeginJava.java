...
public class TDBOutputBeginJava {
  ...
  protected final String TEXT_66 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_67 = " = conn_";
  protected final String TEXT_68 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_69 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_70 = " = conn_";
  protected final String TEXT_71 = ".prepareStatement(insert_";
  protected final String TEXT_72 = ");" + NL + "\t    ";
  protected final String TEXT_73 = NL + "\t    String update_";
  protected final String TEXT_74 = " = \"UPDATE \" + ";
  protected final String TEXT_75 = " + \" SET ";
  protected final String TEXT_76 = " WHERE ";
  protected final String TEXT_77 = "\";" + NL + "\t    ";
  protected final String TEXT_78 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_79 = " = conn_";
  protected final String TEXT_80 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_81 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_82 = " = conn_";
  protected final String TEXT_83 = ".prepareStatement(update_";
  protected final String TEXT_84 = ");" + NL + "\t    ";
  protected final String TEXT_85 = NL + "\t    \tString checkExist_";
  protected final String TEXT_86 = " = \"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_87 = " + \" WHERE ";
  protected final String TEXT_88 = "\";" + NL + "\t    \tString insert_";
  protected final String TEXT_89 = " = \"INSERT INTO \" + ";
  protected final String TEXT_90 = " + \" (";
  protected final String TEXT_91 = ") VALUES (";
  protected final String TEXT_92 = ")\";" + NL + "\t    \tString update_";
  protected final String TEXT_93 = " = \"UPDATE \" + ";
  protected final String TEXT_94 = " + \" SET ";
  protected final String TEXT_95 = " WHERE ";
  protected final String TEXT_96 = "\";" + NL + "\t    ";
  protected final String TEXT_97 = NL + "\t    \tString[] checkExistSQLSplits_";
  protected final String TEXT_98 = " = (checkExist_";
  protected final String TEXT_99 = "+\" \").split(\"\\\\?\");" + NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_100 = " = conn_";
  protected final String TEXT_101 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtInsert_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtUpdate_";
  ...
  protected final String TEXT_108 = ".prepareStatement(checkExist_";
  ...
  protected final String TEXT_112 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_113 = " = conn_";
  protected final String TEXT_114 = ".prepareStatement(update_";
  ...
  protected final String TEXT_120 = "\";" + NL + "\t    String insert_";
  protected final String TEXT_121 = " = \"INSERT INTO \" + ";
  protected final String TEXT_122 = " + \" (";
  protected final String TEXT_123 = ") VALUES (";
  protected final String TEXT_124 = ")\";" + NL + "\t    ";
  protected final String TEXT_125 = NL + "\t\t    java.sql.Statement pstmtUpdate_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "\t\t    java.sql.Statement pstmtInsert_";
  ...
  protected final String TEXT_141 = NL + "\t    \tjava.sql.Statement pstmt_";
  ...
  protected final String TEXT_146 = ".prepareStatement(delete_";
  protected final String TEXT_147 = ");" + NL + "\t    ";
  protected final String TEXT_148 = NL + "        StringBuffer query_";
  protected final String TEXT_149 = " = null;" + NL + "       \t";
  protected final String TEXT_150 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_151 = " = insert_";
  protected final String TEXT_152 = ".split(\"\\\\?\");";
  protected final String TEXT_153 = NL + "\t\t\tupdate_";
  protected final String TEXT_154 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_155 = " = update_";
  protected final String TEXT_156 = ".split(\"\\\\?\");";
  protected final String TEXT_157 = NL + "\t\t\tupdate_";
  protected final String TEXT_158 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_159 = " = update_";
  protected final String TEXT_160 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_161 = " = insert_";
  protected final String TEXT_162 = ".split(\"\\\\?\");";
  protected final String TEXT_163 = NL + "\t\t\tdelete_";
  protected final String TEXT_164 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_165 = " = delete_";
  protected final String TEXT_166 = ".split(\"\\\\?\");";
  protected final String TEXT_167 = NL + "\t\t\treplace_";
  protected final String TEXT_168 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_169 = " = replace_";
  protected final String TEXT_170 = ".split(\"\\\\?\");";
  protected final String TEXT_171 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_172 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_173 = " = insertIgnore_";
  ...
  protected final String TEXT_178 = NL + "\t    int commitEvery_";
  protected final String TEXT_179 = " = ";
  protected final String TEXT_180 = ";" + NL + "\t    int commitCounter_";
  protected final String TEXT_181 = " = 0;" + NL + "\t    ";
