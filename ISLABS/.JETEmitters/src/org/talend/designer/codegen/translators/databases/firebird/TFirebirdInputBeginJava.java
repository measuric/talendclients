...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_93 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_101 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_105 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_106 = ") {";
  protected final String TEXT_107 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_108 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_109 = " = dataSources_";
  protected final String TEXT_110 = ".get(";
  protected final String TEXT_111 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_112 = "\", conn_";
  protected final String TEXT_113 = ");" + NL + "\t\t        }";
  protected final String TEXT_114 = NL + NL + "\t\t    ";
  protected final String TEXT_115 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_116 = " = ";
  protected final String TEXT_117 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_118 = "_QUERY\",dbquery_";
  protected final String TEXT_119 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_120 = " = stmt_";
  protected final String TEXT_121 = ".executeQuery(dbquery_";
  protected final String TEXT_122 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_123 = " = rs_";
  protected final String TEXT_124 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_125 = " = rsmd_";
  protected final String TEXT_126 = ".getColumnCount();" + NL;
  protected final String TEXT_127 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_128 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_129 = ".setDbmsId(\"";
  protected final String TEXT_130 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_131 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_132 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_133 = ".add(\"";
  protected final String TEXT_134 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_135 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_136 = " = ";
  protected final String TEXT_137 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_138 = "; i <= rsmd_";
  protected final String TEXT_139 = ".getColumnCount()-";
  protected final String TEXT_140 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_141 = ".contains(rsmd_";
  protected final String TEXT_142 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_143 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_144 = ".setName(rsmd_";
  protected final String TEXT_145 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_146 = ".setDbName(rsmd_";
  protected final String TEXT_147 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_148 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_149 = "\", rsmd_";
  protected final String TEXT_150 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_151 = ".getPrecision(i), rsmd_";
  protected final String TEXT_152 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_153 = ".setDbType(rsmd_";
  protected final String TEXT_154 = ".getColumnTypeName(i));";
  protected final String TEXT_155 = NL + "                \tdcm_";
  protected final String TEXT_156 = ".setFormat(";
  protected final String TEXT_157 = ");";
  protected final String TEXT_158 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_159 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_160 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_161 = ".setLength(rsmd_";
  protected final String TEXT_162 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_163 = ".setLength(rsmd_";
  protected final String TEXT_164 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_165 = NL + "\t\t\tdcm_";
  protected final String TEXT_166 = ".setLength(rsmd_";
  protected final String TEXT_167 = ".getPrecision(i));";
  protected final String TEXT_168 = NL + "                \tdcm_";
  protected final String TEXT_169 = ".setPrecision(rsmd_";
  protected final String TEXT_170 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_171 = ".setNullable(rsmd_";
  protected final String TEXT_172 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_173 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_174 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_175 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_176 = ".metadatas.add(dcm_";
  protected final String TEXT_177 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_178 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_179 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_180 = " =1;" + NL + "\t\t    while (rs_";
  protected final String TEXT_181 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_182 = "++;" + NL + "\t\t        ";
  protected final String TEXT_183 = NL + "\t\t                        column_index_";
  protected final String TEXT_184 = " = ";
  protected final String TEXT_185 = " + dcg_";
  protected final String TEXT_186 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_187 = NL + "\t\t                        column_index_";
  protected final String TEXT_188 = " = ";
  protected final String TEXT_189 = ";" + NL + "\t\t                    ";
  protected final String TEXT_190 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_202 = " = (List)rs_";
  protected final String TEXT_203 = ".getObject(column_index_";
  protected final String TEXT_204 = ");";
  protected final String TEXT_205 = NL + "\t\t                         ";
  protected final String TEXT_206 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_207 = ".getObject(column_index_";
  protected final String TEXT_208 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_209 = NL + "                                    ";
  protected final String TEXT_210 = ".";
  protected final String TEXT_211 = " = new Geometry(wktValue);";
  protected final String TEXT_212 = NL + "                                        ";
  protected final String TEXT_213 = ".";
  protected final String TEXT_214 = ".setEPSG(";
  ...
  protected final String TEXT_221 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_222 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_223 = " = ";
  protected final String TEXT_224 = "; i_";
  protected final String TEXT_225 = "  <= rsmd_";
  protected final String TEXT_226 = ".getColumnCount(); i_";
  protected final String TEXT_227 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_228 = ".getColumnTypeName(i_";
  protected final String TEXT_229 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_230 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_231 = ".getClob(i_";
  protected final String TEXT_232 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_233 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_234 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_235 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_236 = ".add(tNTextImpl_";
  protected final String TEXT_237 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_238 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_239 = ".";
  protected final String TEXT_240 = ", rs_";
  protected final String TEXT_241 = ", fixedColumnCount_";
  protected final String TEXT_242 = ",list_";
  ...
  protected final String TEXT_250 = ".getObject(column_index_";
