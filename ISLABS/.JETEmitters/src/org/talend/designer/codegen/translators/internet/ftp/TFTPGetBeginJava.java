...
public class TFTPGetBeginJava
{
  ...
  protected final String TEXT_64 = NL + "  \tif((\"true\").equals(System.getProperty(\"http.proxySet\")) ){" + NL + "  \t\tcom.jcraft.jsch.ProxyHTTP proxy_";
  protected final String TEXT_65 = " = new com.jcraft.jsch.ProxyHTTP(System.getProperty(\"http.proxyHost\"),Integer.parseInt(System.getProperty(\"http.proxyPort\")));" + NL + "  \t\tif(!\"\".equals(System.getProperty(\"http.proxyUser\"))){" + NL + "  \t\t\tproxy_";
  protected final String TEXT_66 = ".setUserPasswd(System.getProperty(\"http.proxyUser\"),System.getProperty(\"http.proxyPassword\"));" + NL + "  \t\t}" + NL + "  \t\tsession_";
  protected final String TEXT_67 = ".setProxy(proxy_";
  protected final String TEXT_68 = ");" + NL + "  \t}" + NL + "\t";
  protected final String TEXT_69 = NL + "    session_";
  protected final String TEXT_70 = ".connect();" + NL + "    com.jcraft.jsch. Channel channel_";
  protected final String TEXT_71 = "=session_";
  protected final String TEXT_72 = ".openChannel(\"sftp\");" + NL + "    channel_";
  protected final String TEXT_73 = ".connect();" + NL + "    com.jcraft.jsch.ChannelSftp c_";
  protected final String TEXT_74 = "=(com.jcraft.jsch.ChannelSftp)channel_";
  protected final String TEXT_75 = ";" + NL + "    c_";
  protected final String TEXT_76 = ".setFilenameEncoding(";
  protected final String TEXT_77 = ");";
  protected final String TEXT_78 = NL + "  com.jcraft.jsch.SftpProgressMonitor monitor_";
  protected final String TEXT_79 = " = new MyProgressMonitor_";
  protected final String TEXT_80 = "();" + NL + "  SFTPGetter_";
  protected final String TEXT_81 = " getter_";
  protected final String TEXT_82 = " = new SFTPGetter_";
  protected final String TEXT_83 = "();" + NL + "  getter_";
  protected final String TEXT_84 = ".cnlSFTP = c_";
  protected final String TEXT_85 = ";" + NL + "  getter_";
  protected final String TEXT_86 = ".monitor = monitor_";
  protected final String TEXT_87 = ";" + NL + "  String remotedir_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";" + NL + "  c_";
  protected final String TEXT_90 = ".cd(remotedir_";
  protected final String TEXT_91 = ");";
  protected final String TEXT_92 = "  " + NL + "  final com.enterprisedt.net.ftp.TransferCompleteStrings msg_";
  protected final String TEXT_93 = " = new com.enterprisedt.net.ftp.TransferCompleteStrings();" + NL + "" + NL + "  class FTPGetter_";
  protected final String TEXT_94 = " {" + NL + "    private com.enterprisedt.net.ftp.FTPClient ftpClient = null;" + NL + "    private int count = 0;" + NL + "" + NL + "    public void getAllFiles(String remoteDirectory, String localDirectory) throws java.io.IOException, " + NL + "      com.enterprisedt.net.ftp.FTPException, java.text.ParseException {" + NL + "" + NL + "      ftpClient.chdir(remoteDirectory);" + NL + "      String path = ftpClient.pwd();" + NL + "      String[] ftpFileNames = null;" + NL + "      com.enterprisedt.net.ftp.FTPFile[] ftpFiles = null;" + NL + "" + NL + "      try{" + NL + "        //use dir() for Bug9562 with FTP server in AS400" + NL + "        ftpFileNames = ftpClient.dir(null, false);" + NL + "        //Bug 13272, the same as getFiles()." + NL + "      } catch (com.enterprisedt.net.ftp.FTPException e){" + NL + "        ftpFileNames = null;" + NL + "        ftpFiles = ftpClient.dirDetails(\".\");" + NL + "      }" + NL + "" + NL + "      //if dirDetails(...) doesn't work, then use dir(...), distinguish file type by FTPException" + NL + "" + NL + "      if ((ftpFiles == null) && (ftpFileNames != null)){" + NL + "        //if the file is folder, catch the FTPException and recur" + NL + "        for (String ftpFileName : ftpFileNames){" + NL + "          try {" + NL + "            downloadFile(localDirectory + \"/\" + ftpFileName,ftpFileName);" + NL + "          } catch (com.enterprisedt.net.ftp.FTPException e) {" + NL + "            java.io.File localFile = new java.io.File(localDirectory + \"/\" + ftpFileName);" + NL + "            " + NL + "            if (!localFile.exists()) {" + NL + "              localFile.mkdir();" + NL + "            }" + NL + "            getAllFiles(path + \"/\" + ftpFileName, localDirectory + \"/\" + ftpFileName);" + NL + "            ftpClient.chdir(path);" + NL + "          }" + NL + "        }" + NL + "      } else {" + NL + "        for (com.enterprisedt.net.ftp.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "          if (ftpFile.isDir()) {" + NL + "            if ((!(\".\").equals(ftpFile.getName())) && (!(\"..\").equals(ftpFile.getName()))) {" + NL + "              java.io.File localFile = new java.io.File(localDirectory + \"/\" + ftpFile.getName());" + NL + "" + NL + "              if (!localFile.exists()) {" + NL + "                localFile.mkdir();" + NL + "              }" + NL + "              getAllFiles(path + \"/\" + ftpFile.getName(), localDirectory + \"/\" + ftpFile.getName());" + NL + "              ftpClient.chdir(path);" + NL + "            }" + NL + "          } else if (!ftpFile.isLink()) {" + NL + "            downloadFile(localDirectory + \"/\" + ftpFile.getName(),ftpFile.getName());" + NL + "          }" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "" + NL + "    public void getFiles(String remoteDirectory, String localDirectory, String maskStr) throws java.io.IOException," + NL + "      com.enterprisedt.net.ftp.FTPException, java.text.ParseException {" + NL + "      ftpClient.chdir(remoteDirectory);" + NL + "      String[] ftpFileNames = null;" + NL + "      com.enterprisedt.net.ftp.FTPFile[] ftpFiles = null;" + NL + "" + NL + "      try {" + NL + "        //use dir() for Bug9562 with FTP server in AS400 (the same way as getAllFiles())" + NL + "        ftpFileNames = ftpClient.dir(null, false);" + NL + "        //Bug 13272, if dir() throw exception, use dirDetails()." + NL + "      } catch (com.enterprisedt.net.ftp.FTPException e){" + NL + "        ftpFileNames = null;" + NL + "        ftpFiles = ftpClient.dirDetails(\".\");" + NL + "      }" + NL + "      //if dirDetails(...) doesn't work, then use dir(...), but can not distinguish file type" + NL + "" + NL + "      if ((ftpFiles == null) && (ftpFileNames != null)){" + NL + "        for (String ftpFileName : ftpFileNames) {" + NL + "          if (ftpFileName.matches(maskStr)) {" + NL + "            downloadFile(localDirectory + \"/\" + ftpFileName,ftpFileName);" + NL + "          }" + NL + "        }" + NL + "      } else{" + NL + "" + NL + "        for (com.enterprisedt.net.ftp.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "          if (!ftpFile.isDir() && !ftpFile.isLink()) {" + NL + "            String fileName = ftpFile.getName();" + NL + "" + NL + "            if (fileName.matches(maskStr)) {" + NL + "              downloadFile(localDirectory + \"/\" + fileName,fileName);" + NL + "            }" + NL + "          }" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "" + NL + "    public void chdir(String path) throws java.io.IOException,  com.enterprisedt.net.ftp.FTPException{" + NL + "      ftpClient.chdir(path);" + NL + "    }" + NL + "" + NL + "    public String pwd() throws java.io.IOException,  com.enterprisedt.net.ftp.FTPException{" + NL + "      return ftpClient.pwd();" + NL + "    }" + NL + "" + NL + "    private void downloadFile(String localFileName, String remoteFileName) throws java.io.IOException, com.enterprisedt.net.ftp.FTPException {" + NL + "      java.io.File localFile = new java.io.File(localFileName);" + NL + "" + NL + "      try {";
  protected final String TEXT_95 = NL + "          java.io.FileOutputStream fout = new java.io.FileOutputStream(localFile, true);" + NL + "          ftpClient.get(fout, remoteFileName);" + NL + "          msg_";
  protected final String TEXT_96 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_97 = NL + "            System.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_98 = NL + "          globalMap.put(\"";
  protected final String TEXT_99 = "_CURRENT_STATUS\", \"File transfer OK.\");";
  protected final String TEXT_100 = NL + "          if (!localFile.exists()) {" + NL + "            ftpClient.get(localFileName, remoteFileName);" + NL + "            msg_";
  protected final String TEXT_101 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_102 = NL + "              System.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_103 = NL + "            globalMap.put(\"";
  protected final String TEXT_104 = "_CURRENT_STATUS\", \"File transfer OK.\");" + NL + "          } else { " + NL + "            msg_";
  protected final String TEXT_105 = ".add(\"file [\"+ remoteFileName +\"] exit transmission.\");" + NL + "            globalMap.put(\"";
  protected final String TEXT_106 = "_CURRENT_STATUS\", \"No file transfered.\");" + NL + "          }";
  protected final String TEXT_107 = NL + "          ftpClient.get(localFileName, remoteFileName);" + NL + "          msg_";
  protected final String TEXT_108 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_109 = NL + "            System.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_110 = NL + "          if (localFile.exists()) {" + NL + "            long ftpSize = ftpClient.size(remoteFileName);" + NL + "            long localSize = localFile.length();" + NL + "" + NL + "            if (ftpSize != localSize) {" + NL + "              ftpClient.get(localFileName, remoteFileName);" + NL + "              msg_";
  ...
  protected final String TEXT_114 = "_CURRENT_STATUS\", \"File transfer OK.\");" + NL + "            } else {" + NL + "              msg_";
  protected final String TEXT_115 = ".add(\"file [\"+ remoteFileName +\"] exit transmission.\");" + NL + "              globalMap.put(\"";
  protected final String TEXT_116 = "_CURRENT_STATUS\", \"No file transfered.\");" + NL + "            }" + NL + "          } else {" + NL + "            ftpClient.get(localFileName, remoteFileName);" + NL + "            msg_";
  protected final String TEXT_117 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_118 = NL + "              System.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");";
  protected final String TEXT_119 = NL + "            globalMap.put(\"";
  protected final String TEXT_120 = "_CURRENT_STATUS\", \"File transfer OK.\");" + NL + "          }";
  protected final String TEXT_121 = NL + "      } catch (com.enterprisedt.net.ftp.FTPException e) {" + NL + "        msg_";
  protected final String TEXT_122 = ".add(\"file [\" + remoteFileName + \"] downloaded unsuccessfully.\");" + NL + "        globalMap.put(\"";
  protected final String TEXT_123 = "_CURRENT_STATUS\", \"File transfer fail.\");" + NL + "        throw e;" + NL + "      }" + NL + "      count++;" + NL + "    }" + NL + "  }" + NL + "  com.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_124 = " = null;" + NL;
  protected final String TEXT_125 = NL + "    ftp_";
  protected final String TEXT_126 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_127 = "\");";
  protected final String TEXT_128 = "    " + NL + "    ftp_";
  protected final String TEXT_129 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_130 = ".setRemoteHost(";
  protected final String TEXT_131 = ");" + NL + "    ftp_";
  protected final String TEXT_132 = ".setRemotePort(";
  ...
  protected final String TEXT_141 = ".connect();" + NL + "    ftp_";
  protected final String TEXT_142 = ".login(";
  protected final String TEXT_143 = ", ";
  protected final String TEXT_144 = ");  ";
  protected final String TEXT_145 = NL + "  msg_";
  protected final String TEXT_146 = ".clearAll();" + NL + "  FTPGetter_";
  protected final String TEXT_147 = " getter_";
  protected final String TEXT_148 = " = new FTPGetter_";
  protected final String TEXT_149 = "();" + NL + "  getter_";
  protected final String TEXT_150 = ".ftpClient = ftp_";
  protected final String TEXT_151 = ";" + NL + "  String remotedir_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";" + NL + "  ftp_";
  protected final String TEXT_154 = ".chdir(remotedir_";
  protected final String TEXT_155 = ");";
  protected final String TEXT_156 = NL + "  class FTPSGetter_";
  protected final String TEXT_157 = " {" + NL + "    private it.sauronsoftware.ftp4j.FTPClient ftpClient = null;" + NL + "    private int count = 0;" + NL + "" + NL + "    public void getAllFiles(String remoteDirectory, String localDirectory)" + NL + "      throws IllegalStateException, IOException, java.io.FileNotFoundException," + NL + "      it.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException, " + NL + "      it.sauronsoftware.ftp4j.FTPDataTransferException, it.sauronsoftware.ftp4j.FTPAbortedException, " + NL + "      it.sauronsoftware.ftp4j.FTPListParseException {" + NL + "" + NL + "      ftpClient.changeDirectory(remoteDirectory);" + NL + "      String path = ftpClient.currentDirectory();" + NL + "      it.sauronsoftware.ftp4j.FTPFile[] ftpFiles = null;" + NL + "      ftpFiles = ftpClient.list();" + NL + "" + NL + "      for (it.sauronsoftware.ftp4j.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "        if (ftpFile.getType() == it.sauronsoftware.ftp4j.FTPFile.TYPE_DIRECTORY) {" + NL + "" + NL + "          if ((!(\".\").equals(ftpFile.getName())) && (!(\"..\").equals(ftpFile.getName()))) {" + NL + "            java.io.File localFile = new java.io.File(localDirectory + \"/\" + ftpFile.getName());" + NL + "" + NL + "            if (!localFile.exists()) {" + NL + "              localFile.mkdir();" + NL + "            }" + NL + "            getAllFiles(path + \"/\" + ftpFile.getName(), localDirectory + \"/\" + ftpFile.getName());" + NL + "            ftpClient.changeDirectory(path);" + NL + "          }" + NL + "        } else if (ftpFile.getType() != it.sauronsoftware.ftp4j.FTPFile.TYPE_LINK) {" + NL + "          downloadFile(localDirectory + \"/\" + ftpFile.getName(),ftpFile.getName());" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "" + NL + "    public void getFiles(String remoteDirectory, String localDirectory, String maskStr) " + NL + "      throws IllegalStateException, IOException, java.io.FileNotFoundException," + NL + "      it.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException, " + NL + "      it.sauronsoftware.ftp4j.FTPDataTransferException, it.sauronsoftware.ftp4j.FTPAbortedException, " + NL + "      it.sauronsoftware.ftp4j.FTPListParseException {" + NL + "" + NL + "      ftpClient.changeDirectory(remoteDirectory);" + NL + "      it.sauronsoftware.ftp4j.FTPFile[] ftpFiles = null;" + NL + "      ftpFiles = ftpClient.list(\".\");" + NL + "" + NL + "      for(it.sauronsoftware.ftp4j.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "        if ((ftpFile.getType() != it.sauronsoftware.ftp4j.FTPFile.TYPE_DIRECTORY) && (ftpFile.getType() != it.sauronsoftware.ftp4j.FTPFile.TYPE_LINK)) {" + NL + "          String fileName = ftpFile.getName();" + NL + "" + NL + "          if (fileName.matches(maskStr)) {" + NL + "            downloadFile(localDirectory + \"/\" + fileName,fileName);" + NL + "          }" + NL + "        }" + NL + "      }" + NL + "    }" + NL + "" + NL + "    public void chdir(String path) " + NL + "      throws IllegalStateException, IOException, " + NL + "      it.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException {" + NL + "      ftpClient.changeDirectory(path);" + NL + "    }" + NL + "" + NL + "    public String pwd() " + NL + "      throws IllegalStateException, IOException, " + NL + "      it.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException {" + NL + "      return ftpClient.currentDirectory();" + NL + "    }" + NL + "" + NL + "    private void downloadFile(String localFileName, String remoteFileName) " + NL + "      throws IllegalStateException, java.io.FileNotFoundException, IOException, " + NL + "      it.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException, " + NL + "      it.sauronsoftware.ftp4j.FTPDataTransferException, it.sauronsoftware.ftp4j.FTPAbortedException {" + NL + "      " + NL + "      java.io.File localFile = new java.io.File(localFileName);" + NL + "      ftpClient.download(remoteFileName, localFile);" + NL + "      count++;" + NL + "    }" + NL + "  }" + NL;
  protected final String TEXT_158 = NL + NL + "    class MyTrust_";
  protected final String TEXT_159 = "{" + NL + "      private javax.net.ssl.TrustManager[] getTrustManagers() " + NL + "        throws java.security.KeyStoreException, java.security.NoSuchAlgorithmException, " + NL + "        java.security.cert.CertificateException, java.security.UnrecoverableKeyException," + NL + "        java.io.FileNotFoundException, java.io.IOException {" + NL + "" + NL + "        java.security.KeyStore ks = java.security.KeyStore.getInstance(\"JKS\");" + NL + "        ks.load(new java.io.FileInputStream(";
  protected final String TEXT_160 = "), ";
  protected final String TEXT_161 = ".toCharArray());" + NL + "        javax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "        tmf.init(ks);" + NL + "        return tmf.getTrustManagers();" + NL + "      }" + NL + "    }" + NL + "    MyTrust_";
  protected final String TEXT_162 = " myTrust_";
  protected final String TEXT_163 = "= null;";
  protected final String TEXT_164 = NL + "  javax.net.ssl.SSLContext sslContext = null;" + NL + "  javax.net.ssl.TrustManager[] trustManager = null;" + NL + "  javax.net.ssl.SSLSocketFactory sslSocketFactory = null;" + NL + "  it.sauronsoftware.ftp4j.FTPClient ftp_";
  protected final String TEXT_165 = " =null;" + NL + "  FTPSGetter_";
  protected final String TEXT_166 = " getter_";
  protected final String TEXT_167 = " = null;" + NL + "  String remotedir_";
  protected final String TEXT_168 = " = null;" + NL + "" + NL + "  try {";
  protected final String TEXT_169 = NL + "      sslContext = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "      myTrust_";
  protected final String TEXT_170 = " = new MyTrust_";
  protected final String TEXT_171 = "();" + NL + "      trustManager = myTrust_";
  protected final String TEXT_172 = ".getTrustManagers();" + NL + "      sslContext.init(null, trustManager, new java.security.SecureRandom());" + NL + "      sslSocketFactory = sslContext.getSocketFactory();" + NL + "      ftp_";
  protected final String TEXT_173 = " = new it.sauronsoftware.ftp4j.FTPClient();" + NL + "      ftp_";
  protected final String TEXT_174 = ".setSSLSocketFactory(sslSocketFactory);";
  protected final String TEXT_175 = NL + "\t\tftp_";
  protected final String TEXT_176 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS);";
  protected final String TEXT_177 = NL + "    \tftp_";
  protected final String TEXT_178 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES);";
  protected final String TEXT_179 = NL + "      ftp_";
  protected final String TEXT_180 = ".connect(";
  protected final String TEXT_181 = ",";
  protected final String TEXT_182 = ");" + NL + "      ftp_";
  protected final String TEXT_183 = ".login(";
  protected final String TEXT_184 = ", ";
  protected final String TEXT_185 = ");";
  protected final String TEXT_186 = NL + "      ftp_";
  protected final String TEXT_187 = " = (it.sauronsoftware.ftp4j.FTPClient)globalMap.get(\"";
  protected final String TEXT_188 = "\");";
  protected final String TEXT_189 = NL + "    getter_";
  protected final String TEXT_190 = " = new FTPSGetter_";
  protected final String TEXT_191 = "();" + NL + "    getter_";
  protected final String TEXT_192 = ".ftpClient = ftp_";
  protected final String TEXT_193 = ";" + NL + "    remotedir_";
  protected final String TEXT_194 = " = ";
  protected final String TEXT_195 = ";" + NL + "    ftp_";
  protected final String TEXT_196 = ".changeDirectory(remotedir_";
  protected final String TEXT_197 = ");" + NL + "  } catch (java.lang.IllegalStateException e) {" + NL + "    e.printStackTrace();" + NL + "  } catch (java.io.IOException e) {" + NL + "    e.printStackTrace();" + NL + "  } catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) {" + NL + "    e.printStackTrace();" + NL + "  } catch (it.sauronsoftware.ftp4j.FTPException e) {" + NL + "    e.printStackTrace();" + NL + "  }";
  protected final String TEXT_198 = NL + "java.util.List<String> maskList_";
  protected final String TEXT_199 = " = new java.util.ArrayList<String>();" + NL;
  protected final String TEXT_200 = "    " + NL + "  maskList_";
  protected final String TEXT_201 = ".add(";
  protected final String TEXT_202 = ");       ";
  protected final String TEXT_203 = "  " + NL + "    ftp_";
  protected final String TEXT_204 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.BINARY);";
  protected final String TEXT_205 = "  " + NL + "    ftp_";
  protected final String TEXT_206 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.ASCII);";
  protected final String TEXT_207 = NL + "String localdir_";
  protected final String TEXT_208 = "  = ";
  protected final String TEXT_209 = ";  " + NL + "//create folder if local direcotry (assigned by property) not exists" + NL + "java.io.File dirHandle_";
  protected final String TEXT_210 = " = new java.io.File(localdir_";
  protected final String TEXT_211 = ");" + NL + "" + NL + "if (!dirHandle_";
  protected final String TEXT_212 = ".exists()) {" + NL + "  dirHandle_";
  protected final String TEXT_213 = ".mkdirs();" + NL + "}" + NL + "String root_";
  protected final String TEXT_214 = " = getter_";
  protected final String TEXT_215 = ".pwd();" + NL + "" + NL + "for (String maskStr_";
  protected final String TEXT_216 = " : maskList_";
