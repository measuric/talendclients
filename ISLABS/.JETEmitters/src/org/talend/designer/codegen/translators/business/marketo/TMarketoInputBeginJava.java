...
public class TMarketoInputBeginJava
{
  ...
  protected final String TEXT_42 = ");" + NL + "\t\t\t\t}catch(java.lang.Exception ex_";
  ...
  protected final String TEXT_48 = NL + "\t\t\t\t}" + NL + "\t\t\t}catch(java.lang.Exception ex_";
  ...
  protected final String TEXT_84 = ");" + NL + "            \t}catch(java.lang.Exception ex_";
  ...
  protected final String TEXT_129 = ");" + NL + "\t\t\t\t\t}catch(java.lang.Exception ex_";
