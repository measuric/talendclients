...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_7 = " = 0;" + NL + "int nb_line_copied_";
  protected final String TEXT_8 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_9 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_10 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_11 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_12 = "=0;" + NL + "int copiedCount_";
  protected final String TEXT_13 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_14 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_15 = " = null;" + NL + "boolean whetherReject_";
  ...
  protected final String TEXT_33 = NL + "\t\t   \t\t dbschema_";
  protected final String TEXT_34 = " = ";
  protected final String TEXT_35 = ";\t" + NL + "\t\t\t";
  protected final String TEXT_36 = NL + "\t \t\t\t\tjava.lang.Class.forName(\"com.vertica.jdbc.Driver\");" + NL + "\t\t\t";
  protected final String TEXT_37 = NL + "\t\t\t\t\tjava.lang.Class.forName(\"com.vertica.Driver\");" + NL + "\t\t\t";
  protected final String TEXT_38 = NL + "\t\t\t\tString url_";
  protected final String TEXT_39 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_60 = ".setAutoCommit(false);" + NL + "        " + NL + "int commitEvery_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "        " + NL + "int commitCounter_";
  protected final String TEXT_63 = " = 0;        ";
  protected final String TEXT_64 = NL + "   int batchSize_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_80 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_81 = " + \"_proj (";
  protected final String TEXT_82 = ") AS SELECT ";
  protected final String TEXT_83 = " FROM \" + tableName_";
  ...
  protected final String TEXT_91 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_92 = " + \"_proj (";
  protected final String TEXT_93 = ") AS SELECT ";
  protected final String TEXT_94 = " FROM \" + tableName_";
  ...
  protected final String TEXT_104 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_105 = ".equalsIgnoreCase(";
  protected final String TEXT_106 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_107 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_115 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_116 = " + \"_proj (";
  protected final String TEXT_117 = ") AS SELECT ";
  protected final String TEXT_118 = " FROM \" + tableName_";
  ...
  protected final String TEXT_133 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_134 = " + \"_proj (";
  protected final String TEXT_135 = ") AS SELECT ";
  protected final String TEXT_136 = " FROM \" + tableName_";
  protected final String TEXT_137 = ");//";
  protected final String TEXT_138 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_141 = " = stmtClear_";
  protected final String TEXT_142 = ".executeUpdate(\"";
  protected final String TEXT_143 = "\");";
  protected final String TEXT_144 = NL + "        String insert_";
  protected final String TEXT_145 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_150 = ".prepareStatement(insert_";
  protected final String TEXT_151 = ");";
  protected final String TEXT_152 = NL + "        int batchCount_";
  protected final String TEXT_153 = " = 0;";
  protected final String TEXT_154 = NL + "        String update_";
  protected final String TEXT_155 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_160 = ".prepareStatement(update_";
  protected final String TEXT_161 = ");";
  protected final String TEXT_162 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_165 = " + \" WHERE ";
  protected final String TEXT_166 = "\");" + NL + "        String insert_";
  protected final String TEXT_167 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_168 = " + \" (";
  protected final String TEXT_169 = ") VALUES (";
  protected final String TEXT_170 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_174 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_175 = " + \" SET ";
  protected final String TEXT_176 = " WHERE ";
  protected final String TEXT_177 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_182 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_188 = ");" + NL + "        String insert_";
  protected final String TEXT_189 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_190 = " + \" (";
  protected final String TEXT_191 = ") VALUES (";
  protected final String TEXT_192 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".prepareStatement(insert_";
  protected final String TEXT_195 = ");        ";
  protected final String TEXT_196 = NL + "        String delete_";
  protected final String TEXT_197 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_198 = " + \" WHERE ";
  protected final String TEXT_199 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".prepareStatement(delete_";
  protected final String TEXT_202 = ");";
  protected final String TEXT_203 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_204 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".createStatement();\t" + NL + "        String template_";
  protected final String TEXT_207 = " = \"COPY \" + tableName_";
  protected final String TEXT_208 = " +\" (";
  protected final String TEXT_209 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_210 = "DIRECT";
  protected final String TEXT_211 = "\";" + NL + "\t\t";
  protected final String TEXT_212 = NL + "        StringBuffer query_";
  protected final String TEXT_213 = " = null;" + NL + "       \t";
  protected final String TEXT_214 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_215 = " = insert_";
  protected final String TEXT_216 = ".split(\"\\\\?\");";
  protected final String TEXT_217 = NL + "\t\t\tupdate_";
  protected final String TEXT_218 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_219 = " = update_";
  protected final String TEXT_220 = ".split(\"\\\\?\");";
  protected final String TEXT_221 = NL + "\t\t\tupdate_";
  protected final String TEXT_222 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_223 = " = update_";
  protected final String TEXT_224 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_225 = " = insert_";
  protected final String TEXT_226 = ".split(\"\\\\?\");";
  protected final String TEXT_227 = NL + "\t\t\tdelete_";
  protected final String TEXT_228 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_229 = " = delete_";
  protected final String TEXT_230 = ".split(\"\\\\?\");";
  protected final String TEXT_231 = NL + "\t\t\treplace_";
  protected final String TEXT_232 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_233 = " = replace_";
  protected final String TEXT_234 = ".split(\"\\\\?\");";
  protected final String TEXT_235 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_236 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_237 = " = insertIgnore_";
