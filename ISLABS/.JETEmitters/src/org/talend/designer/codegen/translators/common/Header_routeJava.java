...
public class Header_routeJava
{
  ...
  protected final String TEXT_17 = NL + "\t\t\t//ESB Service Activity Monitor Feature" + NL + "\t\t\tprivate org.apache.cxf.feature.AbstractFeature eventFeature;" + NL + "" + NL + "\t\t\tpublic void setEventFeature(org.apache.cxf.feature.AbstractFeature eventFeature) {" + NL + "\t\t\t\tthis.eventFeature = eventFeature;" + NL + "\t\t\t}" + NL + "\t\t\t";
