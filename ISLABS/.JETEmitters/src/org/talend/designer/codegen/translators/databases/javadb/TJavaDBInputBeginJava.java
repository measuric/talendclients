...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_92 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_93 = ");";
  protected final String TEXT_94 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_95 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_96 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_97 = "),Integer.parseInt(";
  protected final String TEXT_98 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_99 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_100 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_101 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_102 = " && timeOut_";
  protected final String TEXT_103 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_104 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_105 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_106 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_107 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tSystem.exit(1);\t" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_108 = NL + "\t\t\t\tString url_";
  protected final String TEXT_109 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_110 = ";";
  protected final String TEXT_111 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_112 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_113 = " + \":\" + ";
  protected final String TEXT_114 = " + \"/\" + ";
  protected final String TEXT_115 = ";";
  protected final String TEXT_116 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_117 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_118 = " + \":\" + ";
  protected final String TEXT_119 = " + \"/\" + ";
  protected final String TEXT_120 = ";";
  protected final String TEXT_121 = NL + "\t\t\t    java.lang.Class.forName(\"";
  protected final String TEXT_122 = "\").newInstance();" + NL + "\t\t\t\t";
  protected final String TEXT_123 = NL + "\t\t        String dbUser_";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = ";" + NL + "\t\t        String dbPwd_";
  ...
  protected final String TEXT_133 = NL + "\t\t    int nb_line_";
  protected final String TEXT_134 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_135 = " = null;";
  protected final String TEXT_136 = NL + "\t\t        conn_";
  protected final String TEXT_137 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_138 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_139 = ") {";
  protected final String TEXT_140 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_141 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_142 = " = dataSources_";
  protected final String TEXT_143 = ".get(";
  protected final String TEXT_144 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_145 = "\", conn_";
  protected final String TEXT_146 = ");" + NL + "\t\t        }";
  protected final String TEXT_147 = NL + NL + "\t\t    ";
  protected final String TEXT_148 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_149 = " = ";
  protected final String TEXT_150 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_151 = "_QUERY\",dbquery_";
  protected final String TEXT_152 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_153 = " = stmt_";
  protected final String TEXT_154 = ".executeQuery(dbquery_";
  protected final String TEXT_155 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_156 = " = rs_";
  protected final String TEXT_157 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_158 = " = rsmd_";
  protected final String TEXT_159 = ".getColumnCount();" + NL;
  protected final String TEXT_160 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_161 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_162 = ".setDbmsId(\"";
  protected final String TEXT_163 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_164 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_165 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_166 = ".add(\"";
  protected final String TEXT_167 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_168 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_171 = "; i <= rsmd_";
  protected final String TEXT_172 = ".getColumnCount()-";
  protected final String TEXT_173 = "; i++) {" + NL + "                if (!(listSchema_";
  ...
  protected final String TEXT_212 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_213 = " =1;" + NL + "\t\t    while (rs_";
  protected final String TEXT_214 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_215 = "++;" + NL + "\t\t        ";
  protected final String TEXT_216 = NL + "\t\t                        column_index_";
  protected final String TEXT_217 = " = ";
  protected final String TEXT_218 = " + dcg_";
  protected final String TEXT_219 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_220 = NL + "\t\t                        column_index_";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ";" + NL + "\t\t                    ";
  protected final String TEXT_223 = NL + "\t\t                    if(colQtyInRs_";
  protected final String TEXT_224 = " < column_index_";
  ...
  protected final String TEXT_235 = " = (List)rs_";
  protected final String TEXT_236 = ".getObject(column_index_";
  protected final String TEXT_237 = ");";
  protected final String TEXT_238 = NL + "\t\t                         ";
  protected final String TEXT_239 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_240 = ".getObject(column_index_";
  protected final String TEXT_241 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_242 = NL + "                                    ";
  protected final String TEXT_243 = ".";
  protected final String TEXT_244 = " = new Geometry(wktValue);";
  protected final String TEXT_245 = NL + "                                        ";
  protected final String TEXT_246 = ".";
  protected final String TEXT_247 = ".setEPSG(";
  protected final String TEXT_248 = ");";
  protected final String TEXT_249 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_250 = NL + "                                  ";
  protected final String TEXT_251 = ".";
  protected final String TEXT_252 = "=dcg_";
  protected final String TEXT_253 = ";";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_255 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_256 = " = ";
  protected final String TEXT_257 = "; i_";
  protected final String TEXT_258 = "  <= rsmd_";
  protected final String TEXT_259 = ".getColumnCount(); i_";
  protected final String TEXT_260 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_261 = ".getColumnTypeName(i_";
  protected final String TEXT_262 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_263 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_264 = ".getClob(i_";
  protected final String TEXT_265 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_266 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_267 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_268 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_269 = ".add(tNTextImpl_";
  protected final String TEXT_270 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_271 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_272 = ".";
  protected final String TEXT_273 = ", rs_";
  protected final String TEXT_274 = ", fixedColumnCount_";
  protected final String TEXT_275 = ",list_";
  protected final String TEXT_276 = ");";
  protected final String TEXT_277 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_278 = ".";
  protected final String TEXT_279 = ", rs_";
  protected final String TEXT_280 = ", fixedColumnCount_";
  protected final String TEXT_281 = ");";
  protected final String TEXT_282 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_283 = ".getObject(column_index_";
  protected final String TEXT_284 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_285 = ".";
  protected final String TEXT_286 = " = new Geometry(sb.toString());";
