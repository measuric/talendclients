...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_93 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_94 = ";";
  protected final String TEXT_95 = NL + "\t\t\t    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_132 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_133 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_134 = ".add(\"";
  protected final String TEXT_135 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_136 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_137 = " = ";
  protected final String TEXT_138 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_139 = "; i <= rsmd_";
  protected final String TEXT_140 = ".getColumnCount()-";
  protected final String TEXT_141 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_142 = ".contains(rsmd_";
  protected final String TEXT_143 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_144 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_145 = ".setName(rsmd_";
  protected final String TEXT_146 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_147 = ".setDbName(rsmd_";
  protected final String TEXT_148 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_149 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_150 = "\", rsmd_";
  protected final String TEXT_151 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_152 = ".getPrecision(i), rsmd_";
  protected final String TEXT_153 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_154 = ".setDbType(rsmd_";
  protected final String TEXT_155 = ".getColumnTypeName(i));";
  protected final String TEXT_156 = NL + "                \tdcm_";
  protected final String TEXT_157 = ".setFormat(";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_160 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_161 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_162 = ".setLength(rsmd_";
  protected final String TEXT_163 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_164 = ".setLength(rsmd_";
  protected final String TEXT_165 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_166 = NL + "\t\t\tdcm_";
  protected final String TEXT_167 = ".setLength(rsmd_";
  protected final String TEXT_168 = ".getPrecision(i));";
  protected final String TEXT_169 = NL + "                \tdcm_";
  protected final String TEXT_170 = ".setPrecision(rsmd_";
  protected final String TEXT_171 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_172 = ".setNullable(rsmd_";
  protected final String TEXT_173 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_174 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_175 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_176 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_177 = ".metadatas.add(dcm_";
  protected final String TEXT_178 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_179 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_180 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_181 = " =1;" + NL + "\t\t    while (rs_";
  protected final String TEXT_182 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_183 = "++;" + NL + "\t\t        ";
  protected final String TEXT_184 = NL + "\t\t                        column_index_";
  protected final String TEXT_185 = " = ";
  protected final String TEXT_186 = " + dcg_";
  protected final String TEXT_187 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_188 = NL + "\t\t                        column_index_";
  protected final String TEXT_189 = " = ";
  protected final String TEXT_190 = ";" + NL + "\t\t                    ";
  protected final String TEXT_191 = NL + "\t\t                    if(colQtyInRs_";
  protected final String TEXT_192 = " < column_index_";
  ...
  protected final String TEXT_203 = " = (List)rs_";
  protected final String TEXT_204 = ".getObject(column_index_";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "\t\t                         ";
  protected final String TEXT_207 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_208 = ".getObject(column_index_";
  protected final String TEXT_209 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_210 = NL + "                                    ";
  protected final String TEXT_211 = ".";
  protected final String TEXT_212 = " = new Geometry(wktValue);";
  protected final String TEXT_213 = NL + "                                        ";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = ".setEPSG(";
  ...
  protected final String TEXT_222 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_223 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_224 = " = ";
  protected final String TEXT_225 = "; i_";
  protected final String TEXT_226 = "  <= rsmd_";
  protected final String TEXT_227 = ".getColumnCount(); i_";
  protected final String TEXT_228 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_229 = ".getColumnTypeName(i_";
  protected final String TEXT_230 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_231 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_232 = ".getClob(i_";
  protected final String TEXT_233 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_234 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_235 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_236 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_237 = ".add(tNTextImpl_";
  protected final String TEXT_238 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_239 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_245 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_246 = ".";
  protected final String TEXT_247 = ", rs_";
  protected final String TEXT_248 = ", fixedColumnCount_";
  protected final String TEXT_249 = ");";
  protected final String TEXT_250 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_251 = ".getObject(column_index_";
  protected final String TEXT_252 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_253 = ".";
  protected final String TEXT_254 = " = new Geometry(sb.toString());";
