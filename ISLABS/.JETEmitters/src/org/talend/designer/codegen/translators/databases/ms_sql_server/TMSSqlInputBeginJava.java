...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_92 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_93 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_94 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_95 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_96 = ", talendToDBArray_";
  ...
  protected final String TEXT_106 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_107 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_108 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_109 = " += \":\" + ";
  protected final String TEXT_110 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_111 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_112 = " += \"//\" + ";
  protected final String TEXT_113 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_114 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_115 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_116 = " = ";
  protected final String TEXT_117 = ";";
  protected final String TEXT_118 = NL + "\t\t\t";
  protected final String TEXT_119 = ".";
  protected final String TEXT_120 = " = mssqlGTU_";
  protected final String TEXT_121 = ".getDate(rsmd_";
  protected final String TEXT_122 = ", rs_";
  protected final String TEXT_123 = ", column_index_";
  protected final String TEXT_124 = ");" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_126 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_127 = ".getClob(";
  protected final String TEXT_128 = ");" + NL + "\t\t\t\tif(clob_";
  protected final String TEXT_129 = "!=null){" + NL + "\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_130 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_131 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_132 = " = tNTextImpl_";
  protected final String TEXT_133 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_134 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_135 = NL + "           \t\ttmpContent_";
  protected final String TEXT_136 = " = rs_";
  protected final String TEXT_137 = ".getString(column_index_";
  protected final String TEXT_138 = ");";
  protected final String TEXT_139 = NL + "            if(tmpContent_";
  protected final String TEXT_140 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_141 = " .contains(rsmd_";
  protected final String TEXT_142 = ".getColumnTypeName(column_index_";
  protected final String TEXT_143 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_146 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_147 = ".";
  protected final String TEXT_148 = " = tmpContent_";
  protected final String TEXT_149 = ";" + NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_316 = NL + NL + NL + NL + NL;
