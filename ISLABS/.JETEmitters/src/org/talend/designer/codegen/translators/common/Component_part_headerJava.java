...
public class Component_part_headerJava
{
  ...
  protected final String TEXT_32 = NL + NL + "if (execStat) {" + NL + "    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap_";
  protected final String TEXT_33 = " = (java.util.concurrent.ConcurrentHashMap) globalMap.get(\"concurrentHashMap\");" + NL + "\tconcurrentHashMap_";
  protected final String TEXT_34 = ".putIfAbsent(\"";
  protected final String TEXT_35 = "\" + iterateLoop,new java.util.concurrent.atomic.AtomicInteger(0));" + NL + "\tjava.util.concurrent.atomic.AtomicInteger stats_";
  protected final String TEXT_36 = " = (java.util.concurrent.atomic.AtomicInteger) concurrentHashMap_";
  protected final String TEXT_37 = ".get(\"";
  protected final String TEXT_38 = "\" + iterateLoop);" + NL + "\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_39 = "\" + iterateId, stats_";
  protected final String TEXT_40 = ".incrementAndGet()<=1?0:1, 0);" + NL + "} " + NL;
  ...
  protected final String TEXT_45 = "\"+iterateId,1, 1);" + NL + " } ";
  protected final String TEXT_46 = NL + "if(execStat){" + NL + " runStat.updateStatOnConnection(\"";
  protected final String TEXT_47 = "\"+iterateId,1, 1);" + NL + "} ";
  protected final String TEXT_48 = NL;
  protected final String TEXT_49 = NL;
  protected final String TEXT_50 = NL + "\tint tos_count_";
