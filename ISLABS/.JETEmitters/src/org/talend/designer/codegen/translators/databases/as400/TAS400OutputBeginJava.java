...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_16 = " = 0;" + NL + "" + NL + "int nb_line_rejected_";
  protected final String TEXT_17 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_18 = "=0;" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_19 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_20 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_21 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_22 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_23 = " = ";
  protected final String TEXT_24 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_25 = " = false;" + NL + NL;
  ...
  protected final String TEXT_29 = NL + "    String dbProperties_";
  protected final String TEXT_30 = " = ";
  protected final String TEXT_31 = ";" + NL + "    String url_";
  protected final String TEXT_32 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_33 = " == null || dbProperties_";
  protected final String TEXT_34 = ".trim().length() == 0) {" + NL + "        url_";
  protected final String TEXT_35 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_36 = " + \"/\" + ";
  protected final String TEXT_37 = ";" + NL + "    } else {" + NL + "        url_";
  protected final String TEXT_38 = " = \"jdbc:as400://\" + ";
  ...
  protected final String TEXT_45 = ";    " + NL + "    java.lang.Class.forName(\"com.ibm.as400.access.AS400JDBCDriver\");" + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_51 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";                " + NL + "            int commitCounter_";
  protected final String TEXT_54 = " = 0;                ";
  protected final String TEXT_55 = NL + "       int batchSize_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_58 = "=0;";
  protected final String TEXT_59 = NL + "int count_";
  ...
  protected final String TEXT_78 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_88 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_89 = " = conn_";
  protected final String TEXT_90 = ".createStatement();";
  ...
  protected final String TEXT_100 = ", \"+DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = ", \"";
  protected final String TEXT_103 = "\")+\")";
  protected final String TEXT_104 = "\");";
  protected final String TEXT_105 = NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_111 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_112 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_119 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_122 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_123 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_124 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_125 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_282 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_288 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_289 = NL + "\t    String update_";
  protected final String TEXT_290 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_299 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_300 = " + \" WHERE ";
  protected final String TEXT_301 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_302 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_309 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_317 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_324 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_332 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_369 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_370 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_371 = " =null;";
  protected final String TEXT_372 = NL + NL + NL;
