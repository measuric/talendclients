...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_151 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_157 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_158 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_159 = " = tableNameForSearch_";
  protected final String TEXT_160 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_161 = " = tableNameForSearch_";
  protected final String TEXT_162 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_163 = " = dbMetaData_";
  protected final String TEXT_164 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_165 = ", tableNameForSearch_";
  protected final String TEXT_166 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_167 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_168 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_169 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_298 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_299 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_300 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_301 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_302 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_303 = ".append (\"`\" +  ";
  protected final String TEXT_304 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_305 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_306 = ".append (";
  protected final String TEXT_307 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t       ";
  protected final String TEXT_309 = NL + "\t\t        String insert_";
  protected final String TEXT_310 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_311 = " + \"` (";
  protected final String TEXT_312 = ") VALUES (";
  protected final String TEXT_313 = ")\";";
  protected final String TEXT_314 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_315 = " += \tduplidateClause_";
  protected final String TEXT_316 = ".toString();";
  protected final String TEXT_317 = NL + "\t\t\t\t";
  protected final String TEXT_318 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_319 = " = new StringBuffer(insert_";
  protected final String TEXT_320 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_321 = ".insert(insert_";
  protected final String TEXT_322 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_323 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_324 = " =insertStringBuffer_";
  protected final String TEXT_325 = ".toString(); ";
  protected final String TEXT_326 = "    " + NL;
  protected final String TEXT_327 = NL + "                        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_333 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_334 = " = conn_";
  protected final String TEXT_335 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_336 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_337 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_338 = ",insert_";
  protected final String TEXT_339 = ",keyPsmt_";
  protected final String TEXT_340 = ");";
  protected final String TEXT_341 = NL + "\t        \t        ";
  protected final String TEXT_342 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_343 = " {" + NL + "    \t            ";
  protected final String TEXT_344 = NL + "                            ";
  protected final String TEXT_345 = " ";
  protected final String TEXT_346 = ";                ";
  protected final String TEXT_347 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_356 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_357 = "> exInsertColValueList";
  protected final String TEXT_358 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_359 = " exInsertColValue";
  protected final String TEXT_360 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_361 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_362 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_363 = ".append(\"(";
  protected final String TEXT_364 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_365 = "-1) extendInsertValueStmt_";
  protected final String TEXT_366 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_367 = " = \"INSERT INTO `\"+";
  protected final String TEXT_368 = "+\"` (";
  protected final String TEXT_369 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_370 = ".toString();";
  protected final String TEXT_371 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_372 = " += \tduplidateClause_";
  protected final String TEXT_373 = ".toString();";
  protected final String TEXT_374 = NL + "\t\t\t\t";
  protected final String TEXT_375 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_376 = " = new StringBuffer(insert_";
  protected final String TEXT_377 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_378 = ".insert(insert_";
  protected final String TEXT_379 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_380 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_381 = " =insertStringBuffer_";
  protected final String TEXT_382 = ".toString(); ";
  protected final String TEXT_383 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_384 = " =  conn_";
  protected final String TEXT_385 = ".prepareStatement(insert_";
  protected final String TEXT_386 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_387 = " = \"";
  protected final String TEXT_388 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_389 = " =  \"";
  protected final String TEXT_390 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_391 = " = 0;\t ";
  protected final String TEXT_392 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_393 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_394 = " + \"` (";
  protected final String TEXT_395 = ") VALUES (";
  protected final String TEXT_396 = ")\";";
  protected final String TEXT_397 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_398 = " += \tduplidateClause_";
  protected final String TEXT_399 = ".toString();";
  protected final String TEXT_400 = NL + "\t\t        int batchSize_";
  protected final String TEXT_401 = " = ";
  protected final String TEXT_402 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_403 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_404 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_405 = " = new StringBuffer(insert_";
  protected final String TEXT_406 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_407 = ".insert(insert_";
  protected final String TEXT_408 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_409 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_410 = " =insertStringBuffer_";
  ...
  protected final String TEXT_417 = " = \"UPDATE `\" + ";
  protected final String TEXT_418 = " + \"` SET ";
  protected final String TEXT_419 = " WHERE ";
  protected final String TEXT_420 = "\";" + NL + "\t    ";
  protected final String TEXT_421 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_422 = " = new StringBuffer(update_";
  protected final String TEXT_423 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_424 = ".insert(update_";
  protected final String TEXT_425 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_426 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_427 = " =updateStringBuffer_";
  ...
  protected final String TEXT_435 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_436 = " + \"` WHERE ";
  protected final String TEXT_437 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_438 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_439 = " + \"` (";
  protected final String TEXT_440 = ") VALUES (";
  protected final String TEXT_441 = ")\";" + NL + "\t    ";
  protected final String TEXT_442 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_443 = " = new StringBuffer(insert_";
  protected final String TEXT_444 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_445 = ".insert(insert_";
  protected final String TEXT_446 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_447 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_448 = " =insertStringBuffer_";
  protected final String TEXT_449 = ".toString(); ";
  protected final String TEXT_450 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_454 = " = \"UPDATE `\" + ";
  protected final String TEXT_455 = " + \"` SET ";
  protected final String TEXT_456 = " WHERE ";
  protected final String TEXT_457 = "\";" + NL + "\t    ";
  protected final String TEXT_458 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_459 = " = new StringBuffer(update_";
  protected final String TEXT_460 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_461 = ".insert(update_";
  protected final String TEXT_462 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_463 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_464 = " =updateStringBuffer_";
  protected final String TEXT_465 = ".toString(); ";
  protected final String TEXT_466 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_471 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_487 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_488 = " + \"` (";
  protected final String TEXT_489 = ") VALUES (";
  protected final String TEXT_490 = ")\";" + NL + "\t     ";
  protected final String TEXT_491 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_492 = " = new StringBuffer(insert_";
  protected final String TEXT_493 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_494 = ".insert(insert_";
  protected final String TEXT_495 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_496 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_497 = " =insertStringBuffer_";
  protected final String TEXT_498 = ".toString(); ";
  protected final String TEXT_499 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_500 = " = conn_";
  protected final String TEXT_501 = ".prepareStatement(insert_";
  protected final String TEXT_502 = ");\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_503 = NL + "\t    String delete_";
  protected final String TEXT_504 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_505 = " + \"` WHERE ";
  protected final String TEXT_506 = "\";" + NL + "\t    ";
  protected final String TEXT_507 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_508 = " = new StringBuffer(delete_";
  protected final String TEXT_509 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_510 = ".insert(delete_";
  protected final String TEXT_511 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_512 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_513 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_519 = NL + "\t    String replace_";
  protected final String TEXT_520 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_525 = ".prepareStatement(replace_";
  protected final String TEXT_526 = ");" + NL + "\t    ";
  protected final String TEXT_527 = NL + "\t    String insertIgnore_";
  protected final String TEXT_528 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_529 = " + \"` (";
  protected final String TEXT_530 = ") VALUES (";
  protected final String TEXT_531 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_532 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_533 = " = conn_";
  protected final String TEXT_534 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_535 = ");" + NL + "\t    ";
  protected final String TEXT_536 = NL + "\t    String insert_";
  protected final String TEXT_537 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_538 = " + \"` (";
  protected final String TEXT_539 = ") VALUES (";
  protected final String TEXT_540 = ")\";" + NL + "\t    ";
  protected final String TEXT_541 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_542 = " = new StringBuffer(insert_";
  protected final String TEXT_543 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_544 = ".insert(insert_";
  protected final String TEXT_545 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_546 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_547 = " =insertStringBuffer_";
  ...
  protected final String TEXT_551 = ".prepareStatement(insert_";
  protected final String TEXT_552 = ");" + NL + "\t    ";
  protected final String TEXT_553 = NL + "        StringBuffer query_";
  protected final String TEXT_554 = " = null;" + NL + "       \t";
  protected final String TEXT_555 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_556 = " = insert_";
  ...
  protected final String TEXT_560 = " = update_";
  ...
  protected final String TEXT_564 = " = update_";
  protected final String TEXT_565 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_566 = " = insert_";
  protected final String TEXT_567 = ".split(\"\\\\?\");";
  protected final String TEXT_568 = NL + "\t\t\tdelete_";
  protected final String TEXT_569 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_570 = " = delete_";
  protected final String TEXT_571 = ".split(\"\\\\?\");";
  protected final String TEXT_572 = NL + "\t\t\treplace_";
  protected final String TEXT_573 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_574 = " = replace_";
  protected final String TEXT_575 = ".split(\"\\\\?\");";
  protected final String TEXT_576 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_577 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_578 = " = insertIgnore_";
  protected final String TEXT_579 = ".split(\"\\\\?\");";
  protected final String TEXT_580 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_581 = " = insert_";
  protected final String TEXT_582 = ".split(\"\\\\?\");";
  protected final String TEXT_583 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_584 = " {" + NL + "    \t            ";
  protected final String TEXT_585 = NL + "                            ";
  protected final String TEXT_586 = " ";
  protected final String TEXT_587 = ";                ";
  protected final String TEXT_588 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_589 = ";" + NL + "\t\t\t";
  protected final String TEXT_590 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_591 = "(";
  protected final String TEXT_592 = NL + "                                ,";
  protected final String TEXT_593 = NL + "                            ";
  protected final String TEXT_594 = " ";
  protected final String TEXT_595 = NL + "\t\t\t\t, Dynamic ";
  protected final String TEXT_596 = NL + "\t\t\t";
  protected final String TEXT_597 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_598 = NL + "                                this.";
  protected final String TEXT_599 = " = ";
  protected final String TEXT_600 = ";              ";
  protected final String TEXT_601 = NL + "\t\t\t\tthis.";
  protected final String TEXT_602 = "=";
  protected final String TEXT_603 = ";" + NL + "\t\t\t";
  protected final String TEXT_604 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_605 = "> exInsertColValueList";
  protected final String TEXT_606 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_607 = " exInsertColValue";
  protected final String TEXT_608 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_609 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_610 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_611 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_612 = "=1;";
  protected final String TEXT_613 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_614 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_615 = "=0;";
  protected final String TEXT_616 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_617 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_618 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_619 = " =null;" + NL + "\tint rowCount";
