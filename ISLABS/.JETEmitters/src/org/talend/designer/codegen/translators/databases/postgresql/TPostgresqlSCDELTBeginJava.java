...
public class TPostgresqlSCDELTBeginJava {
  ...
  protected final String TEXT_119 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  ...
  protected final String TEXT_145 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  ...
  protected final String TEXT_155 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  ...
  protected final String TEXT_175 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
