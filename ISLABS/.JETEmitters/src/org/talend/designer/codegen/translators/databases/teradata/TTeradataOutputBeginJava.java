...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_142 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_148 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_149 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_150 = " = tableNameForSearch_";
  protected final String TEXT_151 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_152 = " = tableNameForSearch_";
  protected final String TEXT_153 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_289 = NL + "\t    String insert_";
  protected final String TEXT_290 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_291 = " + \"\\\" (";
  protected final String TEXT_292 = ") VALUES (";
  ...
  protected final String TEXT_297 = NL + "\t    String update_";
  protected final String TEXT_298 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_305 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_306 = " = conn_";
  protected final String TEXT_307 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_308 = " + \"\\\" WHERE ";
  protected final String TEXT_309 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_310 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_311 = " + \"\\\" (";
  protected final String TEXT_312 = ") VALUES (";
  protected final String TEXT_313 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_328 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_335 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".prepareStatement(insert_";
  protected final String TEXT_338 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_339 = NL + "\t    String delete_";
  protected final String TEXT_340 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_344 = ".prepareStatement(delete_";
  protected final String TEXT_345 = ");" + NL + "\t    ";
  protected final String TEXT_346 = NL + "        StringBuffer query_";
  protected final String TEXT_347 = " = null;" + NL + "       \t";
  protected final String TEXT_348 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_349 = " = insert_";
  ...
  protected final String TEXT_355 = NL + "\t\t\tupdate_";
  protected final String TEXT_356 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_357 = " = update_";
  protected final String TEXT_358 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_359 = " = insert_";
  protected final String TEXT_360 = ".split(\"\\\\?\");";
  protected final String TEXT_361 = NL + "\t\t\tdelete_";
  protected final String TEXT_362 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_363 = " = delete_";
  protected final String TEXT_364 = ".split(\"\\\\?\");";
  protected final String TEXT_365 = NL + "\t\t\treplace_";
  protected final String TEXT_366 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_367 = " = replace_";
  protected final String TEXT_368 = ".split(\"\\\\?\");";
  protected final String TEXT_369 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_370 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_371 = " = insertIgnore_";
  protected final String TEXT_372 = ".split(\"\\\\?\");";
  protected final String TEXT_373 = NL + "\t\t \tString[] insertSQLSplits_";
