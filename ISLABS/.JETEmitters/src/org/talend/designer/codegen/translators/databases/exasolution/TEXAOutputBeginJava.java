...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_22 = " = false;" + NL + "" + NL + "" + NL + "    String dbProperties_";
  ...
  protected final String TEXT_28 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_29 = " + \":\" + ";
  protected final String TEXT_30 = "+ \";schema=\" + ";
  ...
  protected final String TEXT_40 = ";    " + NL + "     java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_46 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";                " + NL + "            int commitCounter_";
  ...
  protected final String TEXT_59 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_72 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_73 = ".equalsIgnoreCase(";
  protected final String TEXT_74 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_75 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_87 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_92 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_93 = " = conn_";
  protected final String TEXT_94 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_95 = " = deletedCount_";
  protected final String TEXT_96 = " + stmtClear_";
  protected final String TEXT_97 = ".executeUpdate(\"";
  protected final String TEXT_98 = "\");";
  protected final String TEXT_99 = NL + "\t    String insert_";
  protected final String TEXT_100 = " = \"INSERT INTO \" + ";
  protected final String TEXT_101 = " + \" (";
  protected final String TEXT_102 = ") VALUES (";
  protected final String TEXT_103 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_104 = " = conn_";
  protected final String TEXT_105 = ".prepareStatement(insert_";
  protected final String TEXT_106 = ");" + NL + "\t    ";
  protected final String TEXT_107 = NL + "\t    String update_";
  protected final String TEXT_108 = " = \"UPDATE \" + ";
  protected final String TEXT_109 = " + \" SET ";
  protected final String TEXT_110 = " WHERE ";
  protected final String TEXT_111 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_112 = " = conn_";
  protected final String TEXT_113 = ".prepareStatement(update_";
  protected final String TEXT_114 = ");" + NL + "\t    ";
  protected final String TEXT_115 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_116 = " = conn_";
  protected final String TEXT_117 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_118 = " + \" WHERE ";
  protected final String TEXT_119 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_120 = " = \"INSERT INTO \" + ";
  protected final String TEXT_121 = " + \" (";
  protected final String TEXT_122 = ") VALUES (";
  protected final String TEXT_123 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".prepareStatement(insert_";
  protected final String TEXT_126 = ");" + NL + "\t    String update_";
  protected final String TEXT_127 = " = \"UPDATE \" + ";
  protected final String TEXT_128 = " + \" SET ";
  protected final String TEXT_129 = " WHERE ";
  protected final String TEXT_130 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".prepareStatement(update_";
  protected final String TEXT_133 = ");" + NL + "\t    ";
  protected final String TEXT_134 = NL + "\t    String update_";
  protected final String TEXT_135 = " = \"UPDATE \" + ";
  protected final String TEXT_136 = " + \" SET ";
  protected final String TEXT_137 = " WHERE ";
  protected final String TEXT_138 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = ".prepareStatement(update_";
  protected final String TEXT_141 = ");" + NL + "\t    String insert_";
  protected final String TEXT_142 = " = \"INSERT INTO \" + ";
  protected final String TEXT_143 = " + \" (";
  protected final String TEXT_144 = ") VALUES (";
  protected final String TEXT_145 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".prepareStatement(insert_";
  protected final String TEXT_148 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_149 = NL + "\t    String delete_";
  protected final String TEXT_150 = " = \"DELETE FROM \" + ";
  protected final String TEXT_151 = " + \" WHERE ";
  protected final String TEXT_152 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_153 = " = conn_";
  protected final String TEXT_154 = ".prepareStatement(delete_";
  protected final String TEXT_155 = ");" + NL + "\t    ";
  protected final String TEXT_156 = NL + "        String query_";
