...
public class TTeradataFastLoadMainJava
{
  ...
  protected final String TEXT_112 = ".addBatch();" + NL + "        }catch(java.lang.Exception e)" + NL + "        {";
  ...
  protected final String TEXT_134 = ".addBatch();" + NL + "\t\t\t}catch(java.lang.Exception e)" + NL + "\t\t\t{" + NL + "\t            ";
  ...
  protected final String TEXT_147 = ".addBatch();" + NL + "\t\t\t}catch(java.lang.Exception e)" + NL + "\t\t\t{" + NL + "\t            ";
  ...
  protected final String TEXT_161 = ".addBatch();" + NL + "\t}catch(java.lang.Exception e)" + NL + "\t{";
  ...
  protected final String TEXT_176 = "++;" + NL + "\t\t}catch(java.lang.Exception e)" + NL + "\t\t{";
  ...
  protected final String TEXT_190 = ".addBatch();" + NL + "\t\t}catch(java.lang.Exception e)" + NL + "\t\t{";
