...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_15 = "++;" + NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  ...
  protected final String TEXT_37 = ".setNull(counter";
  protected final String TEXT_38 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_39 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_40 = ".";
  protected final String TEXT_41 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_42 = ".setNull(counter";
  protected final String TEXT_43 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_45 = ".";
  protected final String TEXT_46 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_47 = ".setNull(counter";
  protected final String TEXT_48 = ",java.sql.Types.ARRAY);         " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_53 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_57 = ".setNull(counter";
  protected final String TEXT_58 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_63 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_65 = ".";
  protected final String TEXT_66 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_67 = ".setNull(counter";
  protected final String TEXT_68 = ",java.sql.Types.BOOLEAN);   " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_70 = ".";
  protected final String TEXT_71 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_72 = ".setNull(counter";
  protected final String TEXT_73 = ",java.sql.Types.DOUBLE);    " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_78 = ",java.sql.Types.FLOAT); " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_84 = NL + "\t\t\t\t\t\t\t\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_85 = ".";
  protected final String TEXT_86 = ").toLowerCase())){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_88 = ".setNull(counter";
  protected final String TEXT_89 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}else if(";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = " == '\\0'){" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_92 = ".setString(counter";
  protected final String TEXT_93 = ",\"\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_100 = "!=null){" + NL + "\t\t\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\t\t\tdate_";
  protected final String TEXT_101 = " = ";
  protected final String TEXT_102 = ".";
  protected final String TEXT_103 = ".getTime();" + NL + "\t\t\t\t\t\t\t\tif (date_";
  protected final String TEXT_104 = " < year1_";
  protected final String TEXT_105 = " || date_";
  protected final String TEXT_106 = " >= year10000_";
  protected final String TEXT_107 = ") {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_108 = ".setString(counter";
  protected final String TEXT_109 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_110 = ".setTimestamp(counter";
  protected final String TEXT_111 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_112 = "));" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_113 = ".setNull(counter";
  protected final String TEXT_114 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_116 = ".set";
  protected final String TEXT_117 = "(counter";
  protected final String TEXT_118 = ",";
  protected final String TEXT_119 = ".";
  protected final String TEXT_120 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\tint counter";
  protected final String TEXT_123 = " = rowCount";
  protected final String TEXT_124 = " * ";
  protected final String TEXT_125 = " + 1;";
  protected final String TEXT_126 = NL + "\t\t\t\t\t\tcounter";
  protected final String TEXT_127 = "++;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\texInsertColValue";
  protected final String TEXT_129 = " = new BufferLine_";
  protected final String TEXT_130 = "(";
  protected final String TEXT_131 = NL + "\t                            ,";
  protected final String TEXT_132 = NL + "\t                        ";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = "              ";
  protected final String TEXT_135 = "  " + NL + "\t\t\t\t); " + NL + "\t               " + NL + "\t\t\t\texInsertColValueList";
  protected final String TEXT_136 = ".add(exInsertColValue";
  protected final String TEXT_137 = ");" + NL + "\t\t\t\trowCount";
  protected final String TEXT_138 = "++;" + NL + "\t\t\t\t" + NL + "\t\t\t\tif(rowCount";
  protected final String TEXT_139 = " == ";
  protected final String TEXT_140 = "){ " + NL + "\t                    insertedCount_";
  protected final String TEXT_141 = " = insertedCount_";
  protected final String TEXT_142 = " + pstmt_";
  protected final String TEXT_143 = ".executeUpdate();" + NL + "\t                    exInsertColValueList";
  protected final String TEXT_144 = ".clear();" + NL + "\t                    rowCount";
  protected final String TEXT_145 = " = 0;" + NL + "\t\t\t\t\t\tcounter";
  protected final String TEXT_146 = "=1;" + NL + "\t\t\t\t} ";
  ...
  protected final String TEXT_155 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_156 = " = updatedCount_";
  protected final String TEXT_157 = " + pstmt_";
  protected final String TEXT_158 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_159 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_170 = NL + "                        rejectedCount_";
  protected final String TEXT_171 = " = rejectedCount_";
  ...
  protected final String TEXT_182 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_183 = " = pstmt_";
  protected final String TEXT_184 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_185 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_186 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_187 = " = rs_";
  protected final String TEXT_188 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_197 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_198 = " = updatedCount_";
  protected final String TEXT_199 = " + pstmtUpdate_";
  protected final String TEXT_200 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_211 = NL + "                            rejectedCount_";
  protected final String TEXT_212 = " = rejectedCount_";
  protected final String TEXT_213 = " + 1;";
  ...
  protected final String TEXT_218 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_219 = NL + "                        ";
  protected final String TEXT_220 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_221 = " = insertedCount_";
  protected final String TEXT_222 = " + pstmtInsert_";
  protected final String TEXT_223 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_240 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_241 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_242 = "++;";
  protected final String TEXT_243 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_252 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_253 = "=pstmtUpdate_";
  protected final String TEXT_254 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_255 = " = updatedCount_";
  protected final String TEXT_256 = "+updateFlag_";
  protected final String TEXT_257 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_258 = " = true;";
  protected final String TEXT_259 = NL + "                    throw(e);";
  ...
  protected final String TEXT_268 = NL + "                        rejectedCount_";
  ...
  protected final String TEXT_274 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_275 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_276 = " == 0) {";
  protected final String TEXT_277 = NL + "                        ";
  protected final String TEXT_278 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_279 = " = insertedCount_";
  protected final String TEXT_280 = " + pstmtInsert_";
  protected final String TEXT_281 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_282 = " = true;";
  protected final String TEXT_283 = NL + "                        throw(e);";
  ...
  protected final String TEXT_292 = NL + "                            rejectedCount_";
  protected final String TEXT_293 = " = rejectedCount_";
  protected final String TEXT_294 = " + 1;";
  protected final String TEXT_295 = NL + "                            ";
  protected final String TEXT_296 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_297 = ";";
  protected final String TEXT_298 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_299 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_300 = "++;";
  protected final String TEXT_301 = NL + "\t\t\t\t\t";
  protected final String TEXT_302 = NL + "                    \t";
  protected final String TEXT_303 = NL + "\t                        query_";
  protected final String TEXT_304 = " = ";
  protected final String TEXT_305 = ";" + NL + "\t                        ";
  protected final String TEXT_306 = NL + "                    ";
  protected final String TEXT_307 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_308 = " = deletedCount_";
  protected final String TEXT_309 = " + pstmt_";
  protected final String TEXT_310 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_321 = NL + "                        rejectedCount_";
  protected final String TEXT_322 = " = rejectedCount_";
  protected final String TEXT_323 = " + 1;";
  protected final String TEXT_324 = NL + "                        ";
  protected final String TEXT_325 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_326 = ";";
  protected final String TEXT_327 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_328 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_329 = "++;";
  protected final String TEXT_330 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_341 = NL + "                commitCounter_";
  protected final String TEXT_342 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_343 = "<=commitCounter_";
  protected final String TEXT_344 = ") {" + NL + "                " + NL + "                    conn_";
  protected final String TEXT_345 = ".commit();" + NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_346 = "=0;" + NL + "        " + NL + "                }";
