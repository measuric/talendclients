...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_113 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_114 = " = rsTable_";
  protected final String TEXT_115 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_116 = ".equalsIgnoreCase(";
  protected final String TEXT_117 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_118 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_132 = ".equals";
  protected final String TEXT_133 = "IgnoreCase";
  protected final String TEXT_134 = "(";
  protected final String TEXT_135 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_136 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_142 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_146 = NL + "                if(whetherExist_";
  protected final String TEXT_147 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_148 = " = conn_";
  protected final String TEXT_149 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_150 = ".execute(\"";
  protected final String TEXT_151 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_152 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_160 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_161 = ".executeUpdate(\"";
  protected final String TEXT_162 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_163 = ".close();";
  protected final String TEXT_164 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_167 = " = stmtTruncCount_";
  protected final String TEXT_168 = ".executeQuery(\"";
  protected final String TEXT_169 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_172 = ".executeUpdate(\"";
  protected final String TEXT_173 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_174 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_175 = " += rsTruncCount_";
  protected final String TEXT_176 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_177 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_178 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_179 = ".close();            ";
  protected final String TEXT_180 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_181 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_182 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_183 = NL + "        java.sql.Statement stmtBulkInsert_";
  protected final String TEXT_184 = " = conn_";
  protected final String TEXT_185 = ".createStatement();" + NL + "        stmtBulkInsert_";
  protected final String TEXT_186 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_187 = " + \"] FROM '\" + ";
  protected final String TEXT_188 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_189 = " + \"',DATAFILETYPE='";
  protected final String TEXT_190 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_191 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_192 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_193 = "+\"')\");" + NL + "        stmtBulkInsert_";
  protected final String TEXT_194 = ".close();        ";
  protected final String TEXT_195 = NL + "            int keyCount_";
  protected final String TEXT_196 = " = ";
  protected final String TEXT_197 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_198 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_199 = " = tableName_";
  protected final String TEXT_200 = ";" + NL + "            tableName_";
  protected final String TEXT_201 = " = \"tmp_";
  protected final String TEXT_202 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".createStatement();" + NL + "            stmtCreateTmp_";
  protected final String TEXT_205 = ".execute(\"";
  protected final String TEXT_206 = ")\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_207 = ".close();" + NL + "            java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".createStatement();" + NL + "            stmtTmpBulk_";
  protected final String TEXT_210 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_211 = " + \"] FROM '\" + ";
  protected final String TEXT_212 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_213 = " + \"',DATAFILETYPE='";
  protected final String TEXT_214 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_215 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_216 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_217 = "+\"')\");" + NL + "            stmtTmpBulk_";
  protected final String TEXT_218 = ".close();" + NL + "            tableName_";
  protected final String TEXT_219 = " = tmpTableName_";
  protected final String TEXT_220 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_221 = " = \"tmp_";
  protected final String TEXT_222 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".createStatement();" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_225 = ".executeUpdate(\"";
  protected final String TEXT_226 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_227 = ".close();" + NL + "            tableName_";
  protected final String TEXT_228 = " = \"tmp_";
  protected final String TEXT_229 = "\" + \"_\" +pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_232 = ".execute(\"";
  protected final String TEXT_233 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_234 = ".close();";
  protected final String TEXT_235 = NL + "        if(conn_";
  protected final String TEXT_236 = " != null && !conn_";
  protected final String TEXT_237 = ".isClosed()) {" + NL + "            conn_";
