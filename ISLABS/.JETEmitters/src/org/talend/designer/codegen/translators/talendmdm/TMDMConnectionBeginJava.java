...
public class TMDMConnectionBeginJava
{
  ...
  protected final String TEXT_19 = ");" + NL + "stub_";
  protected final String TEXT_20 = ".ping(new org.talend.mdm.webservice.WSPing());";
  protected final String TEXT_21 = NL + NL + "globalMap.put(\"xtentisWS_";
