...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_147 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_153 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_154 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_155 = " = tableNameForSearch_";
  protected final String TEXT_156 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_157 = " = tableNameForSearch_";
  protected final String TEXT_158 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_159 = " = dbMetaData_";
  protected final String TEXT_160 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_161 = ", tableNameForSearch_";
  protected final String TEXT_162 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_163 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_164 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_165 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_186 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_194 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_195 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_196 = " = rsTable_";
  protected final String TEXT_197 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_208 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_215 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_225 = NL + "                if(whetherExist_";
  protected final String TEXT_226 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_229 = ".execute(\"";
  protected final String TEXT_230 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_231 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_253 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_254 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_255 = "            ";
  protected final String TEXT_256 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_259 = ".executeUpdate(\"";
  protected final String TEXT_260 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_261 = ".close();";
  protected final String TEXT_262 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_263 = " = conn_";
  protected final String TEXT_264 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_265 = " = stmtTruncCount_";
  protected final String TEXT_266 = ".executeQuery(\"";
  protected final String TEXT_267 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_268 = " = conn_";
  protected final String TEXT_269 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_270 = ".executeUpdate(\"";
  protected final String TEXT_271 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_272 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_273 = " += rsTruncCount_";
  protected final String TEXT_274 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_275 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_276 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_297 = ") VALUES (";
  protected final String TEXT_298 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_312 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_317 = ") VALUES (";
  protected final String TEXT_318 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_319 = " = conn_";
  protected final String TEXT_320 = ".prepareStatement(insert_";
  protected final String TEXT_321 = ");" + NL + "\t    String update_";
  protected final String TEXT_322 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_323 = " + \" SET ";
  protected final String TEXT_324 = " WHERE ";
  protected final String TEXT_325 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_326 = " = conn_";
  protected final String TEXT_327 = ".prepareStatement(update_";
  protected final String TEXT_328 = ");" + NL + "\t    ";
  protected final String TEXT_329 = NL + "\t    String update_";
  protected final String TEXT_330 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_331 = " + \" SET ";
  protected final String TEXT_332 = " WHERE ";
  protected final String TEXT_333 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_334 = " = conn_";
  protected final String TEXT_335 = ".prepareStatement(update_";
  ...
  protected final String TEXT_344 = NL + "\t    String delete_";
  protected final String TEXT_345 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_349 = ".prepareStatement(delete_";
  protected final String TEXT_350 = ");" + NL + "\t    ";
  protected final String TEXT_351 = NL + "        StringBuffer query_";
  protected final String TEXT_352 = " = null;" + NL + "       \t";
  protected final String TEXT_353 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_360 = NL + "\t\t\tupdate_";
  protected final String TEXT_361 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_362 = " = update_";
  protected final String TEXT_363 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_364 = " = insert_";
  protected final String TEXT_365 = ".split(\"\\\\?\");";
  protected final String TEXT_366 = NL + "\t\t\tdelete_";
  protected final String TEXT_367 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_368 = " = delete_";
  protected final String TEXT_369 = ".split(\"\\\\?\");";
  protected final String TEXT_370 = NL + "\t\t\treplace_";
  protected final String TEXT_371 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_372 = " = replace_";
  protected final String TEXT_373 = ".split(\"\\\\?\");";
  protected final String TEXT_374 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_375 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_376 = " = insertIgnore_";
  protected final String TEXT_377 = ".split(\"\\\\?\");";
  protected final String TEXT_378 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_379 = " = insert_";
  protected final String TEXT_380 = ".split(\"\\\\?\");";
  protected final String TEXT_381 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_382 = " = ";
  protected final String TEXT_383 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_384 = " = 0;" + NL + "        ";
  protected final String TEXT_385 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_386 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_387 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
