...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_36 = "\");" + NL + "\tif (null == conn_";
  protected final String TEXT_37 = ") {";
  protected final String TEXT_38 = " " + NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_39 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\tconn_";
  protected final String TEXT_40 = " = dataSources_";
  protected final String TEXT_41 = ".get(";
  protected final String TEXT_42 = ").getConnection();" + NL + "\t}";
  protected final String TEXT_43 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_44 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (null != dataSources_";
  protected final String TEXT_45 = ") {";
  protected final String TEXT_46 = NL + "\t\tconn_";
  protected final String TEXT_47 = " = dataSources_";
  protected final String TEXT_48 = ".get(";
  protected final String TEXT_49 = ").getConnection();" + NL + "\t} else {";
  protected final String TEXT_50 = NL + "\t\tString dbProperties_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "\t\tString url_";
  protected final String TEXT_53 = " = null;" + NL + "\t\tif(dbProperties_";
  protected final String TEXT_54 = " == null || dbProperties_";
  protected final String TEXT_55 = ".trim().length() == 0) {" + NL + "\t\t\turl_";
  protected final String TEXT_56 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_57 = " + \":\" + ";
  protected final String TEXT_58 = " + \"/\" + ";
  protected final String TEXT_59 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t\t} else {" + NL + "\t\t\tString properties_";
  protected final String TEXT_60 = " = ";
  protected final String TEXT_61 = ";" + NL + "\t\t\tif (!properties_";
  protected final String TEXT_62 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\t\tproperties_";
  protected final String TEXT_63 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\turl_";
  protected final String TEXT_64 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_65 = " + \":\" + ";
  protected final String TEXT_66 = " + \"/\" + ";
  protected final String TEXT_67 = " + \"?\" + properties_";
  protected final String TEXT_68 = ";" + NL + "\t\t}" + NL + "\t\tString dbUser_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_71 = " = ";
  protected final String TEXT_72 = ";    " + NL + "\t\tjava.lang.Class.forName(\"";
  ...
  protected final String TEXT_79 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_82 = " = 0;";
  protected final String TEXT_83 = NL + "   int batchSize_";
  protected final String TEXT_84 = " = ";
  protected final String TEXT_85 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_86 = "=0;";
  protected final String TEXT_87 = NL + " ";
  protected final String TEXT_88 = NL + "int count_";
  ...
  protected final String TEXT_95 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_96 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_118 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_123 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_141 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_142 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_149 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_152 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_153 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_154 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_155 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_156 = ")== null){";
  protected final String TEXT_157 = "              ";
  protected final String TEXT_158 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_161 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_162 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_163 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_164 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_165 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_170 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_171 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_172 = " = tableNameForSearch_";
  protected final String TEXT_173 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_174 = " = tableNameForSearch_";
  protected final String TEXT_175 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_176 = " = dbMetaData_";
  protected final String TEXT_177 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_178 = ", tableNameForSearch_";
  protected final String TEXT_179 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_180 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_181 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_182 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_192 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_193 = " = rsTable_";
  protected final String TEXT_194 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_195 = ".equals";
  protected final String TEXT_196 = "IgnoreCase";
  protected final String TEXT_197 = "(";
  protected final String TEXT_198 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_214 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_215 = ".equalsIgnoreCase(";
  protected final String TEXT_216 = ")) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_220 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_225 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_232 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_242 = NL + "                if(whetherExist_";
  protected final String TEXT_243 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_244 = " = conn_";
  protected final String TEXT_245 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_246 = ".execute(\"";
  protected final String TEXT_247 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_248 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_249 = " = conn_";
  protected final String TEXT_250 = ".createStatement();";
  protected final String TEXT_251 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_252 = ".execute(\"";
  protected final String TEXT_253 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_260 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_270 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_271 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_272 = "            ";
  protected final String TEXT_273 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_274 = " = conn_";
  protected final String TEXT_275 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_276 = ".executeUpdate(\"";
  protected final String TEXT_277 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_278 = ".close();";
  protected final String TEXT_279 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_282 = " = stmtTruncCount_";
  protected final String TEXT_283 = ".executeQuery(\"";
  protected final String TEXT_284 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_285 = " = conn_";
  protected final String TEXT_286 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_287 = ".executeUpdate(\"";
  protected final String TEXT_288 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_289 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_290 = " += rsTruncCount_";
  protected final String TEXT_291 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_292 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_293 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_294 = ".close();            ";
  protected final String TEXT_295 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_298 = " = stmtTruncCount_";
  protected final String TEXT_299 = ".executeQuery(\"";
  protected final String TEXT_300 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_301 = " = conn_";
  protected final String TEXT_302 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_303 = ".executeUpdate(\"";
  ...
  protected final String TEXT_311 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_312 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_313 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_314 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_315 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_316 = ".append (\"`\" +  ";
  protected final String TEXT_317 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_318 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_319 = ".append (";
  protected final String TEXT_320 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t       ";
  protected final String TEXT_322 = NL + "\t\t        String insert_";
  protected final String TEXT_323 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_324 = " + \"` (";
  protected final String TEXT_325 = ") VALUES (";
  protected final String TEXT_326 = ")\";";
  protected final String TEXT_327 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_328 = " += \tduplidateClause_";
  protected final String TEXT_329 = ".toString();";
  protected final String TEXT_330 = NL + "\t\t\t\t";
  protected final String TEXT_331 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_332 = " = new StringBuffer(insert_";
  protected final String TEXT_333 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_334 = ".insert(insert_";
  protected final String TEXT_335 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_336 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_337 = " =insertStringBuffer_";
  protected final String TEXT_338 = ".toString(); ";
  protected final String TEXT_339 = "    " + NL;
  protected final String TEXT_340 = NL + "                        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_346 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  ...
  protected final String TEXT_355 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_356 = " {" + NL + "    \t            ";
  protected final String TEXT_357 = NL + "                            ";
  protected final String TEXT_358 = " ";
  protected final String TEXT_359 = ";                ";
  protected final String TEXT_360 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_361 = "(";
  protected final String TEXT_362 = NL + "                                ,";
  protected final String TEXT_363 = NL + "                            ";
  protected final String TEXT_364 = " ";
  protected final String TEXT_365 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_366 = NL + "                                this.";
  protected final String TEXT_367 = " = ";
  protected final String TEXT_368 = ";              ";
  protected final String TEXT_369 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_370 = "> exInsertColValueList";
  protected final String TEXT_371 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_372 = " exInsertColValue";
  protected final String TEXT_373 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_374 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_375 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_376 = ".append(\"(";
  protected final String TEXT_377 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_378 = "-1) extendInsertValueStmt_";
  protected final String TEXT_379 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_380 = " = \"INSERT INTO `\"+";
  protected final String TEXT_381 = "+\"` (";
  protected final String TEXT_382 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_383 = ".toString();";
  protected final String TEXT_384 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_385 = " += \tduplidateClause_";
  protected final String TEXT_386 = ".toString();";
  protected final String TEXT_387 = NL + "\t\t\t\t";
  protected final String TEXT_388 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_389 = " = new StringBuffer(insert_";
  protected final String TEXT_390 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_391 = ".insert(insert_";
  protected final String TEXT_392 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_393 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_394 = " =insertStringBuffer_";
  protected final String TEXT_395 = ".toString(); ";
  protected final String TEXT_396 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_397 = " =  conn_";
  protected final String TEXT_398 = ".prepareStatement(insert_";
  protected final String TEXT_399 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_400 = " = \"";
  protected final String TEXT_401 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_402 = " =  \"";
  protected final String TEXT_403 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_404 = " = 0;\t ";
  protected final String TEXT_405 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_406 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_407 = " + \"` (";
  protected final String TEXT_408 = ") VALUES (";
  ...
  protected final String TEXT_413 = NL + "\t\t        int batchSize_";
  protected final String TEXT_414 = " = ";
  protected final String TEXT_415 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_416 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_417 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_418 = " = new StringBuffer(insert_";
  protected final String TEXT_419 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_420 = ".insert(insert_";
  protected final String TEXT_421 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_422 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_423 = " =insertStringBuffer_";
  ...
  protected final String TEXT_430 = " = \"UPDATE `\" + ";
  protected final String TEXT_431 = " + \"` SET ";
  protected final String TEXT_432 = " WHERE ";
  protected final String TEXT_433 = "\";" + NL + "\t    ";
  protected final String TEXT_434 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_435 = " = new StringBuffer(update_";
  protected final String TEXT_436 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_437 = ".insert(update_";
  protected final String TEXT_438 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_439 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_440 = " =updateStringBuffer_";
  ...
  protected final String TEXT_448 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_449 = " + \"` WHERE ";
  protected final String TEXT_450 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_451 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_452 = " + \"` (";
  protected final String TEXT_453 = ") VALUES (";
  protected final String TEXT_454 = ")\";" + NL + "\t    ";
  protected final String TEXT_455 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_456 = " = new StringBuffer(insert_";
  protected final String TEXT_457 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_458 = ".insert(insert_";
  protected final String TEXT_459 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_460 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_461 = " =insertStringBuffer_";
  protected final String TEXT_462 = ".toString(); ";
  protected final String TEXT_463 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_467 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_488 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_489 = " = new StringBuffer(update_";
  protected final String TEXT_490 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_491 = ".insert(update_";
  protected final String TEXT_492 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_493 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_494 = " =updateStringBuffer_";
  protected final String TEXT_495 = ".toString(); ";
  protected final String TEXT_496 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_504 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_505 = " = new StringBuffer(insert_";
  protected final String TEXT_506 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_507 = ".insert(insert_";
  protected final String TEXT_508 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_509 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_510 = " =insertStringBuffer_";
  protected final String TEXT_511 = ".toString(); ";
  protected final String TEXT_512 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_516 = NL + "\t    String delete_";
  protected final String TEXT_517 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_518 = " + \"` WHERE ";
  protected final String TEXT_519 = "\";" + NL + "\t    ";
  protected final String TEXT_520 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_521 = " = new StringBuffer(delete_";
  protected final String TEXT_522 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_523 = ".insert(delete_";
  protected final String TEXT_524 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_525 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_526 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_530 = ".prepareStatement(delete_";
  protected final String TEXT_531 = ");" + NL + "\t    ";
  protected final String TEXT_532 = NL + "\t    String replace_";
  protected final String TEXT_533 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_538 = ".prepareStatement(replace_";
  protected final String TEXT_539 = ");" + NL + "\t    ";
  protected final String TEXT_540 = NL + "\t    String insertIgnore_";
  protected final String TEXT_541 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_542 = " + \"` (";
  protected final String TEXT_543 = ") VALUES (";
  protected final String TEXT_544 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_545 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_546 = " = conn_";
  protected final String TEXT_547 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_548 = ");" + NL + "\t    ";
  protected final String TEXT_549 = NL + "\t    String insert_";
  protected final String TEXT_550 = " = \"INSERT IGNORE INTO `\" + ";
  ...
  protected final String TEXT_562 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_566 = NL + "        StringBuffer query_";
  protected final String TEXT_567 = " = null;" + NL + "       \t";
  protected final String TEXT_568 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_569 = " = insert_";
  protected final String TEXT_570 = ".split(\"\\\\?\");";
  protected final String TEXT_571 = NL + "\t\t\tupdate_";
  protected final String TEXT_572 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_573 = " = update_";
  protected final String TEXT_574 = ".split(\"\\\\?\");";
  protected final String TEXT_575 = NL + "\t\t\tupdate_";
  protected final String TEXT_576 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_577 = " = update_";
  protected final String TEXT_578 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_579 = " = insert_";
  protected final String TEXT_580 = ".split(\"\\\\?\");";
  protected final String TEXT_581 = NL + "\t\t\tdelete_";
  protected final String TEXT_582 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_583 = " = delete_";
  protected final String TEXT_584 = ".split(\"\\\\?\");";
  protected final String TEXT_585 = NL + "\t\t\treplace_";
  protected final String TEXT_586 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_587 = " = replace_";
  protected final String TEXT_588 = ".split(\"\\\\?\");";
  protected final String TEXT_589 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_590 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_591 = " = insertIgnore_";
  ...
  protected final String TEXT_621 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_622 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_623 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_624 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_625 = "=1;";
  protected final String TEXT_626 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_627 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_628 = "=0;";
  protected final String TEXT_629 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_630 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_631 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_632 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_633 = "=0;";
