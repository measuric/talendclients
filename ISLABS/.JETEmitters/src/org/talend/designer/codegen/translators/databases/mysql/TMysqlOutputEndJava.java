...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_186 = "                " + NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_187 = " != null){" + NL + "\t\t\tint countSum_";
  ...
  protected final String TEXT_192 = " < 0 ? 0 : countEach_";
  protected final String TEXT_193 = ");" + NL + "\t\t\t}       \t" + NL + "\t    \t";
  protected final String TEXT_194 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_195 = " += countSum_";
  protected final String TEXT_196 = "; " + NL + "\t    \t";
  protected final String TEXT_197 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_198 = " += countSum_";
  protected final String TEXT_199 = ";" + NL + "\t    \t";
  protected final String TEXT_200 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_201 = " += countSum_";
  protected final String TEXT_202 = ";" + NL + "\t    \t";
  protected final String TEXT_203 = "            \t    " + NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_204 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_205 = NL + "    \tint countSum_";
  protected final String TEXT_206 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_207 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_208 = " += (countEach_";
  protected final String TEXT_209 = " < 0 ? 0 : countEach_";
  protected final String TEXT_210 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_211 = NL + "    \tinsertedCount_";
  protected final String TEXT_212 = " += countSum_";
  protected final String TEXT_213 = ";" + NL + "    \t";
  protected final String TEXT_214 = "            \t    \t\t" + NL + "    \tupdatedCount_";
  protected final String TEXT_215 = " += countSum_";
  protected final String TEXT_216 = ";" + NL + "    \t";
  protected final String TEXT_217 = NL + "    \tdeletedCount_";
  protected final String TEXT_218 = " += countSum_";
  protected final String TEXT_219 = ";" + NL + "    \t";
  protected final String TEXT_220 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_221 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_222 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_223 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_225 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_227 = ");   " + NL + "\t\t\t";
  protected final String TEXT_228 = "              " + NL + "        }        ";
  protected final String TEXT_229 = NL;
  protected final String TEXT_230 = NL + "    \t\tconn_";
  protected final String TEXT_231 = ".commit();" + NL + "    \t\t";
  protected final String TEXT_232 = "\t" + NL + "    \tconn_";
  protected final String TEXT_233 = " .close();" + NL + "    \t";
  protected final String TEXT_234 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_235 = "=nb_line_deleted_";
  protected final String TEXT_236 = "+ deletedCount_";
  protected final String TEXT_237 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_238 = "=nb_line_update_";
  protected final String TEXT_239 = " + updatedCount_";
  protected final String TEXT_240 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_241 = "=nb_line_inserted_";
  protected final String TEXT_242 = " + insertedCount_";
  protected final String TEXT_243 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_244 = "=nb_line_rejected_";
  protected final String TEXT_245 = " + rejectedCount_";
  ...
  protected final String TEXT_249 = "_NB_LINE_UPDATED\",nb_line_update_";
  ...
  protected final String TEXT_255 = "_NB_LINE_REJECTED\", nb_line_rejected_";
