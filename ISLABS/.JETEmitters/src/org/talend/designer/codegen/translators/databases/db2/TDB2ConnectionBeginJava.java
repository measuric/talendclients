...
public class TDB2ConnectionBeginJava
{
  ...
  protected final String TEXT_26 = NL + "\t\t\tglobalMap.put(\"tableschema_";
  protected final String TEXT_27 = "\", ";
  protected final String TEXT_28 = ");";
  protected final String TEXT_29 = NL + NL + "\t";
  protected final String TEXT_30 = NL + NL + "\tString userName_";
  ...
  protected final String TEXT_38 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_39 = ")) {" + NL + "\t\t";
  protected final String TEXT_40 = NL + "\t\t";
  protected final String TEXT_41 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_42 = "\", conn_";
  protected final String TEXT_43 = ");" + NL + "\t}";
  protected final String TEXT_44 = NL + "\tif (null != conn_";
  protected final String TEXT_45 = ") {" + NL + "\t\t";
  protected final String TEXT_46 = NL + "\t}";
  protected final String TEXT_47 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_48 = "\", conn_";
  protected final String TEXT_49 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_50 = "\", ";
  protected final String TEXT_51 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_52 = "\", ";
  protected final String TEXT_53 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_54 = "\", ";
  protected final String TEXT_55 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_56 = "\", userName_";
  protected final String TEXT_57 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_58 = "\", password_";
