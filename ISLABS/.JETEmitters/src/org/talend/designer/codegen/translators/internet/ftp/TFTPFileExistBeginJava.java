...
public class TFTPFileExistBeginJava
{
  ...
  protected final String TEXT_60 = NL + "  com.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_61 = " = null;" + NL;
  protected final String TEXT_62 = NL + "    ftp_";
  protected final String TEXT_63 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_64 = "\");";
  protected final String TEXT_65 = "    " + NL + "    ftp_";
  protected final String TEXT_66 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_67 = ".setRemoteHost(";
  protected final String TEXT_68 = ");" + NL + "    ftp_";
  protected final String TEXT_69 = ".setRemotePort(";
  protected final String TEXT_70 = ");" + NL;
  protected final String TEXT_71 = NL + "      ftp_";
  protected final String TEXT_72 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);";
  protected final String TEXT_73 = NL + "      ftp_";
  protected final String TEXT_74 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);";
  protected final String TEXT_75 = NL + "    ftp_";
  protected final String TEXT_76 = ".setControlEncoding(";
  protected final String TEXT_77 = ");" + NL + "    ftp_";
  protected final String TEXT_78 = ".connect();  " + NL + "    ftp_";
