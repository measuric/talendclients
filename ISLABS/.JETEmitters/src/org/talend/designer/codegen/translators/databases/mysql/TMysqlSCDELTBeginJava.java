...
public class TMysqlSCDELTBeginJava {
  ...
  protected final String TEXT_116 = "\"))).toString();" + NL + "\t";
  protected final String TEXT_117 = NL + "        String changeDateTime_";
  protected final String TEXT_118 = "_begin = changeDateTime_";
  protected final String TEXT_119 = ";" + NL + "        String changeDateTime_";
  protected final String TEXT_120 = "_end = changeDateTime_";
  protected final String TEXT_121 = ";" + NL + "        ";
  protected final String TEXT_122 = NL + "\t\t        changeDateTime_";
  protected final String TEXT_123 = "_begin = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_124 = "\").getDateString(\"";
  protected final String TEXT_125 = "\",\"";
  protected final String TEXT_126 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_127 = "\"),";
  protected final String TEXT_128 = ");" + NL + "\t\t";
  protected final String TEXT_129 = NL + "        \t\tchangeDateTime_";
  protected final String TEXT_130 = "_end = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_131 = "\").getDateString(\"";
  protected final String TEXT_132 = "\",\"";
  protected final String TEXT_133 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_134 = "\"),";
  protected final String TEXT_135 = ");";
  protected final String TEXT_136 = NL + "        String updateForType2_";
  protected final String TEXT_137 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_138 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_139 = " + \"` t SET `";
  protected final String TEXT_140 = "` = '\" + (changeDateTime_";
  protected final String TEXT_141 = ") + \"'";
  protected final String TEXT_142 = ", `";
  protected final String TEXT_143 = "` = 0";
  protected final String TEXT_144 = " WHERE ";
  protected final String TEXT_145 = " AND (";
  protected final String TEXT_146 = ") AND d.`";
  protected final String TEXT_147 = "` IS NULL\"; " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_148 = " = conn_";
  protected final String TEXT_149 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_150 = ".executeUpdate(updateForType2_";
  protected final String TEXT_151 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_152 = ".close();";
  protected final String TEXT_153 = NL + "        \tString updateForType2_";
  protected final String TEXT_154 = "_debug = \"UPDATE `\" + tableName_";
  protected final String TEXT_155 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_156 = " + \"` t SET `";
  protected final String TEXT_157 = "` = '\" + (changeDateTime_";
  protected final String TEXT_158 = "_end) + \"'";
  protected final String TEXT_159 = ", `";
  protected final String TEXT_160 = "` = 0";
  protected final String TEXT_161 = " WHERE ";
  protected final String TEXT_162 = " AND (";
  protected final String TEXT_163 = ") AND d.`";
  protected final String TEXT_164 = "` IS NULL\"; " + NL + "            System.out.println(\"[";
  protected final String TEXT_165 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_166 = "_debug + \"\\ndone\");";
  protected final String TEXT_167 = NL + "        String insertForType2_";
  protected final String TEXT_168 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_169 = " + \"`(";
  protected final String TEXT_170 = ") SELECT t.";
  protected final String TEXT_171 = ", '\" + " + NL + "        (changeDateTime_";
  protected final String TEXT_172 = ") + \"', NULL";
  protected final String TEXT_173 = ", 1";
  protected final String TEXT_174 = ", d.`";
  protected final String TEXT_175 = "` + 1";
  protected final String TEXT_176 = " FROM `\" + " + NL + "        sourceTable_";
  protected final String TEXT_177 = " + \"` t, `\" + tableName_";
  protected final String TEXT_178 = " + \"` d WHERE ";
  protected final String TEXT_179 = " AND (";
  protected final String TEXT_180 = ") AND d.`";
  protected final String TEXT_181 = "` = '\" + (changeDateTime_";
  protected final String TEXT_182 = ") + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_185 = ".executeUpdate(insertForType2_";
  protected final String TEXT_186 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_187 = ".close();";
  protected final String TEXT_188 = NL + "\t\t\tString insertForType2_";
  protected final String TEXT_189 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_190 = " + \"`(";
  protected final String TEXT_191 = ") SELECT t.";
  protected final String TEXT_192 = ", '\" + (changeDateTime_";
  protected final String TEXT_193 = "_begin) + \"', NULL";
  protected final String TEXT_194 = ", 1";
  protected final String TEXT_195 = ", d.`";
  protected final String TEXT_196 = "` + 1";
  protected final String TEXT_197 = " FROM `\" + sourceTable_";
  protected final String TEXT_198 = " + \"` t, `\" + tableName_";
  protected final String TEXT_199 = " + \"` d WHERE ";
  protected final String TEXT_200 = " AND (";
  protected final String TEXT_201 = ") AND d.`";
  protected final String TEXT_202 = "` = '\" + (changeDateTime_";
  protected final String TEXT_203 = "_end) + \"'\";" + NL + "            System.out.println(\"[";
  protected final String TEXT_204 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_205 = "_debug + \"\\ndone\");";
  protected final String TEXT_206 = NL + "    String insert_";
  protected final String TEXT_207 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_208 = " + \"`(";
  protected final String TEXT_209 = ") SELECT t.";
  protected final String TEXT_210 = "\"";
  protected final String TEXT_211 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_212 = ") + \"', NULL\"";
  protected final String TEXT_213 = NL + "    + \"";
  protected final String TEXT_214 = ", 1";
  protected final String TEXT_215 = ", 1";
  protected final String TEXT_216 = " FROM `\" + " + NL + "    sourceTable_";
  protected final String TEXT_217 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_218 = " + \"` d ON ";
  protected final String TEXT_219 = " WHERE (";
  protected final String TEXT_220 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_223 = ".executeUpdate(insert_";
  protected final String TEXT_224 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_225 = ".close();";
  protected final String TEXT_226 = NL + "    \tString insert_";
  protected final String TEXT_227 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_228 = " + \"`(";
  protected final String TEXT_229 = ") SELECT t.";
  protected final String TEXT_230 = "\"";
  protected final String TEXT_231 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_232 = "_begin) + \"', NULL\"";
  protected final String TEXT_233 = " + \"";
  protected final String TEXT_234 = ", 1";
  protected final String TEXT_235 = ", 1";
  protected final String TEXT_236 = " FROM `\" + sourceTable_";
  protected final String TEXT_237 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_238 = " + \"` d ON ";
  protected final String TEXT_239 = " WHERE (";
  protected final String TEXT_240 = ")\";" + NL + "        System.out.println(\"[";
  protected final String TEXT_241 = "] new rows sql\\n\" + insert_";
  protected final String TEXT_242 = "_debug + \"\\ndone\");";
