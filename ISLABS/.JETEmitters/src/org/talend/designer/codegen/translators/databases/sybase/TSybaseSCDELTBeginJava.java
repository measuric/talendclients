...
public class TSybaseSCDELTBeginJava {
  ...
  protected final String TEXT_113 = " = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  ...
  protected final String TEXT_139 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  ...
  protected final String TEXT_168 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
