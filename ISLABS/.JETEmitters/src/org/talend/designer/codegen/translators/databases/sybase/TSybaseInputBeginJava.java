...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_94 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_106 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_107 = " = null;";
  protected final String TEXT_108 = NL + "\t\t        conn_";
  protected final String TEXT_109 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_110 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_111 = ") {";
  protected final String TEXT_112 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_113 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_114 = " = dataSources_";
  protected final String TEXT_115 = ".get(";
  protected final String TEXT_116 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_117 = "\", conn_";
  protected final String TEXT_118 = ");" + NL + "\t\t        }";
  protected final String TEXT_119 = NL + NL + "\t\t    ";
  protected final String TEXT_120 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_121 = " = ";
  protected final String TEXT_122 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_123 = "_QUERY\",dbquery_";
  protected final String TEXT_124 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_125 = " = stmt_";
  protected final String TEXT_126 = ".executeQuery(dbquery_";
  protected final String TEXT_127 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_128 = " = rs_";
  protected final String TEXT_129 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_130 = " = rsmd_";
  protected final String TEXT_131 = ".getColumnCount();" + NL;
  protected final String TEXT_132 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_133 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_134 = ".setDbmsId(\"";
  protected final String TEXT_135 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_136 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_137 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_138 = ".add(\"";
  protected final String TEXT_139 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_140 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_141 = " = ";
  protected final String TEXT_142 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_143 = "; i <= rsmd_";
  protected final String TEXT_144 = ".getColumnCount()-";
  protected final String TEXT_145 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_146 = ".contains(rsmd_";
  protected final String TEXT_147 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_148 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_149 = ".setName(rsmd_";
  protected final String TEXT_150 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_151 = ".setDbName(rsmd_";
  protected final String TEXT_152 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_153 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_154 = "\", rsmd_";
  protected final String TEXT_155 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_156 = ".getPrecision(i), rsmd_";
  protected final String TEXT_157 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_158 = ".setDbType(rsmd_";
  protected final String TEXT_159 = ".getColumnTypeName(i));";
  protected final String TEXT_160 = NL + "                \tdcm_";
  protected final String TEXT_161 = ".setFormat(";
  protected final String TEXT_162 = ");";
  protected final String TEXT_163 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_164 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_165 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_166 = ".setLength(rsmd_";
  protected final String TEXT_167 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_168 = ".setLength(rsmd_";
  protected final String TEXT_169 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_170 = NL + "\t\t\tdcm_";
  protected final String TEXT_171 = ".setLength(rsmd_";
  protected final String TEXT_172 = ".getPrecision(i));";
  protected final String TEXT_173 = NL + "                \tdcm_";
  protected final String TEXT_174 = ".setPrecision(rsmd_";
  protected final String TEXT_175 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_176 = ".setNullable(rsmd_";
  protected final String TEXT_177 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_178 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_179 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_180 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_181 = ".metadatas.add(dcm_";
  protected final String TEXT_182 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_183 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_184 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_185 = " =1;" + NL + "\t\t    while (rs_";
  protected final String TEXT_186 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_187 = "++;" + NL + "\t\t        ";
  protected final String TEXT_188 = NL + "\t\t                        column_index_";
  protected final String TEXT_189 = " = ";
  protected final String TEXT_190 = " + dcg_";
  protected final String TEXT_191 = ".getColumnCount(); " + NL + "\t\t                    ";
  ...
  protected final String TEXT_226 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_227 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = "; i_";
  protected final String TEXT_230 = "  <= rsmd_";
  protected final String TEXT_231 = ".getColumnCount(); i_";
  protected final String TEXT_232 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_233 = ".getColumnTypeName(i_";
  protected final String TEXT_234 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_235 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_236 = ".getClob(i_";
  protected final String TEXT_237 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_238 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_239 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_240 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_241 = ".add(tNTextImpl_";
  protected final String TEXT_242 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_243 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_244 = ".";
  protected final String TEXT_245 = ", rs_";
  protected final String TEXT_246 = ", fixedColumnCount_";
  protected final String TEXT_247 = ",list_";
  protected final String TEXT_248 = ");";
  protected final String TEXT_249 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_250 = ".";
  protected final String TEXT_251 = ", rs_";
  protected final String TEXT_252 = ", fixedColumnCount_";
  protected final String TEXT_253 = ");";
  protected final String TEXT_254 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_255 = ".getObject(column_index_";
  protected final String TEXT_256 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_257 = ".";
  protected final String TEXT_258 = " = new Geometry(sb.toString());";
