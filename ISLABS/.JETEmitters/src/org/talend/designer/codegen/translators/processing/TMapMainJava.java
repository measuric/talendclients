...
public class TMapMainJava {
  ...
  protected final String TEXT_357 = NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t//if anohter java.lang.Exception when processing an java.lang.Exception" + NL + "\t\t\ttry{//EE";
  protected final String TEXT_358 = NL;
  protected final String TEXT_359 = "                " + NL + "                ";
  protected final String TEXT_360 = "            " + NL + "               ";
  protected final String TEXT_361 = NL + "                ";
  protected final String TEXT_362 = " = ";
  protected final String TEXT_363 = "_tmp;";
  protected final String TEXT_364 = NL + "                ";
  protected final String TEXT_365 = ".errorMessage = e.getMessage();";
  protected final String TEXT_366 = NL + "                ";
  protected final String TEXT_367 = ".errorStackTrace = ResumeUtil.getExceptionStackTrace(e);" + NL + "              " + NL + "                ";
  protected final String TEXT_368 = "\t\t\t" + NL + "\t\t\t" + NL + "    ";
  protected final String TEXT_369 = "\t" + NL + "                \t\t";
  protected final String TEXT_370 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_371 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_372 = " = null;";
  protected final String TEXT_373 = NL + "         } catch (java.lang.Exception ee) {//EE" + NL + "\t\t\t\tee.printStackTrace();";
  protected final String TEXT_374 = "\t" + NL + "                \t\t";
  protected final String TEXT_375 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_376 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_377 = " = null;";
  protected final String TEXT_378 = NL + "\t\t}//EE  \t\t\t" + NL + "\t}//end catch";
  protected final String TEXT_379 = NL + NL + NL + NL + NL + NL + NL;
