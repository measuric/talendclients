...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_49 = ").getConnection();" + NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_50 = NL + "\t\t\tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");\t" + NL + "\t\t";
  protected final String TEXT_51 = NL + "\t\t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");\t" + NL + "\t\t";
  ...
  protected final String TEXT_58 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_59 = " + \":\" + ";
  protected final String TEXT_60 = " + \":\" + ";
  protected final String TEXT_61 = ";";
  protected final String TEXT_62 = NL + "\t\t\turl_";
  protected final String TEXT_63 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_64 = " + \")(port=\" + ";
  protected final String TEXT_65 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_66 = " + \")))\";";
  protected final String TEXT_67 = NL + "\t\t\turl_";
  protected final String TEXT_68 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_75 = ";" + NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_82 = ");" + NL + "\t\t\tif(dbschema_";
  protected final String TEXT_83 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_84 = ")) //get schema from connection" + NL + "\t\t\t\t{" + NL + "\t\t\t\tdbschema_";
  protected final String TEXT_85 = "=conn_";
  protected final String TEXT_86 = ".getMetaData().getUserName();" + NL + "\t\t\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_103 = ".getBytes()));" + NL + "\t\tconn_";
  ...
  protected final String TEXT_109 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  ...
  protected final String TEXT_118 = NL + "int count_";
  protected final String TEXT_119 = "=0;";
  protected final String TEXT_120 = NL + NL + "if(dbschema_";
  ...
  protected final String TEXT_148 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_254 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_255 = ".equalsIgnoreCase(";
  protected final String TEXT_256 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_257 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_262 = ".createStatement();";
  protected final String TEXT_263 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_264 = ".execute(\"";
  protected final String TEXT_265 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_272 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_283 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_286 = ".execute(\"";
  protected final String TEXT_287 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_288 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_293 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_300 = ", \"+DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_301 = ".";
  protected final String TEXT_302 = ", \"";
  protected final String TEXT_303 = "\")+\")";
  protected final String TEXT_304 = "\");";
  protected final String TEXT_305 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_306 = ".execute(\"";
  ...
  protected final String TEXT_313 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_314 = " = conn_";
  protected final String TEXT_315 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_316 = ".executeUpdate(\"";
  protected final String TEXT_317 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_318 = ".close();";
  protected final String TEXT_319 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_320 = " = conn_";
  protected final String TEXT_321 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_322 = " = stmtTruncCount_";
  protected final String TEXT_323 = ".executeQuery(\"";
  protected final String TEXT_324 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_325 = " = conn_";
  protected final String TEXT_326 = ".createStatement();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_342 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_343 = ".executeUpdate(\"";
  protected final String TEXT_344 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_345 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_346 = " += rsTruncCount_";
  protected final String TEXT_347 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_348 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_349 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_356 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_357 = " = new StringBuffer(insert_";
  protected final String TEXT_358 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_359 = ".insert(insert_";
  protected final String TEXT_360 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_361 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_362 = " =insertStringBuffer_";
  protected final String TEXT_363 = ".toString(); ";
  protected final String TEXT_364 = "    \t    " + NL + "\t    ";
  protected final String TEXT_365 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_366 = " = conn_";
  protected final String TEXT_367 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_373 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_374 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_375 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_376 = ",insert_";
  protected final String TEXT_377 = ",keyPsmt_";
  protected final String TEXT_378 = ");";
  protected final String TEXT_379 = NL + "\t    " + NL + "\t    ";
  protected final String TEXT_380 = NL + "\t    String update_";
  protected final String TEXT_381 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_382 = " + \" SET ";
  protected final String TEXT_383 = " WHERE ";
  protected final String TEXT_384 = "\";" + NL + "    \t";
  protected final String TEXT_385 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_386 = " = new StringBuffer(update_";
  protected final String TEXT_387 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_388 = ".insert(update_";
  protected final String TEXT_389 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_390 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_391 = " =updateStringBuffer_";
  protected final String TEXT_392 = ".toString(); ";
  protected final String TEXT_393 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_394 = " = conn_";
  protected final String TEXT_395 = ".prepareStatement(update_";
  protected final String TEXT_396 = ");" + NL + "\t    ";
  protected final String TEXT_397 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_398 = " = conn_";
  protected final String TEXT_399 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_404 = ") VALUES (";
  protected final String TEXT_405 = ")\";" + NL + "\t   \t";
  protected final String TEXT_406 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_407 = " = new StringBuffer(insert_";
  protected final String TEXT_408 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_409 = ".insert(insert_";
  protected final String TEXT_410 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_411 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_412 = " =insertStringBuffer_";
  protected final String TEXT_413 = ".toString(); ";
  protected final String TEXT_414 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_415 = " = conn_";
  protected final String TEXT_416 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_422 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_423 = " = new StringBuffer(update_";
  protected final String TEXT_424 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_425 = ".insert(update_";
  protected final String TEXT_426 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_427 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_428 = " =updateStringBuffer_";
  protected final String TEXT_429 = ".toString(); ";
  protected final String TEXT_430 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_439 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_440 = " = new StringBuffer(update_";
  protected final String TEXT_441 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_442 = ".insert(update_";
  protected final String TEXT_443 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_444 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_445 = " =updateStringBuffer_";
  protected final String TEXT_446 = ".toString(); ";
  protected final String TEXT_447 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_471 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_472 = " = new StringBuffer(delete_";
  protected final String TEXT_473 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_474 = ".insert(delete_";
  protected final String TEXT_475 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_476 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_477 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_481 = ".prepareStatement(delete_";
  protected final String TEXT_482 = ");" + NL + "\t    ";
  protected final String TEXT_483 = NL + "        StringBuffer query_";
  protected final String TEXT_484 = " = null;" + NL + "\t   ";
  protected final String TEXT_485 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_486 = " = insert_";
  protected final String TEXT_487 = ".split(\"\\\\?\");";
  protected final String TEXT_488 = NL + "\t\t\tupdate_";
  protected final String TEXT_489 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_495 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_496 = " = insert_";
  protected final String TEXT_497 = ".split(\"\\\\?\");";
  protected final String TEXT_498 = NL + "\t\t\tdelete_";
  protected final String TEXT_499 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_500 = " = delete_";
  protected final String TEXT_501 = ".split(\"\\\\?\");";
  protected final String TEXT_502 = NL + "\t\t\treplace_";
  protected final String TEXT_503 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_504 = " = replace_";
  protected final String TEXT_505 = ".split(\"\\\\?\");";
  protected final String TEXT_506 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_507 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_508 = " = insertIgnore_";
  protected final String TEXT_509 = ".split(\"\\\\?\");";
  protected final String TEXT_510 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_511 = " = insert_";
  protected final String TEXT_512 = ".split(\"\\\\?\");";
  protected final String TEXT_513 = NL + "\t   ";
  protected final String TEXT_514 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_515 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_516 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_517 = " = true;" + NL + "    \t";
  protected final String TEXT_518 = NL + "\tclass XMLTypeUtil_";
  ...
  protected final String TEXT_520 = " xmlTypeUtil_";
  protected final String TEXT_521 = " = null;" + NL + "\txmlTypeUtil_";
  protected final String TEXT_522 = " = new XMLTypeUtil_";
  protected final String TEXT_523 = "();";
  protected final String TEXT_524 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_525 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_526 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
