...
public class TPostgresqlInputBeginJava
{
  ...
  protected final String TEXT_93 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_94 = " + \":\" + ";
  protected final String TEXT_95 = " + \"/\" + ";
  protected final String TEXT_96 = ";";
  protected final String TEXT_97 = NL + "\t\t\tconn_";
  protected final String TEXT_98 = ".setAutoCommit(false);";
  protected final String TEXT_99 = NL + "                stmt_";
  protected final String TEXT_100 = ".setFetchSize(";
  protected final String TEXT_101 = ");";
  protected final String TEXT_102 = NL + "    " + NL + "\t";
  protected final String TEXT_103 = NL + "\t\t    int nb_line_";
  protected final String TEXT_104 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_105 = " = null;";
  protected final String TEXT_106 = NL + "\t\t        conn_";
  protected final String TEXT_107 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_108 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_109 = ") {";
  protected final String TEXT_110 = NL + "\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_111 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_112 = " = dataSources_";
  protected final String TEXT_113 = ".get(";
  protected final String TEXT_114 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_115 = "\", conn_";
  protected final String TEXT_116 = ");" + NL + "\t\t        }";
  protected final String TEXT_117 = NL + NL + "\t\t    ";
  protected final String TEXT_118 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_119 = " = ";
  protected final String TEXT_120 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_121 = "_QUERY\",dbquery_";
  protected final String TEXT_122 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_123 = " = stmt_";
  protected final String TEXT_124 = ".executeQuery(dbquery_";
  protected final String TEXT_125 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_126 = " = rs_";
  protected final String TEXT_127 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_128 = " = rsmd_";
  protected final String TEXT_129 = ".getColumnCount();" + NL;
  protected final String TEXT_130 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_131 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_132 = ".setDbmsId(\"";
  protected final String TEXT_133 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_134 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_135 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_136 = ".add(\"";
  protected final String TEXT_137 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_138 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_139 = " = ";
  protected final String TEXT_140 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_141 = "; i <= rsmd_";
  protected final String TEXT_142 = ".getColumnCount()-";
  protected final String TEXT_143 = "; i++) {" + NL + "                if (!(listSchema_";
  ...
  protected final String TEXT_182 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_183 = " =1;" + NL + "\t\t    while (rs_";
  protected final String TEXT_184 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_185 = "++;" + NL + "\t\t        ";
  protected final String TEXT_186 = NL + "\t\t                        column_index_";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = " + dcg_";
  protected final String TEXT_189 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_190 = NL + "\t\t                        column_index_";
  protected final String TEXT_191 = " = ";
  protected final String TEXT_192 = ";" + NL + "\t\t                    ";
  protected final String TEXT_193 = NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_206 = ".getObject(column_index_";
  ...
  protected final String TEXT_210 = ".getObject(column_index_";
  ...
  protected final String TEXT_224 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_225 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_226 = " = ";
  protected final String TEXT_227 = "; i_";
  protected final String TEXT_228 = "  <= rsmd_";
  protected final String TEXT_229 = ".getColumnCount(); i_";
  protected final String TEXT_230 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_231 = ".getColumnTypeName(i_";
  protected final String TEXT_232 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_233 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_234 = ".getClob(i_";
  protected final String TEXT_235 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_236 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_237 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_238 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_239 = ".add(tNTextImpl_";
  protected final String TEXT_240 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_241 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_247 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_248 = ".";
  protected final String TEXT_249 = ", rs_";
  protected final String TEXT_250 = ", fixedColumnCount_";
  protected final String TEXT_251 = ");";
  protected final String TEXT_252 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_253 = ".getObject(column_index_";
  protected final String TEXT_254 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_255 = ".";
  protected final String TEXT_256 = " = new Geometry(sb.toString());";
