...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_73 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_74 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_75 = " = tableNameForSearch_";
  protected final String TEXT_76 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_77 = " = tableNameForSearch_";
  protected final String TEXT_78 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_79 = " = dbMetaData_";
  protected final String TEXT_80 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_81 = ", tableNameForSearch_";
  protected final String TEXT_82 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_83 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_84 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_85 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_86 = ".close();";
  protected final String TEXT_87 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_88 = " = conn_";
  protected final String TEXT_89 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_95 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_96 = " = rsTable_";
  protected final String TEXT_97 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_98 = ".equalsIgnoreCase(";
  protected final String TEXT_99 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_100 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_101 = ") || dbschema_";
  protected final String TEXT_102 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_103 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_104 = ".close();";
  protected final String TEXT_105 = "      " + NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_106 = " = conn_";
  protected final String TEXT_107 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_108 = " = dbMetaData_";
  protected final String TEXT_109 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_110 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_111 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_112 = " = rsTable_";
  protected final String TEXT_113 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_118 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_129 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_130 = " = conn_";
  protected final String TEXT_131 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_132 = ".execute(\"";
  protected final String TEXT_133 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_134 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_142 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_143 = ".executeUpdate(\"";
  protected final String TEXT_144 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_145 = ".close();";
  protected final String TEXT_146 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_147 = " = conn_";
  protected final String TEXT_148 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_149 = " = stmtTruncCount_";
  protected final String TEXT_150 = ".executeQuery(\"";
  protected final String TEXT_151 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_154 = ".executeUpdate(\"";
  protected final String TEXT_155 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_156 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_157 = " += rsTruncCount_";
  protected final String TEXT_158 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_159 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_160 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_161 = ".close();            ";
  protected final String TEXT_162 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_163 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_164 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_165 = NL + "\t";
  protected final String TEXT_166 = NL + "        int keyCount_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_169 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        String tmpTableName_";
  ...
  protected final String TEXT_173 = "\" + \"_\" + pid;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_176 = ".execute(\"";
  protected final String TEXT_177 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_178 = ".close();";
  protected final String TEXT_179 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_180 = " =conn_";
  protected final String TEXT_181 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_182 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_183 = ".close();" + NL + "   \t\t";
  protected final String TEXT_184 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_187 = ".execute(bulkSQL_";
  protected final String TEXT_188 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_189 = ".close();" + NL + "        tableName_";
  protected final String TEXT_190 = " = tmpTableName_";
  protected final String TEXT_191 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_192 = " = \"tmp_";
  protected final String TEXT_193 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_196 = ".executeUpdate(\"";
  protected final String TEXT_197 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_198 = ".close();" + NL + "        tableName_";
  protected final String TEXT_199 = " = tmpTableName_";
  protected final String TEXT_200 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_203 = ".execute(\"";
  protected final String TEXT_204 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_205 = ".close();";
  protected final String TEXT_206 = NL + "\t    ";
  protected final String TEXT_207 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_208 = " =conn_";
  protected final String TEXT_209 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_210 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_211 = ".close();" + NL + "   \t\t";
  protected final String TEXT_212 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_215 = ".execute(bulkSQL_";
  protected final String TEXT_216 = ");" + NL + "    stmtBulk_";
