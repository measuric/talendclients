...
public class TMDMViewSearchBeginJava
{
  ...
  protected final String TEXT_41 = ".size() > 0){" + NL + "\t\t\t\t";
  protected final String TEXT_42 = NL + "\t\t\t\t\twsItem_";
  protected final String TEXT_43 = " =new org.talend.mdm.webservice.WSWhereItem(null,conditions_";
  protected final String TEXT_44 = ".toArray(new org.talend.mdm.webservice.WSWhereItem[conditions_";
  protected final String TEXT_45 = ".size()]),null);" + NL + "\t\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\t\twsItem_";
  protected final String TEXT_47 = " =new org.talend.mdm.webservice.WSWhereItem(null,null,conditions_";
  protected final String TEXT_48 = ".toArray(new org.talend.mdm.webservice.WSWhereItem[conditions_";
  protected final String TEXT_49 = ".size()]));" + NL + "\t\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\torg.talend.mdm.webservice.WSViewSearch wsViewSearch_";
  protected final String TEXT_51 = " = null;" + NL + "\t\t\t\t" + NL + "\t\t\t\tint limit_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "\t\t\t\tint recordsPerPage_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "\t\t\t\tint skip_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "\t\t\t\t" + NL + "\t\t\t\tif (skip_";
  protected final String TEXT_58 = " < 0)" + NL + "\t                skip_";
  protected final String TEXT_59 = " = 0;" + NL + "\t" + NL + "\t            if (recordsPerPage_";
  protected final String TEXT_60 = " <= 0)" + NL + "\t                recordsPerPage_";
  protected final String TEXT_61 = " = -1;// read whole records in one time" + NL + "\t" + NL + "\t            if (limit_";
  protected final String TEXT_62 = " <= 0)" + NL + "\t                limit_";
  protected final String TEXT_63 = " = -1;// no limit" + NL + "\t\t\t\t" + NL + "\t            int retrievedCount_";
  protected final String TEXT_64 = " = 0;" + NL + "       \t\t\tint readRecordsSize_";
  protected final String TEXT_65 = " = limit_";
  protected final String TEXT_66 = " == -1 ? recordsPerPage_";
  protected final String TEXT_67 = " : (recordsPerPage_";
  protected final String TEXT_68 = " == -1 ? limit_";
  protected final String TEXT_69 = " : (recordsPerPage_";
  protected final String TEXT_70 = " > limit_";
  protected final String TEXT_71 = " ? limit_";
  protected final String TEXT_72 = NL + "                : recordsPerPage_";
  protected final String TEXT_73 = "));" + NL + "" + NL + "\t\t\t\torg.talend.mdm.webservice.WSGetItems getitems_";
  protected final String TEXT_74 = "=null;" + NL + "\t\t\t\t" + NL + "        \t\tboolean continueFlag_";
  protected final String TEXT_75 = " = true;" + NL + "\t\t\t\tint totalCount_";
  protected final String TEXT_76 = " = -1;";
  protected final String TEXT_77 = NL + "        \t\twhile (continueFlag_";
  protected final String TEXT_78 = ") {" + NL + "\t\t\t\t\twsViewSearch_";
  protected final String TEXT_79 = " = new org.talend.mdm.webservice.WSViewSearch();       \t\t\t\t\t                " + NL + "\t                wsViewSearch_";
  protected final String TEXT_80 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_81 = ");" + NL + "\t\t\t\t\twsViewSearch_";
  protected final String TEXT_82 = ".setWsViewPK(new org.talend.mdm.webservice.WSViewPK(";
  protected final String TEXT_83 = "));" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\twsViewSearch_";
  protected final String TEXT_84 = ".setSpellTreshold(";
  protected final String TEXT_85 = ");" + NL + "\t\t\t\t\twsViewSearch_";
  protected final String TEXT_86 = ".setSkip(skip_";
  protected final String TEXT_87 = " + retrievedCount_";
  protected final String TEXT_88 = ");" + NL + "\t\t\t\t\twsViewSearch_";
  protected final String TEXT_89 = ".setMaxItems(readRecordsSize_";
  protected final String TEXT_90 = ");" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\t\t\twsViewSearch_";
  protected final String TEXT_92 = ".setOrderBy(";
  protected final String TEXT_93 = "); // OPTIONAL" + NL + "\t\t\t\t\t\twsViewSearch_";
  protected final String TEXT_94 = ".setDirection(\"";
  protected final String TEXT_95 = "\"); // OPTIONAL" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t\twsViewSearch_";
  protected final String TEXT_97 = ".setWhereItem(wsItem_";
  protected final String TEXT_98 = "); // OPTIONAL" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tString[] items_";
  protected final String TEXT_99 = " = xtentisWS_";
  protected final String TEXT_100 = ".viewSearch(wsViewSearch_";
  protected final String TEXT_101 = ");" + NL + "\t\t\t\t\tif(totalCount_";
  protected final String TEXT_102 = " < 0){" + NL + "\t\t\t\t\t\ttotalCount_";
  protected final String TEXT_103 = " = Integer.valueOf(items_";
  protected final String TEXT_104 = "[0].replaceAll(\"<totalCount>\", \"\").replaceAll(\"</totalCount>\", \"\"));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tretrievedCount_";
  protected final String TEXT_105 = " += items_";
  protected final String TEXT_106 = ".length - 1; // for header" + NL + "\t\t\t\t\tif (totalCount_";
  protected final String TEXT_107 = " == retrievedCount_";
  protected final String TEXT_108 = " || recordsPerPage_";
  protected final String TEXT_109 = " == -1 || items_";
  protected final String TEXT_110 = ".length < readRecordsSize_";
  ...
  protected final String TEXT_128 = " = items_";
