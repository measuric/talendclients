...
public class TJDBCOutputMainJava {
  ...
  protected final String TEXT_70 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_112 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_141 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_179 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_211 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_239 = ".addBatch();" + NL + "\t\t\t";
  protected final String TEXT_240 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_241 = "++;";
  protected final String TEXT_242 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_243 = " = deletedCount_";
  protected final String TEXT_244 = " + pstmt_";
  protected final String TEXT_245 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_260 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_261 = ";";
  protected final String TEXT_262 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_263 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_264 = NL + "            nb_line_";
  protected final String TEXT_265 = "++;";
  protected final String TEXT_266 = NL + "            if(!whetherReject_";
  protected final String TEXT_267 = ") {";
  protected final String TEXT_268 = NL + "                            ";
  protected final String TEXT_269 = " = new ";
  protected final String TEXT_270 = "Struct();";
  ...
  protected final String TEXT_277 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_278 = " <= batchSizeCounter_";
  protected final String TEXT_279 = ") {                ";
  protected final String TEXT_280 = "                                                " + NL + "\t\t\t\t\tint[] status_";
  protected final String TEXT_281 = " = null;" + NL + "\t\t\t\t\tint countSum_";
  protected final String TEXT_282 = " = 0;" + NL + "\t                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_283 = " = 0;" + NL + "\t\t\t\t\t\tstatus_";
  protected final String TEXT_284 = " = pstmt_";
  protected final String TEXT_285 = ".executeBatch();" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_286 = ": status_";
  protected final String TEXT_287 = ") {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_288 = " += (countEach_";
  protected final String TEXT_289 = " < 0 ? 0 : countEach_";
  protected final String TEXT_290 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t                \t";
  protected final String TEXT_291 = NL + "\t                \t\tthrow(e);" + NL + "\t                \t";
  protected final String TEXT_292 = NL + "\t                \tfor(int countEach_";
  protected final String TEXT_293 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_294 = " += (countEach_";
  protected final String TEXT_295 = " < 0 ? 0 : countEach_";
  protected final String TEXT_296 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t                \tSystem.err.println(e.getMessage());" + NL + "\t                \t";
  protected final String TEXT_297 = NL + "\t                }" + NL + "\t                try {" + NL + "        \t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_298 = " = pstmt_";
  protected final String TEXT_299 = ".getUpdateCount();" + NL + "\t\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t                \t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_300 = " = tmp_batchUpdateCount_";
  protected final String TEXT_301 = " > countSum_";
  protected final String TEXT_302 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_303 = " : countSum_";
  protected final String TEXT_304 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_305 = NL + "\t    \t    \t\tinsertedCount_";
  protected final String TEXT_306 = " += tmp_batchUpdateCount_";
  protected final String TEXT_307 = "; " + NL + "\t    \t    \t";
  protected final String TEXT_308 = NL + "\t    \t    \t\tupdatedCount_";
  protected final String TEXT_309 = " += tmp_batchUpdateCount_";
  protected final String TEXT_310 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_311 = NL + "\t    \t    \t    deletedCount_";
  protected final String TEXT_312 = " += tmp_batchUpdateCount_";
  protected final String TEXT_313 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_314 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_315 = NL + "                commitCounter_";
  protected final String TEXT_316 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_317 = " <= commitCounter_";
  protected final String TEXT_318 = ") {" + NL + "                    connection_";
  protected final String TEXT_319 = ".commit();" + NL + "                    commitCounter_";
