...
public class TDBOutputMainJava {
  ...
  protected final String TEXT_19 = NL + "            try {";
  ...
  protected final String TEXT_23 = ".executeUpdate(query_";
  protected final String TEXT_24 = ".toString().trim());";
  protected final String TEXT_25 = NL + "                insertedCount_";
  protected final String TEXT_26 = " = insertedCount_";
  protected final String TEXT_27 = " + pstmt_";
  protected final String TEXT_28 = ".executeUpdate();";
  protected final String TEXT_29 = NL + "                nb_line_";
  protected final String TEXT_30 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_41 = NL + "                        rejectedCount_";
  protected final String TEXT_42 = " = rejectedCount_";
  ...
  protected final String TEXT_64 = ".executeUpdate(query_";
  protected final String TEXT_65 = ".toString().trim());";
  protected final String TEXT_66 = NL + "                updatedCount_";
  protected final String TEXT_67 = " = updatedCount_";
  protected final String TEXT_68 = " + pstmt_";
  protected final String TEXT_69 = ".executeUpdate();";
  ...
  protected final String TEXT_95 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_96 = " = pstmt_";
  protected final String TEXT_97 = ".executeQuery(query_";
  protected final String TEXT_98 = ".toString().trim());" + NL + "    \t\tquery_";
  protected final String TEXT_99 = " = new StringBuffer(\"\");" + NL + "    \t\t";
  protected final String TEXT_100 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_101 = " = pstmt_";
  protected final String TEXT_102 = ".executeQuery();" + NL + "    \t\t";
  protected final String TEXT_103 = NL + "    \t\tint checkCount_";
  protected final String TEXT_104 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_105 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_106 = " = rs_";
  protected final String TEXT_107 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_120 = NL + "                try {";
  protected final String TEXT_121 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_122 = " = updatedCount_";
  protected final String TEXT_123 = " + pstmtUpdate_";
  protected final String TEXT_124 = ".executeUpdate(query_";
  protected final String TEXT_125 = ".toString().trim());" + NL + "            \t";
  protected final String TEXT_126 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_127 = " = updatedCount_";
  protected final String TEXT_128 = " + pstmtUpdate_";
  protected final String TEXT_129 = ".executeUpdate();" + NL + "            \t";
  protected final String TEXT_130 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_141 = NL + "                            rejectedCount_";
  protected final String TEXT_142 = " = rejectedCount_";
  protected final String TEXT_143 = " + 1;";
  protected final String TEXT_144 = NL + "                            ";
  protected final String TEXT_145 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_146 = ";" + NL + "                            ";
  protected final String TEXT_147 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_148 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_149 = NL + "                        ";
  protected final String TEXT_150 = NL + "                            query_";
  protected final String TEXT_151 = " = ";
  protected final String TEXT_152 = ";";
  protected final String TEXT_153 = NL + "                    globalMap.put(\"";
  protected final String TEXT_154 = "_QUERY\", query_";
  protected final String TEXT_155 = ".toString().trim());";
  protected final String TEXT_156 = NL + "                try {";
  protected final String TEXT_157 = NL + "                    insertedCount_";
  protected final String TEXT_158 = " = insertedCount_";
  protected final String TEXT_159 = " + pstmtInsert_";
  protected final String TEXT_160 = ".executeUpdate(query_";
  ...
  protected final String TEXT_164 = " + pstmtInsert_";
  ...
  protected final String TEXT_184 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_185 = "++;" + NL + "    \t\t";
  protected final String TEXT_186 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_199 = NL + "    \t" + NL + "            try {";
  protected final String TEXT_200 = NL + "                updateFlag_";
  protected final String TEXT_201 = "=pstmtUpdate_";
  protected final String TEXT_202 = ".executeUpdate(query_";
  protected final String TEXT_203 = ".toString().trim());";
  protected final String TEXT_204 = NL + "                updateFlag_";
  protected final String TEXT_205 = "=pstmtUpdate_";
  protected final String TEXT_206 = ".executeUpdate();";
  protected final String TEXT_207 = NL + "                updatedCount_";
  protected final String TEXT_208 = " = updatedCount_";
  protected final String TEXT_209 = " + updateFlag_";
  protected final String TEXT_210 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_221 = NL + "                        rejectedCount_";
  protected final String TEXT_222 = " = rejectedCount_";
  protected final String TEXT_223 = " + 1;";
  ...
  protected final String TEXT_228 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_229 = " == 0) {" + NL + "            \t";
  protected final String TEXT_230 = NL + "\t\t\t\tquery_";
  protected final String TEXT_231 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_232 = NL + "                        ";
  protected final String TEXT_233 = NL + "                            query_";
  protected final String TEXT_234 = " = ";
  protected final String TEXT_235 = ";";
  protected final String TEXT_236 = NL + "                    globalMap.put(\"";
  protected final String TEXT_237 = "_QUERY\", query_";
  protected final String TEXT_238 = ".toString().trim());";
  protected final String TEXT_239 = NL + "                try {";
  protected final String TEXT_240 = NL + "                    insertedCount_";
  protected final String TEXT_241 = " = insertedCount_";
  protected final String TEXT_242 = " + pstmtInsert_";
  protected final String TEXT_243 = ".executeUpdate(query_";
  ...
  protected final String TEXT_248 = ".executeUpdate();";
  protected final String TEXT_249 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_260 = NL + "                            rejectedCount_";
  protected final String TEXT_261 = " = rejectedCount_";
  ...
  protected final String TEXT_267 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_274 = "_QUERY\", query_";
  protected final String TEXT_275 = ".toString().trim());";
  protected final String TEXT_276 = NL + "            try {" + NL + "\t\t\t";
  protected final String TEXT_277 = NL + "               deletedCount_";
  protected final String TEXT_278 = " = deletedCount_";
  protected final String TEXT_279 = " + pstmt_";
  protected final String TEXT_280 = ".executeUpdate(query_";
  protected final String TEXT_281 = ".toString().trim());" + NL + "\t\t\t";
  protected final String TEXT_282 = NL + "               deletedCount_";
  protected final String TEXT_283 = " = deletedCount_";
  protected final String TEXT_284 = " + pstmt_";
  protected final String TEXT_285 = ".executeUpdate();" + NL + "\t\t\t";
  protected final String TEXT_286 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_287 = " = true;";
  protected final String TEXT_288 = NL + "                    throw(e);";
  ...
  protected final String TEXT_297 = NL + "                        rejectedCount_";
  protected final String TEXT_298 = " = rejectedCount_";
  protected final String TEXT_299 = " + 1;";
  protected final String TEXT_300 = NL + "                        ";
  protected final String TEXT_301 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_302 = ";";
  protected final String TEXT_303 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_304 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_305 = "++;" + NL + "    \t";
  protected final String TEXT_306 = NL + "            if(!whetherReject_";
  protected final String TEXT_307 = ") {";
  protected final String TEXT_308 = NL + "                            ";
  protected final String TEXT_309 = " = new ";
  protected final String TEXT_310 = "Struct();";
  ...
  protected final String TEXT_317 = NL + "            commitCounter_";
  protected final String TEXT_318 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_319 = " <= commitCounter_";
  protected final String TEXT_320 = ") {" + NL + "            " + NL + "            \tconn_";
  protected final String TEXT_321 = ".commit();" + NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_322 = "=0;" + NL + "            }\t" + NL + "    \t";
