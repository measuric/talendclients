...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_130 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_138 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_139 = " + \" WHERE ";
  protected final String TEXT_140 = "\");\t" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_143 = " + \" (";
  protected final String TEXT_144 = ") VALUES (";
  protected final String TEXT_145 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_148 = " + \" SET ";
  protected final String TEXT_149 = " WHERE ";
  protected final String TEXT_150 = "\");" + NL + "\t\t" + NL + "\t    ";
  protected final String TEXT_151 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_154 = " + \" SET ";
  protected final String TEXT_155 = " WHERE ";
  protected final String TEXT_156 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_157 = " = conn_";
  protected final String TEXT_158 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_159 = " + \" (";
  protected final String TEXT_160 = ") VALUES (";
  protected final String TEXT_161 = ")\");" + NL + "\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_162 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_165 = " + \" WHERE ";
  protected final String TEXT_166 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_167 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_168 = " = ";
  protected final String TEXT_169 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_170 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_171 = NL + "\t   int batchSize_";
  protected final String TEXT_172 = " = ";
  protected final String TEXT_173 = ";" + NL + "\t   int batchSizeCounter_";
