...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_143 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_149 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_150 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_151 = " = tableNameForSearch_";
  protected final String TEXT_152 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_153 = " = tableNameForSearch_";
  protected final String TEXT_154 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_182 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_183 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_187 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_188 = " = dbMetaData_";
  protected final String TEXT_189 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_190 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_191 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_192 = " = rsTable_";
  protected final String TEXT_193 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_194 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_211 = ", \"+DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_212 = ".";
  protected final String TEXT_213 = ", \"";
  protected final String TEXT_214 = "\")+\")";
  protected final String TEXT_215 = "\");";
  protected final String TEXT_216 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_217 = ".execute(\"";
  ...
  protected final String TEXT_222 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_225 = ".execute(\"";
  protected final String TEXT_226 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_227 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_228 = " = conn_";
  protected final String TEXT_229 = ".createStatement();";
  ...
  protected final String TEXT_239 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_249 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_250 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_251 = "            ";
  protected final String TEXT_252 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_255 = ".executeUpdate(\"";
  protected final String TEXT_256 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_257 = ".close();";
  protected final String TEXT_258 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_259 = " = conn_";
  protected final String TEXT_260 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_261 = " = stmtTruncCount_";
  protected final String TEXT_262 = ".executeQuery(\"";
  protected final String TEXT_263 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_266 = ".executeUpdate(\"";
  protected final String TEXT_267 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_268 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_269 = " += rsTruncCount_";
  protected final String TEXT_270 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_271 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_272 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_273 = ".close();            ";
  protected final String TEXT_274 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_277 = " = stmtTruncCount_";
  protected final String TEXT_278 = ".executeQuery(\"";
  protected final String TEXT_279 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_282 = ".executeUpdate(\"";
  protected final String TEXT_283 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_284 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_285 = " += rsTruncCount_";
  protected final String TEXT_286 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_287 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_288 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_289 = ".close();";
  protected final String TEXT_290 = NL + "\t    String insert_";
  protected final String TEXT_291 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_292 = " + \" (";
  protected final String TEXT_293 = ") VALUES (";
  protected final String TEXT_294 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_295 = " = conn_";
  protected final String TEXT_296 = ".prepareStatement(insert_";
  protected final String TEXT_297 = ");" + NL + "\t    ";
  protected final String TEXT_298 = NL + "\t    String update_";
  protected final String TEXT_299 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_300 = " + \" SET ";
  protected final String TEXT_301 = " WHERE ";
  protected final String TEXT_302 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_303 = " = conn_";
  protected final String TEXT_304 = ".prepareStatement(update_";
  protected final String TEXT_305 = ");" + NL + "\t    ";
  protected final String TEXT_306 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_307 = " = conn_";
  protected final String TEXT_308 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_309 = " + \" WHERE ";
  protected final String TEXT_310 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_311 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_312 = " + \" (";
  protected final String TEXT_313 = ") VALUES (";
  protected final String TEXT_314 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_321 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_329 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_330 = " = conn_";
  protected final String TEXT_331 = ".prepareStatement(update_";
  ...
  protected final String TEXT_336 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_337 = " = conn_";
  protected final String TEXT_338 = ".prepareStatement(insert_";
  protected final String TEXT_339 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_340 = NL + "\t    String delete_";
  protected final String TEXT_341 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_345 = ".prepareStatement(delete_";
  protected final String TEXT_346 = ");" + NL + "\t    ";
  protected final String TEXT_347 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_352 = NL + "\t\t\tupdate_";
  protected final String TEXT_353 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_354 = " = update_";
  protected final String TEXT_355 = ".split(\"\\\\?\");";
  protected final String TEXT_356 = NL + "\t\t\tupdate_";
  protected final String TEXT_357 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_358 = " = update_";
  protected final String TEXT_359 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_360 = " = insert_";
  protected final String TEXT_361 = ".split(\"\\\\?\");";
  protected final String TEXT_362 = NL + "\t\t\tdelete_";
  protected final String TEXT_363 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_364 = " = delete_";
  protected final String TEXT_365 = ".split(\"\\\\?\");";
  protected final String TEXT_366 = NL + "\t\t\treplace_";
  protected final String TEXT_367 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_368 = " = replace_";
  protected final String TEXT_369 = ".split(\"\\\\?\");";
  protected final String TEXT_370 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_371 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_372 = " = insertIgnore_";
  protected final String TEXT_373 = ".split(\"\\\\?\");";
  protected final String TEXT_374 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_375 = " = insert_";
  protected final String TEXT_376 = ".split(\"\\\\?\");";
  protected final String TEXT_377 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_378 = " = conn_";
  protected final String TEXT_379 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_380 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_381 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_382 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_383 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_384 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
