...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_391 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_392 = " = conn_";
  protected final String TEXT_393 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_394 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_395 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_396 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_397 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_398 = " = buffersSize_";
  protected final String TEXT_399 = ";";
  protected final String TEXT_400 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_401 = " = buffersSize_";
  protected final String TEXT_402 = ";";
  protected final String TEXT_403 = NL + "        whetherReject_";
  protected final String TEXT_404 = " = false;";
  protected final String TEXT_405 = NL + "                    ";
  protected final String TEXT_406 = NL + "                        query_";
  protected final String TEXT_407 = " = ";
  protected final String TEXT_408 = ";";
  protected final String TEXT_409 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_410 = ".";
  protected final String TEXT_411 = ", pstmt_";
  protected final String TEXT_412 = ", ";
  protected final String TEXT_413 = ", \"";
  protected final String TEXT_414 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_415 = NL + "                globalMap.put(\"";
  protected final String TEXT_416 = "_QUERY\", query_";
  protected final String TEXT_417 = ".toString().trim());";
  protected final String TEXT_418 = NL + "    \t\tpstmt_";
  protected final String TEXT_419 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_420 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_421 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_422 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_423 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_424 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_425 = " = insertedCount_";
  protected final String TEXT_426 = " + pstmt_";
  protected final String TEXT_427 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_428 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_429 = " = true;";
  protected final String TEXT_430 = NL + "                    throw(e);";
  protected final String TEXT_431 = NL + "                        ";
  protected final String TEXT_432 = " = new ";
  protected final String TEXT_433 = "Struct();";
  protected final String TEXT_434 = NL + "                            ";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = " = ";
  protected final String TEXT_437 = ".";
  protected final String TEXT_438 = ";";
  protected final String TEXT_439 = NL + "                        rejectedCount_";
  protected final String TEXT_440 = " = rejectedCount_";
  protected final String TEXT_441 = " + 1;";
  protected final String TEXT_442 = NL + "                        ";
  protected final String TEXT_443 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_444 = ";";
  protected final String TEXT_445 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_446 = NL + "            }";
  protected final String TEXT_447 = NL + "                    ";
  protected final String TEXT_448 = NL + "                        query_";
  protected final String TEXT_449 = " = ";
  protected final String TEXT_450 = ";";
  protected final String TEXT_451 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_452 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_469 = "_QUERY\", query_";
  protected final String TEXT_470 = ".toString().trim());";
  protected final String TEXT_471 = NL + "    \t\tpstmt_";
  protected final String TEXT_472 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_473 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_474 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_475 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_476 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_477 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_478 = " = updatedCount_";
  protected final String TEXT_479 = " + pstmt_";
  protected final String TEXT_480 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_481 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_482 = " = true;";
  protected final String TEXT_483 = NL + "                    throw(e);";
  protected final String TEXT_484 = NL + "                        ";
  protected final String TEXT_485 = " = new ";
  protected final String TEXT_486 = "Struct();";
  protected final String TEXT_487 = NL + "                            ";
  protected final String TEXT_488 = ".";
  protected final String TEXT_489 = " = ";
  protected final String TEXT_490 = ".";
  protected final String TEXT_491 = ";";
  protected final String TEXT_492 = NL + "                        rejectedCount_";
  protected final String TEXT_493 = " = rejectedCount_";
  protected final String TEXT_494 = " + 1;";
  protected final String TEXT_495 = NL + "                        ";
  protected final String TEXT_496 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_537 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_538 = " = true;";
  protected final String TEXT_539 = NL + "                        throw(e);";
  ...
  protected final String TEXT_550 = " + 1;";
  protected final String TEXT_551 = NL + "                            ";
  protected final String TEXT_552 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_553 = ";";
  protected final String TEXT_554 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_555 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_556 = NL + "                        ";
  protected final String TEXT_557 = NL + "                            query_";
  ...
  protected final String TEXT_569 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_570 = " = insertedCount_";
  protected final String TEXT_571 = " + pstmtInsert_";
  protected final String TEXT_572 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_573 = " = true;";
  protected final String TEXT_574 = NL + "                        throw(e);";
  protected final String TEXT_575 = NL + "                            ";
  protected final String TEXT_576 = " = new ";
  protected final String TEXT_577 = "Struct();";
  protected final String TEXT_578 = NL + "                                ";
  protected final String TEXT_579 = ".";
  protected final String TEXT_580 = " = ";
  protected final String TEXT_581 = ".";
  protected final String TEXT_582 = ";";
  protected final String TEXT_583 = NL + "                            rejectedCount_";
  protected final String TEXT_584 = " = rejectedCount_";
  protected final String TEXT_585 = " + 1;";
  protected final String TEXT_586 = NL + "                            ";
  protected final String TEXT_587 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_588 = ";";
  protected final String TEXT_589 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_590 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_591 = "++;";
  protected final String TEXT_592 = NL + "            int updateFlag_";
  protected final String TEXT_593 = " = 0;";
  protected final String TEXT_594 = NL + "                    ";
  protected final String TEXT_595 = NL + "                        query_";
  protected final String TEXT_596 = " = ";
  protected final String TEXT_597 = ";";
  protected final String TEXT_598 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_599 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_600 = ".";
  protected final String TEXT_601 = ", pstmtUpdate_";
  ...
  protected final String TEXT_614 = NL + "                globalMap.put(\"";
  protected final String TEXT_615 = "_QUERY\", query_";
  protected final String TEXT_616 = ".toString().trim());";
  protected final String TEXT_617 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_618 = "=pstmtUpdate_";
  protected final String TEXT_619 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_620 = " = updatedCount_";
  protected final String TEXT_621 = "+updateFlag_";
  protected final String TEXT_622 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_623 = " = true;";
  protected final String TEXT_624 = NL + "                    throw(e);";
  protected final String TEXT_625 = NL + "                        ";
  protected final String TEXT_626 = " = new ";
  protected final String TEXT_627 = "Struct();";
  protected final String TEXT_628 = NL + "                            ";
  protected final String TEXT_629 = ".";
  protected final String TEXT_630 = " = ";
  protected final String TEXT_631 = ".";
  protected final String TEXT_632 = ";";
  protected final String TEXT_633 = NL + "                        rejectedCount_";
  protected final String TEXT_634 = " = rejectedCount_";
  ...
  protected final String TEXT_640 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_641 = " == 0) {" + NL + "            \t";
  protected final String TEXT_642 = NL + "\t\t\t\tquery_";
  protected final String TEXT_643 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_644 = NL + "                        ";
  protected final String TEXT_645 = NL + "                            query_";
  protected final String TEXT_646 = " = ";
  protected final String TEXT_647 = ";";
  protected final String TEXT_648 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_649 = ".";
  protected final String TEXT_650 = ", pstmtInsert_";
  protected final String TEXT_651 = ", ";
  protected final String TEXT_652 = ", \"";
  protected final String TEXT_653 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_654 = NL + "                    globalMap.put(\"";
  protected final String TEXT_655 = "_QUERY\", query_";
  protected final String TEXT_656 = ".toString().trim());";
  protected final String TEXT_657 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_658 = " = insertedCount_";
  protected final String TEXT_659 = " + pstmtInsert_";
  protected final String TEXT_660 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_661 = " = true;";
  protected final String TEXT_662 = NL + "                        throw(e);";
  protected final String TEXT_663 = NL + "                            ";
  protected final String TEXT_664 = " = new ";
  protected final String TEXT_665 = "Struct();";
  protected final String TEXT_666 = NL + "                                ";
  protected final String TEXT_667 = ".";
  protected final String TEXT_668 = " = ";
  protected final String TEXT_669 = ".";
  protected final String TEXT_670 = ";";
  protected final String TEXT_671 = NL + "                            rejectedCount_";
  protected final String TEXT_672 = " = rejectedCount_";
  protected final String TEXT_673 = " + 1;";
  protected final String TEXT_674 = NL + "                            ";
  protected final String TEXT_675 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_676 = ";";
  protected final String TEXT_677 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_678 = NL + "                }" + NL + "            }" + NL + "            " + NL + "            nb_line_";
  ...
  protected final String TEXT_693 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_694 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_695 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_696 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_697 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_698 = " = deletedCount_";
  protected final String TEXT_699 = " + pstmt_";
  protected final String TEXT_700 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_701 = " = true;";
  protected final String TEXT_702 = NL + "                    throw(e);";
  protected final String TEXT_703 = NL + "                        ";
  protected final String TEXT_704 = " = new ";
  protected final String TEXT_705 = "Struct();";
  protected final String TEXT_706 = NL + "                            ";
  protected final String TEXT_707 = ".";
  protected final String TEXT_708 = " = ";
  protected final String TEXT_709 = ".";
  protected final String TEXT_710 = ";";
  protected final String TEXT_711 = NL + "                        rejectedCount_";
  protected final String TEXT_712 = " = rejectedCount_";
  protected final String TEXT_713 = " + 1;";
  ...
  protected final String TEXT_717 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_718 = NL + "            }" + NL + "           \t";
  protected final String TEXT_719 = NL + "            nb_line_";
  protected final String TEXT_720 = "++;";
  protected final String TEXT_721 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_732 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_733 = " <= batchSizeCounter_";
  protected final String TEXT_734 = ") {                ";
  protected final String TEXT_735 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_736 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_737 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_738 = ": pstmt_";
  protected final String TEXT_739 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_740 = " += (countEach_";
  protected final String TEXT_741 = " < 0 ? 0 : countEach_";
  protected final String TEXT_742 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "            \t    \t";
  protected final String TEXT_743 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_744 = " += countSum_";
  protected final String TEXT_745 = ";" + NL + "            \t    \t";
  protected final String TEXT_746 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_747 = " += countSum_";
  protected final String TEXT_748 = ";" + NL + "            \t    \t";
  protected final String TEXT_749 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_750 = " += countSum_";
  protected final String TEXT_751 = ";" + NL + "            \t    \t";
  protected final String TEXT_752 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_753 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_754 = NL + "                \tint countSum_";
  protected final String TEXT_755 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_756 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_769 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_770 = NL + "                }";
  protected final String TEXT_771 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_772 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_773 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_774 = " <= commitCounter_";
  protected final String TEXT_775 = ") {" + NL + "                ";
  protected final String TEXT_776 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_777 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_778 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_779 = NL + "                \t\tint countSum_";
  protected final String TEXT_780 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_781 = ": pstmt_";
  protected final String TEXT_782 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_783 = " += (countEach_";
  protected final String TEXT_784 = " < 0 ? 0 : countEach_";
  protected final String TEXT_785 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_786 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_787 = " += countSum_";
  protected final String TEXT_788 = ";" + NL + "            \t    \t";
  protected final String TEXT_789 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_790 = " += countSum_";
  protected final String TEXT_791 = ";" + NL + "            \t    \t";
  protected final String TEXT_792 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_793 = " += countSum_";
  protected final String TEXT_794 = ";" + NL + "            \t    \t";
  protected final String TEXT_795 = "  " + NL + "            \t    \t";
  protected final String TEXT_796 = NL + "\t                \tbatchSizeCounter_";
  protected final String TEXT_797 = " = 0;  " + NL + "\t                \t";
  protected final String TEXT_798 = NL + "            \t   ";
  protected final String TEXT_799 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_800 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_801 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_802 = NL + "\t                \tint countSum_";
  protected final String TEXT_803 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_804 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_805 = " += (countEach_";
  protected final String TEXT_806 = " < 0 ? 0 : countEach_";
  protected final String TEXT_807 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_808 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_809 = " += countSum_";
  protected final String TEXT_810 = ";" + NL + "            \t    \t";
  protected final String TEXT_811 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_812 = " += countSum_";
  protected final String TEXT_813 = ";" + NL + "            \t    \t";
  protected final String TEXT_814 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_815 = " += countSum_";
  protected final String TEXT_816 = ";" + NL + "            \t    \t";
  protected final String TEXT_817 = " " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_818 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_819 = NL + "                \tconn_";
  protected final String TEXT_820 = ".commit();                " + NL + "                \tcommitCounter_";
