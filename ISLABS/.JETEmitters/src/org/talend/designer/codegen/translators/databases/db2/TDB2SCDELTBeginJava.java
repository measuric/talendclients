...
public class TDB2SCDELTBeginJava {
  ...
  protected final String TEXT_117 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  ...
  protected final String TEXT_143 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_144 = "\"))) + \"', CAST(NULL AS ";
  protected final String TEXT_145 = ")";
  protected final String TEXT_146 = ", 1";
  protected final String TEXT_147 = ", d.\\\"";
  protected final String TEXT_148 = "\\\" + 1";
  protected final String TEXT_149 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_150 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_151 = " + \"\\\" d WHERE ";
  protected final String TEXT_152 = " AND (";
  protected final String TEXT_153 = ") AND d.\\\"";
  protected final String TEXT_154 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_155 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_156 = " = conn_";
  protected final String TEXT_157 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_158 = ".executeUpdate(insertForType2_";
  protected final String TEXT_159 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_160 = ".close();";
  protected final String TEXT_161 = NL + "            System.out.println(\"[";
  protected final String TEXT_162 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_163 = " + \"\\ndone\");";
  protected final String TEXT_164 = NL + "    String insert_";
  protected final String TEXT_165 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_166 = " + \"\\\"(";
  protected final String TEXT_167 = "\\\"";
  protected final String TEXT_168 = "\\\", ";
  protected final String TEXT_169 = ") SELECT ";
  protected final String TEXT_170 = "NEXT VALUE FOR \" + ";
  protected final String TEXT_171 = " + \", ";
  protected final String TEXT_172 = "t.";
  protected final String TEXT_173 = "\"";
  protected final String TEXT_174 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_175 = "\"))) + \"', CAST(NULL AS ";
