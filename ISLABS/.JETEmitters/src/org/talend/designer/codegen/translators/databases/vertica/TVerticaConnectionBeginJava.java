...
public class TVerticaConnectionBeginJava
{
  ...
  protected final String TEXT_21 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_29 = NL + "\tString password_";
  protected final String TEXT_30 = " = ";
  protected final String TEXT_31 = ";" + NL + "" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_32 = " = null;" + NL;
  protected final String TEXT_33 = NL + "\t";
  protected final String TEXT_34 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_35 = ")) {" + NL + "\t\t";
  protected final String TEXT_36 = NL + "\t\t";
  protected final String TEXT_37 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_38 = "\", conn_";
  protected final String TEXT_39 = ");" + NL + "\t}";
  protected final String TEXT_40 = NL + "\tif (null != conn_";
  protected final String TEXT_41 = ") {" + NL + "\t\t";
  protected final String TEXT_42 = NL + "\t}";
  protected final String TEXT_43 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_44 = "\",conn_";
  protected final String TEXT_45 = ");" + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_46 = "\", ";
  protected final String TEXT_47 = ");" + NL + "\tglobalMap.put(\"db_";
