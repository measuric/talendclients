...
public class TSystemBeginJava
{
  ...
  protected final String TEXT_85 = ".start();";
  protected final String TEXT_86 = NL + "if(ps_";
  protected final String TEXT_87 = ".getOutputStream()!=null){" + NL + "    ps_";
  protected final String TEXT_88 = ".getOutputStream().close();" + NL + "}" + NL + "ps_";
  protected final String TEXT_89 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_90 = ".join(10000);" + NL + "error_";
  protected final String TEXT_91 = ".join(10000);" + NL;
  protected final String TEXT_92 = NL + "\t\t\t\tfor(String tmp_";
  protected final String TEXT_93 = ":output_";
  protected final String TEXT_94 = "){";
  protected final String TEXT_95 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_96 = ".";
  protected final String TEXT_97 = " = tmp_";
