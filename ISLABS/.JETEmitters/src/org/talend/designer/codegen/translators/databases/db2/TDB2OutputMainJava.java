...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_424 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_474 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_475 = " = updatedCount_";
  protected final String TEXT_476 = " + pstmt_";
  protected final String TEXT_477 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_478 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_479 = " = true;";
  protected final String TEXT_480 = NL + "                    throw(e);";
  ...
  protected final String TEXT_493 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_500 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_501 = " = pstmt_";
  protected final String TEXT_502 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_503 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_504 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_505 = " = rs_";
  protected final String TEXT_506 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_507 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_508 = NL + "                        ";
  protected final String TEXT_509 = NL + "                            query_";
  protected final String TEXT_510 = " = ";
  protected final String TEXT_511 = ";";
  protected final String TEXT_512 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_513 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_514 = ".";
  protected final String TEXT_515 = ", pstmtUpdate_";
  protected final String TEXT_516 = ", ";
  protected final String TEXT_517 = ", \"";
  protected final String TEXT_518 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_519 = NL + "\t                    \t";
  protected final String TEXT_520 = NL + "\t                    ";
  protected final String TEXT_521 = NL + "\t                        query_";
  protected final String TEXT_522 = " = ";
  protected final String TEXT_523 = ";" + NL + "\t                        ";
  protected final String TEXT_524 = NL + "                        ";
  protected final String TEXT_525 = NL + "                            query_";
  protected final String TEXT_526 = " = ";
  protected final String TEXT_527 = ";";
  protected final String TEXT_528 = NL + "                    globalMap.put(\"";
  protected final String TEXT_529 = "_QUERY\", query_";
  protected final String TEXT_530 = ".toString().trim());";
  protected final String TEXT_531 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_532 = " = updatedCount_";
  protected final String TEXT_533 = " + pstmtUpdate_";
  protected final String TEXT_534 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_535 = " = true;";
  protected final String TEXT_536 = NL + "                        throw(e);";
  protected final String TEXT_537 = NL + "                            ";
  protected final String TEXT_538 = " = new ";
  protected final String TEXT_539 = "Struct();";
  protected final String TEXT_540 = NL + "                                ";
  protected final String TEXT_541 = ".";
  protected final String TEXT_542 = " = ";
  protected final String TEXT_543 = ".";
  protected final String TEXT_544 = ";";
  protected final String TEXT_545 = NL + "                            rejectedCount_";
  protected final String TEXT_546 = " = rejectedCount_";
  protected final String TEXT_547 = " + 1;";
  protected final String TEXT_548 = NL + "                            ";
  protected final String TEXT_549 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_550 = ";";
  protected final String TEXT_551 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_552 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_553 = NL + "                        ";
  protected final String TEXT_554 = NL + "                            query_";
  protected final String TEXT_555 = " = ";
  protected final String TEXT_556 = ";";
  protected final String TEXT_557 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_558 = ".";
  protected final String TEXT_559 = ", pstmtInsert_";
  protected final String TEXT_560 = ", ";
  protected final String TEXT_561 = ", \"";
  protected final String TEXT_562 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_563 = NL + "                    globalMap.put(\"";
  protected final String TEXT_564 = "_QUERY\", query_";
  protected final String TEXT_565 = ".toString().trim());";
  protected final String TEXT_566 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_567 = " = insertedCount_";
  protected final String TEXT_568 = " + pstmtInsert_";
  protected final String TEXT_569 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_570 = " = true;";
  protected final String TEXT_571 = NL + "                        throw(e);";
  protected final String TEXT_572 = NL + "                            ";
  protected final String TEXT_573 = " = new ";
  protected final String TEXT_574 = "Struct();";
  protected final String TEXT_575 = NL + "                                ";
  protected final String TEXT_576 = ".";
  protected final String TEXT_577 = " = ";
  protected final String TEXT_578 = ".";
  protected final String TEXT_579 = ";";
  protected final String TEXT_580 = NL + "                            rejectedCount_";
  protected final String TEXT_581 = " = rejectedCount_";
  protected final String TEXT_582 = " + 1;";
  protected final String TEXT_583 = NL + "                            ";
  protected final String TEXT_584 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_585 = ";";
  protected final String TEXT_586 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_587 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_588 = "++;" + NL + "    \t\t";
  protected final String TEXT_589 = NL + "    \t    int updateFlag_";
  protected final String TEXT_590 = "=0;" + NL + "    \t    ";
  protected final String TEXT_591 = NL + "                    ";
  protected final String TEXT_592 = NL + "                        query_";
  protected final String TEXT_593 = " = ";
  protected final String TEXT_594 = ";";
  protected final String TEXT_595 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_596 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_597 = ".";
  protected final String TEXT_598 = ", pstmtUpdate_";
  ...
  protected final String TEXT_609 = NL + "                        query_";
  ...
  protected final String TEXT_615 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_616 = "=pstmtUpdate_";
  protected final String TEXT_617 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_618 = " = updatedCount_";
  protected final String TEXT_619 = " + updateFlag_";
  protected final String TEXT_620 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_621 = " = true;";
  protected final String TEXT_622 = NL + "                    throw(e);";
  protected final String TEXT_623 = NL + "                        ";
  protected final String TEXT_624 = " = new ";
  protected final String TEXT_625 = "Struct();";
  ...
  protected final String TEXT_638 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_639 = " == 0) {" + NL + "            \t";
  protected final String TEXT_640 = NL + "\t\t\t\tquery_";
  protected final String TEXT_641 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_642 = NL + "                        ";
  protected final String TEXT_643 = NL + "                            query_";
  protected final String TEXT_644 = " = ";
  protected final String TEXT_645 = ";";
  protected final String TEXT_646 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_653 = "_QUERY\", query_";
  protected final String TEXT_654 = ".toString().trim());";
  protected final String TEXT_655 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_656 = " = insertedCount_";
  protected final String TEXT_657 = " + pstmtInsert_";
  protected final String TEXT_658 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_659 = " = true;";
  protected final String TEXT_660 = NL + "                        throw(e);";
  protected final String TEXT_661 = NL + "                            ";
  protected final String TEXT_662 = " = new ";
  protected final String TEXT_663 = "Struct();";
  protected final String TEXT_664 = NL + "                                ";
  protected final String TEXT_665 = ".";
  protected final String TEXT_666 = " = ";
  protected final String TEXT_667 = ".";
  protected final String TEXT_668 = ";";
  protected final String TEXT_669 = NL + "                            rejectedCount_";
  protected final String TEXT_670 = " = rejectedCount_";
  protected final String TEXT_671 = " + 1;";
  protected final String TEXT_672 = NL + "                            ";
  protected final String TEXT_673 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_674 = ";";
  protected final String TEXT_675 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_676 = NL + "                }" + NL + "            } " + NL + "    " + NL + "            nb_line_";
  ...
  protected final String TEXT_735 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_736 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_737 = ": pstmt_";
  protected final String TEXT_738 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_739 = " += (countEach_";
  protected final String TEXT_740 = " < 0 ? 0 : countEach_";
  protected final String TEXT_741 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "            \t    \t";
  protected final String TEXT_742 = NL + "            \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_746 = " += countSum_";
  protected final String TEXT_747 = ";" + NL + "            \t    \t";
  protected final String TEXT_748 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_749 = " += countSum_";
  protected final String TEXT_750 = ";" + NL + "            \t    \t";
  protected final String TEXT_751 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_752 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  ...
  protected final String TEXT_776 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_777 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_778 = ": pstmt_";
  protected final String TEXT_779 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_780 = " += (countEach_";
  protected final String TEXT_781 = " < 0 ? 0 : countEach_";
  protected final String TEXT_782 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_783 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_784 = " += countSum_";
  protected final String TEXT_785 = ";" + NL + "            \t    \t";
  protected final String TEXT_786 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_787 = " += countSum_";
  protected final String TEXT_788 = ";" + NL + "            \t    \t";
  protected final String TEXT_789 = NL + "            \t    \t    deletedCount_";
