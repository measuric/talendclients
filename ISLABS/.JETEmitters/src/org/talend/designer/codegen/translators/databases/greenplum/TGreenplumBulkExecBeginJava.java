...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_10 = NL + "    String tmpTableName_";
  protected final String TEXT_11 = " = \"tmp_";
  protected final String TEXT_12 = "_\" + pid;";
  protected final String TEXT_13 = NL + "String bulkSQL_";
  protected final String TEXT_14 = " = \"COPY \\\"\" + ";
  protected final String TEXT_15 = "tmpTableName_";
  protected final String TEXT_16 = "tableName_";
  protected final String TEXT_17 = " ";
  protected final String TEXT_18 = " + \"\\\" ";
  protected final String TEXT_19 = "FROM '\" + ";
  protected final String TEXT_20 = " + \"' WITH \";";
  protected final String TEXT_21 = NL + "    bulkSQL_";
  protected final String TEXT_22 = " += \"BINARY ";
  protected final String TEXT_23 = "\";";
  protected final String TEXT_24 = NL + "    bulkSQL_";
  protected final String TEXT_25 = " += \"";
  protected final String TEXT_26 = " \" + \"DELIMITER AS '\" + ";
  ...
  protected final String TEXT_31 = " += \"CSV ";
  protected final String TEXT_32 = " QUOTE AS '\" + ";
  protected final String TEXT_33 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  protected final String TEXT_34 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_35 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  ...
  protected final String TEXT_43 = NL + "\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\tconn_";
  protected final String TEXT_44 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_165 = NL + "        int keyCount_";
  protected final String TEXT_166 = " = ";
  protected final String TEXT_167 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_168 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_169 = " = tableName_";
  protected final String TEXT_170 = ";" + NL + "        tableName_";
  protected final String TEXT_171 = " = \"tmp_";
  protected final String TEXT_172 = "_\" + pid;" + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_173 = " = conn_";
  protected final String TEXT_174 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_175 = ".execute(\"";
  protected final String TEXT_176 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_177 = ".close();" + NL + "        java.sql.Statement stmtTmpBulk_";
  ...
  protected final String TEXT_199 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_202 = ".execute(bulkSQL_";
  protected final String TEXT_203 = ");" + NL + "    stmtBulk_";
