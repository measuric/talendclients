...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_190 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_196 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_197 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_198 = " = tableNameForSearch_";
  protected final String TEXT_199 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_200 = " = tableNameForSearch_";
  protected final String TEXT_201 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_202 = " = dbMetaData_";
  protected final String TEXT_203 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_204 = ", tableNameForSearch_";
  protected final String TEXT_205 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_206 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_207 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_208 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_209 = ".close();" + NL + "\t            ";
  protected final String TEXT_210 = "  \t            " + NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_213 = " = dbMetaData_";
  protected final String TEXT_214 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_215 = " = false;" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_240 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_241 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_251 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_258 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_268 = NL + "                if(whetherExist_";
  protected final String TEXT_269 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_270 = " = conn_";
  protected final String TEXT_271 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_272 = ".execute(\"";
  protected final String TEXT_273 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_274 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".createStatement();";
  protected final String TEXT_277 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_278 = ".execute(\"";
  protected final String TEXT_279 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_286 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_299 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_300 = " = conn_";
  protected final String TEXT_301 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_302 = ".executeUpdate(\"";
  protected final String TEXT_303 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_304 = ".close();";
  protected final String TEXT_305 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_306 = " = conn_";
  protected final String TEXT_307 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_308 = " = stmtTruncCount_";
  protected final String TEXT_309 = ".executeQuery(\"";
  protected final String TEXT_310 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_311 = " = conn_";
  protected final String TEXT_312 = ".createStatement();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_328 = ".createStatement();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_337 = NL + "\t    String insert_";
  protected final String TEXT_338 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_339 = " + \" (";
  protected final String TEXT_340 = ") VALUES (";
  protected final String TEXT_341 = ")\";" + NL + "\t   \t";
  protected final String TEXT_342 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_343 = " = new StringBuffer(insert_";
  protected final String TEXT_344 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_345 = ".insert(insert_";
  protected final String TEXT_346 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_347 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_348 = " =insertStringBuffer_";
  protected final String TEXT_349 = ".toString(); ";
  protected final String TEXT_350 = "    \t    " + NL + "\t    ";
  protected final String TEXT_351 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_352 = " = conn_";
  protected final String TEXT_353 = ".prepareStatement(insert_";
  protected final String TEXT_354 = ");";
  protected final String TEXT_355 = NL + "                        ";
  protected final String TEXT_356 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_357 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_358 = " = conn_";
  protected final String TEXT_359 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_360 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_361 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_362 = ",insert_";
  protected final String TEXT_363 = ",keyPsmt_";
  protected final String TEXT_364 = ");";
  protected final String TEXT_365 = NL + "\t    " + NL + "\t    ";
  protected final String TEXT_366 = NL + "\t    String update_";
  protected final String TEXT_367 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_368 = " + \" SET ";
  protected final String TEXT_369 = " WHERE ";
  protected final String TEXT_370 = "\";" + NL + "    \t";
  protected final String TEXT_371 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_372 = " = new StringBuffer(update_";
  protected final String TEXT_373 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_374 = ".insert(update_";
  protected final String TEXT_375 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_376 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_377 = " =updateStringBuffer_";
  ...
  protected final String TEXT_385 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_386 = " + \" WHERE ";
  protected final String TEXT_387 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_388 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_389 = " + \" (";
  protected final String TEXT_390 = ") VALUES (";
  protected final String TEXT_391 = ")\";" + NL + "\t   \t";
  protected final String TEXT_392 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_393 = " = new StringBuffer(insert_";
  protected final String TEXT_394 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_395 = ".insert(insert_";
  protected final String TEXT_396 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_397 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_398 = " =insertStringBuffer_";
  protected final String TEXT_399 = ".toString(); ";
  protected final String TEXT_400 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_401 = " = conn_";
  protected final String TEXT_402 = ".prepareStatement(insert_";
  protected final String TEXT_403 = ");" + NL + "\t    String update_";
  protected final String TEXT_404 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_405 = " + \" SET ";
  protected final String TEXT_406 = " WHERE ";
  protected final String TEXT_407 = "\";" + NL + "\t    ";
  protected final String TEXT_408 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_409 = " = new StringBuffer(update_";
  protected final String TEXT_410 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_411 = ".insert(update_";
  protected final String TEXT_412 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_413 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_414 = " =updateStringBuffer_";
  protected final String TEXT_415 = ".toString(); ";
  protected final String TEXT_416 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_417 = " = conn_";
  protected final String TEXT_418 = ".prepareStatement(update_";
  ...
  protected final String TEXT_425 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_426 = " = new StringBuffer(update_";
  protected final String TEXT_427 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_428 = ".insert(update_";
  protected final String TEXT_429 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_430 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_431 = " =updateStringBuffer_";
  protected final String TEXT_432 = ".toString(); ";
  protected final String TEXT_433 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_434 = " = conn_";
  protected final String TEXT_435 = ".prepareStatement(update_";
  ...
  protected final String TEXT_441 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_442 = " = new StringBuffer(insert_";
  protected final String TEXT_443 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_444 = ".insert(insert_";
  protected final String TEXT_445 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_446 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_447 = " =insertStringBuffer_";
  ...
  protected final String TEXT_453 = NL + "\t    String delete_";
  protected final String TEXT_454 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_455 = " + \" WHERE ";
  protected final String TEXT_456 = "\";" + NL + "\t    ";
  protected final String TEXT_457 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_458 = " = new StringBuffer(delete_";
  protected final String TEXT_459 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_460 = ".insert(delete_";
  protected final String TEXT_461 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_462 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_463 = " =deleteStringBuffer_";
  protected final String TEXT_464 = ".toString();  ";
  protected final String TEXT_465 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_466 = " = conn_";
  protected final String TEXT_467 = ".prepareStatement(delete_";
  protected final String TEXT_468 = ");" + NL + "\t    ";
  protected final String TEXT_469 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_474 = NL + "\t\t\tupdate_";
  protected final String TEXT_475 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_476 = " = update_";
  protected final String TEXT_477 = ".split(\"\\\\?\");";
  protected final String TEXT_478 = NL + "\t\t\tupdate_";
  protected final String TEXT_479 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_480 = " = update_";
  protected final String TEXT_481 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_482 = " = insert_";
  protected final String TEXT_483 = ".split(\"\\\\?\");";
  protected final String TEXT_484 = NL + "\t\t\tdelete_";
  protected final String TEXT_485 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_486 = " = delete_";
  protected final String TEXT_487 = ".split(\"\\\\?\");";
  protected final String TEXT_488 = NL + "\t\t\treplace_";
  protected final String TEXT_489 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_490 = " = replace_";
  protected final String TEXT_491 = ".split(\"\\\\?\");";
  protected final String TEXT_492 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_493 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_494 = " = insertIgnore_";
  protected final String TEXT_495 = ".split(\"\\\\?\");";
  protected final String TEXT_496 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_497 = " = insert_";
  protected final String TEXT_498 = ".split(\"\\\\?\");";
  protected final String TEXT_499 = NL + "\t   ";
  protected final String TEXT_500 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_501 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_502 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_503 = " = true;" + NL + "    \t";
  protected final String TEXT_504 = NL + "\tclass XMLTypeUtil_";
  protected final String TEXT_505 = " {" + NL + "\t\tpublic oracle.sql.CLOB getCLOB(String xmlData, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t  oracle.sql.CLOB tempClob = null;" + NL + "\t\t  try{" + NL + "\t\t    // If the temporary CLOB has not yet been created, create one" + NL + "\t\t    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION); " + NL + "\t\t " + NL + "\t\t    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t    tempClob.open(oracle.sql.CLOB.MODE_READWRITE); " + NL + "\t\t    // Get the output stream to write" + NL + "\t\t    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream(); " + NL + "\t\t    // Write the data into the temporary CLOB" + NL + "\t\t    tempClobWriter.write(xmlData); " + NL + "\t\t " + NL + "\t\t    // Flush and close the stream" + NL + "\t\t    tempClobWriter.flush();" + NL + "\t\t    tempClobWriter.close(); " + NL + "\t\t " + NL + "\t\t    // Close the temporary CLOB " + NL + "\t\t    tempClob.close();    " + NL + "\t\t  } catch( java.sql.SQLException sqlexp){" + NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    sqlexp.printStackTrace();" + NL + "\t\t  } catch(java.lang.Exception exp){" + NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    exp.printStackTrace();" + NL + "\t\t  }" + NL + "\t\t  return tempClob; " + NL + "\t\t}" + NL + "\t}" + NL + "\tXMLTypeUtil_";
  protected final String TEXT_506 = " xmlTypeUtil_";
  protected final String TEXT_507 = " = null;" + NL + "\txmlTypeUtil_";
  protected final String TEXT_508 = " = new XMLTypeUtil_";
  protected final String TEXT_509 = "();";
  protected final String TEXT_510 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_511 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_512 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_513 = " =null;";
  protected final String TEXT_514 = NL + NL + NL + NL;
