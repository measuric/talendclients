...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_102 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_103 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_104 = " = tableNameForSearch_";
  protected final String TEXT_105 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_106 = " = tableNameForSearch_";
  protected final String TEXT_107 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_108 = " = dbMetaData_";
  protected final String TEXT_109 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_110 = ", tableNameForSearch_";
  protected final String TEXT_111 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_112 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_113 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_114 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_126 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_127 = ".equalsIgnoreCase(";
  protected final String TEXT_128 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_129 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_130 = ") || dbschema_";
  protected final String TEXT_131 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_132 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_136 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_137 = " = dbMetaData_";
  protected final String TEXT_138 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_139 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_140 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_141 = " = rsTable_";
  protected final String TEXT_142 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_147 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_153 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_157 = NL + "                if(whetherExist_";
  protected final String TEXT_158 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_161 = ".execute(\"";
  protected final String TEXT_162 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_163 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_191 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_192 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_193 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_194 = NL + "\t";
  protected final String TEXT_195 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_198 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_201 = ".execute(xpxSQL_";
  protected final String TEXT_202 = ");" + NL + "    stmtXPX_";
  protected final String TEXT_203 = ".close();    ";
  protected final String TEXT_204 = NL + "    stmtBulk_";
  protected final String TEXT_205 = ".execute(bulkSQL_";
  protected final String TEXT_206 = ");" + NL + "    stmtBulk_";
