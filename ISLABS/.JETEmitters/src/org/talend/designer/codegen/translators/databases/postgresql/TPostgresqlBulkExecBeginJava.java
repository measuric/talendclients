...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_28 = " += \"NULL AS '\" + ";
  protected final String TEXT_29 = " + \"' \";" + NL + "\t";
  protected final String TEXT_30 = NL + "\t\tbulkSQL_";
  protected final String TEXT_31 = " += \"NULL AS '\" + ";
  protected final String TEXT_32 = ".replaceAll(\"\\\\\\\\\",\"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t";
  protected final String TEXT_33 = NL + "       \t\tif(\"\\\\\".equals(";
  protected final String TEXT_34 = ")){" + NL + "            \tbulkSQL_";
  protected final String TEXT_35 = " += \"CSV ";
  protected final String TEXT_36 = " QUOTE AS '\" + ";
  protected final String TEXT_37 = "+ \"' \";" + NL + "\t        }else{" + NL + "\t\t        bulkSQL_";
  protected final String TEXT_38 = " += \"CSV ";
  protected final String TEXT_39 = " QUOTE AS \" + (\"'\".equals(";
  protected final String TEXT_40 = ")?\"E\":\"\") + \"'\" +(\"'\".equals(";
  protected final String TEXT_41 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_42 = "+ \"' \";" + NL + "\t\t\t}" + NL + "\t\t\tif(\"\\\\\".equals(";
  protected final String TEXT_43 = ")){" + NL + "\t\t\t\tbulkSQL_";
  protected final String TEXT_44 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_45 = " + \"' \";" + NL + "\t\t\t}else{" + NL + "\t        \tbulkSQL_";
  protected final String TEXT_46 = " += \"ESCAPE AS \" + (\"'\".equals(";
  protected final String TEXT_47 = ")?\"E\":\"\")  + \"'\" +(\"'\".equals(";
  protected final String TEXT_48 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_49 = " + \"' \"; " + NL + "\t\t    }";
  protected final String TEXT_50 = NL + "       \t\tif(\"\\\\\".equals(";
  protected final String TEXT_51 = ")){" + NL + "       \t\t\tbulkSQL_";
  protected final String TEXT_52 = " += \"CSV ";
  protected final String TEXT_53 = " QUOTE AS '\" +  ";
  protected final String TEXT_54 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "       \t\t}else{" + NL + "\t\t        bulkSQL_";
  protected final String TEXT_55 = " += \"CSV ";
  protected final String TEXT_56 = " QUOTE AS '\" + (\"'\".equals(";
  protected final String TEXT_57 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_58 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "       \t\t}" + NL + "\t\t\tif(\"\\\\\".equals(";
  protected final String TEXT_59 = ")){" + NL + "\t\t        bulkSQL_";
  protected final String TEXT_60 = " += \"ESCAPE AS '\"+ ";
  protected final String TEXT_61 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t\t}else{" + NL + "\t\t        bulkSQL_";
  protected final String TEXT_62 = " += \"ESCAPE AS '\"+ (\"'\".equals(";
  protected final String TEXT_63 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_64 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t\t}";
  protected final String TEXT_65 = "        " + NL + "        bulkSQL_";
  ...
  protected final String TEXT_73 = NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t\tconn_";
  protected final String TEXT_74 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_82 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_83 = " = conn_";
  protected final String TEXT_84 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_85 = ".execute(\"";
  protected final String TEXT_86 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_87 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_103 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_104 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_105 = " = tableNameForSearch_";
  protected final String TEXT_106 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_107 = " = tableNameForSearch_";
  protected final String TEXT_108 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_109 = " = dbMetaData_";
  protected final String TEXT_110 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_111 = ", tableNameForSearch_";
  protected final String TEXT_112 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_113 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_114 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_115 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_125 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_126 = " = rsTable_";
  protected final String TEXT_127 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_128 = ".equalsIgnoreCase(";
  protected final String TEXT_129 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_130 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_145 = "IgnoreCase";
  protected final String TEXT_146 = "(";
  protected final String TEXT_147 = ")) {" + NL + "                    whetherExist_";
  ...
  protected final String TEXT_154 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_161 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_162 = ".execute(\"";
  protected final String TEXT_163 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_164 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_192 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_193 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_194 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_195 = NL + "\t";
  protected final String TEXT_196 = NL + "        int keyCount_";
  protected final String TEXT_197 = " = ";
  protected final String TEXT_198 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_199 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        String tmpTableName_";
  protected final String TEXT_200 = " = tableName_";
  protected final String TEXT_201 = ";" + NL + "        tableName_";
  protected final String TEXT_202 = " = \"tmp_";
  protected final String TEXT_203 = "\" + \"_\" + pid ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_206 = ".execute(\"";
  protected final String TEXT_207 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_208 = ".close();" + NL + "        " + NL + "        ";
  protected final String TEXT_209 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_210 = " =conn_";
  protected final String TEXT_211 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_212 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_213 = ".close();" + NL + "   \t\t";
  protected final String TEXT_214 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_217 = ".execute(bulkSQL_";
  protected final String TEXT_218 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_219 = ".close();" + NL + "        " + NL + "        tableName_";
  protected final String TEXT_220 = " = tmpTableName_";
  protected final String TEXT_221 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_222 = " = \"tmp_";
  protected final String TEXT_223 = "\" + \"_\" + pid;" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".createStatement();" + NL + "        " + NL + "        stmtUpdateBulk_";
  protected final String TEXT_226 = ".executeUpdate(\"";
  protected final String TEXT_227 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_228 = ".close();" + NL + "        tableName_";
  protected final String TEXT_229 = " = tmpTableName_";
  protected final String TEXT_230 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_233 = ".execute(\"";
  protected final String TEXT_234 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_235 = ".close();";
  protected final String TEXT_236 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_237 = " =conn_";
  protected final String TEXT_238 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_239 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_240 = ".close();";
  protected final String TEXT_241 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_244 = ".execute(bulkSQL_";
  protected final String TEXT_245 = ");" + NL + "    stmtBulk_";
