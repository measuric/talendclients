...
public class Subprocess_footerJava
{
  ...
  protected final String TEXT_20 = NL + NL + "\t" + NL + "\t} catch(java.lang.Exception e) {\t" + NL + "" + NL + "\t\tthrow new TalendException(e, currentComponent, globalMap);" + NL + "\t" + NL + "\t} catch(java.lang.Error error) {" + NL + "\t";
  protected final String TEXT_21 = NL + "\t\trunStat.stopThreadStat();";
  protected final String TEXT_22 = NL + "\t\tthrow error;" + NL + "" + NL + "\t}";
  protected final String TEXT_23 = NL + "\t\t\t\t";
  protected final String TEXT_24 = " finally{ ";
  protected final String TEXT_25 = NL + "\t\t\t\t//free memory for \"";
  protected final String TEXT_26 = "\"" + NL + "\t\t\t\tglobalMap.remove(\"";
  protected final String TEXT_27 = "\");" + NL + "\t";
  protected final String TEXT_28 = NL + "     \t\t\t";
  protected final String TEXT_29 = " finally{ ";
  protected final String TEXT_30 = NL + "     \t\t\t//free memory for \"";
  protected final String TEXT_31 = "\"" + NL + "     \t\t\tglobalMap.remove(\"tHash_Lookup_";
  protected final String TEXT_32 = "\"); ";
  protected final String TEXT_33 = "      \t" + NL + "      \t\t\t";
  protected final String TEXT_34 = " finally{ ";
  protected final String TEXT_35 = NL + "      \t\t\t//free memory for \"";
  protected final String TEXT_36 = "\"" + NL + "\t\t\t\tglobalMap.remove(\"tHash_";
