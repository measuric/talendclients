...
public class TRedshiftOutputEndJava {
  ...
  protected final String TEXT_92 = " ; i++){" + NL + "\t             extendInsertValueStmt.append(\"(";
  ...
  protected final String TEXT_97 = ") VALUES \"+extendInsertValueStmt.toString();" + NL + "\t\t\tpstmt_";
  protected final String TEXT_98 = " = conn_";
  protected final String TEXT_99 = ".prepareStatement(insert_";
  protected final String TEXT_100 = ");" + NL + "\t        " + NL + "\t        int row2Count";
  protected final String TEXT_101 = " = 0;" + NL + "\t\t\tint count";
  protected final String TEXT_102 = " = 0;" + NL + "        " + NL + "\t        for(BufferLine_";
  protected final String TEXT_103 = " bufferL";
  protected final String TEXT_104 = " : exInsertColValueList";
  protected final String TEXT_105 = "){            " + NL + "\t\t\t\tcount";
  protected final String TEXT_106 = " = row2Count";
  protected final String TEXT_107 = "*";
  protected final String TEXT_108 = "+1;         \t          " + NL + "\t";
  protected final String TEXT_109 = NL + "\t                    count";
  protected final String TEXT_110 = "++;" + NL + "\t                    ";
  protected final String TEXT_111 = NL + "\t    " + NL + "\t            row2Count";
  protected final String TEXT_112 = "++;" + NL + "\t        }        " + NL + "\t        insertedCount_";
  protected final String TEXT_113 = " = insertedCount_";
  protected final String TEXT_114 = " + pstmt_";
  protected final String TEXT_115 = ".executeUpdate();" + NL + "\t    }" + NL + "\t";
  protected final String TEXT_116 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_117 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_118 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_119 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_120 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_121 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_122 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_123 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_124 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_125 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_126 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_127 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_128 = NL + "        if(pstmt_";
  protected final String TEXT_129 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_130 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_131 = NL;
  protected final String TEXT_132 = NL + "\t\t\tconn_";
  protected final String TEXT_133 = ".commit();";
  protected final String TEXT_134 = "\t" + NL + "    \tconn_";
  protected final String TEXT_135 = " .close();" + NL + "    \t";
  protected final String TEXT_136 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_137 = "=nb_line_deleted_";
  protected final String TEXT_138 = "+ deletedCount_";
  protected final String TEXT_139 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_140 = "=nb_line_update_";
  protected final String TEXT_141 = " + updatedCount_";
  protected final String TEXT_142 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_143 = "=nb_line_inserted_";
  protected final String TEXT_144 = " + insertedCount_";
  protected final String TEXT_145 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_146 = "=nb_line_rejected_";
  protected final String TEXT_147 = " + rejectedCount_";
  ...
  protected final String TEXT_153 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_154 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_155 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_156 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_157 = "_NB_LINE_REJECTED\",nb_line_rejected_";
