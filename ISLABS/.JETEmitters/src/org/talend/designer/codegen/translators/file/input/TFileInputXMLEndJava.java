...
public class TFileInputXMLEndJava
{
  ...
  protected final String TEXT_5 = ".handleTaskResponse();" + NL + "\t} catch(java.lang.Exception e) {" + NL + "\t\tif(!(e.getCause() instanceof org.talend.xml.sax.exception.EnoughDataException))" + NL + "\t";
