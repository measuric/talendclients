...
public class TPivotToColumnsDelimitedBeginJava {
  ...
  protected final String TEXT_46 = NL + "    " + NL + "    com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_47 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "            new java.io.FileOutputStream(fileName_";
  protected final String TEXT_48 = ", false), ";
  protected final String TEXT_49 = ")));" + NL + "    CsvWriter";
  protected final String TEXT_50 = ".setSeparator('";
  protected final String TEXT_51 = "');  " + NL + "    ";
  protected final String TEXT_52 = NL + "    CsvWriter";
  protected final String TEXT_53 = ".setLineEnd(\"";
  protected final String TEXT_54 = "\");";
  protected final String TEXT_55 = NL + "    CsvWriter";
  protected final String TEXT_56 = ".setQuoteChar('";
  protected final String TEXT_57 = "');                " + NL;
  protected final String TEXT_58 = NL + "    CsvWriter";
  protected final String TEXT_59 = ".setEscapeChar('\\\\');";
  protected final String TEXT_60 = NL + "    CsvWriter";
  protected final String TEXT_61 = ".setEscapeChar('";
  protected final String TEXT_62 = "');";
  protected final String TEXT_63 = NL + "\tCsvWriter";
  protected final String TEXT_64 = ".setEscapeChar('";
  protected final String TEXT_65 = "');";
  protected final String TEXT_66 = "    " + NL + "\tCsvWriter";
  protected final String TEXT_67 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);   " + NL + NL;
  protected final String TEXT_68 = NL + NL + NL + "java.io.File file";
  protected final String TEXT_69 = " = new java.io.File(fileName_";
  protected final String TEXT_70 = ");" + NL + "" + NL + "boolean pivot_Exists";
  protected final String TEXT_71 = " = false;" + NL + "" + NL + "StringBuilder pivot_Key";
  protected final String TEXT_72 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<String> pivot_Keys";
  protected final String TEXT_73 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "boolean group_Exists";
  protected final String TEXT_74 = " = false;" + NL + "" + NL + "StringBuilder group_Key";
  protected final String TEXT_75 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<java.util.List<String>> group_Keys";
  protected final String TEXT_76 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "" + NL + "java.util.List<String> gKvalue";
  protected final String TEXT_77 = " = null;" + NL + "" + NL + "java.util.List<String> aggValues";
  protected final String TEXT_78 = " = null;" + NL + "" + NL + "java.util.Map<java.util.List<String>,java.util.List<String>> aggregation";
  protected final String TEXT_79 = " = new java.util.HashMap<java.util.List<String>,java.util.List<String>>();" + NL;
