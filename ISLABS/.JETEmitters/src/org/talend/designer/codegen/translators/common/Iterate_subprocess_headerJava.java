...
public class Iterate_subprocess_headerJava
{
  ...
  protected final String TEXT_2 = "++;" + NL + "\titerateLoop++;";
  ...
  protected final String TEXT_12 = NL + "\t\tprivate java.util.Map<String, Object> globalMap = null;" + NL + "\t\tboolean isRunning = false;" + NL + "\t\tString iterateId = \"\";" + NL + "\t\tint iterateLoop = 0;";
  ...
  protected final String TEXT_31 = NL + "\t\t\t\t}" + NL + "\t\t\titerateId = \".\" + threadID;" + NL + "\t\t\titerateLoop++;" + NL + "\t";
  ...
  protected final String TEXT_42 = "\", 3, 0);" + NL + "}           \t\t\t";
  protected final String TEXT_43 = "        \t\t" + NL + "if(execStat){" + NL + "\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_44 = "\", 1, \"exec\" + NB_ITERATE_";
  protected final String TEXT_45 = ");" + NL + "\t\t\t\t//Thread.sleep(1000);" + NL + "}\t\t\t\t";
