...
public class HeaderJava
{
  ...
  protected final String TEXT_25 = NL + "\tprivate ESBEndpointRegistry registry = null;" + NL + "" + NL + "\tpublic void setEndpointRegistry(ESBEndpointRegistry registry) {" + NL + "\t\tthis.registry = registry;" + NL + "\t}" + NL + "" + NL + "\tprivate ESBProviderCallback callback = null;" + NL + "" + NL + "\tpublic void setProviderCallback(ESBProviderCallback callback) {" + NL + "\t\t";
  protected final String TEXT_26 = NL + "\t\t\tthis.callback = callback;" + NL + "\t\t";
  protected final String TEXT_27 = NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_28 = NL + "\t\tpublic ESBEndpointInfo getEndpoint() { return null; }" + NL + "\t";
  protected final String TEXT_29 = NL;
  protected final String TEXT_30 = NL + "\tpublic TalendESBJob newTalendESBJob() {" + NL + "\t\t";
  protected final String TEXT_31 = " talendESBJob = new ";
  protected final String TEXT_32 = "();" + NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> talendDataSources =" + NL + "\t\t\t(java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != talendDataSources) {" + NL + "\t\t\tjava.util.Map<String, javax.sql.DataSource> dataSources = new java.util.HashMap<String, javax.sql.DataSource>();" + NL + "\t\t\tfor (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry : talendDataSources.entrySet()) {" + NL + "\t\t\t\tdataSources.put(talendDataSourceEntry.getKey(), talendDataSourceEntry.getValue().getRawDataSource());" + NL + "\t\t\t}" + NL + "\t\t\ttalendESBJob.setDataSources(dataSources);" + NL + "\t\t}" + NL + "\t\t// fix for TESB-7714" + NL + "\t\ttalendESBJob.setEndpointRegistry(registry);" + NL + "\t\treturn talendESBJob;" + NL + "\t}";
  protected final String TEXT_33 = NL + NL + "\tpublic final Object obj = new Object();" + NL + "" + NL + "\t// for transmiting parameters purpose" + NL + "\tprivate Object valueObject = null;" + NL + "" + NL + "\tpublic Object getValueObject() {" + NL + "\t\treturn this.valueObject;" + NL + "\t}" + NL + "" + NL + "\tpublic void setValueObject(Object valueObject) {" + NL + "\t\tthis.valueObject = valueObject;" + NL + "\t}";
  protected final String TEXT_34 = NL + "\tprivate Object[] multiThreadLockWrite = new Object[0];";
  protected final String TEXT_35 = NL + "\t";
  protected final String TEXT_36 = NL + "\tprivate final static String defaultCharset = java.nio.charset.Charset.defaultCharset().name();" + NL + "" + NL + "\t";
  protected final String TEXT_37 = NL + "\tprivate final static String utf8Charset = \"UTF-8\";" + NL + "" + NL + "\t// create and load default properties" + NL + "\tprivate java.util.Properties defaultProps = new java.util.Properties();" + NL + "\t// create application properties with default" + NL + "\tpublic class ContextProperties extends java.util.Properties {" + NL + "" + NL + "\t\tprivate static final long serialVersionUID = 1L;" + NL + "" + NL + "\t\tpublic ContextProperties(java.util.Properties properties){" + NL + "\t\t\tsuper(properties);" + NL + "\t\t}" + NL + "\t\tpublic ContextProperties(){" + NL + "\t\t\tsuper();" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void synchronizeContext(){" + NL + "\t\t\t";
  protected final String TEXT_38 = NL + "\t\t\tif(";
  protected final String TEXT_39 = " != null){" + NL + "\t\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\t\t\tString pattern_";
  protected final String TEXT_41 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "\t\t\t\t\tString value_";
  protected final String TEXT_42 = " = \"";
  protected final String TEXT_43 = "\";" + NL + "\t\t\t\t\tString[] parts_";
  protected final String TEXT_44 = " = value_";
  protected final String TEXT_45 = ".split(\";\");" + NL + "\t\t\t\t\tif(parts_";
  protected final String TEXT_46 = ".length > 1){" + NL + "\t\t\t\t\t\tpattern_";
  protected final String TEXT_47 = " = parts_";
  protected final String TEXT_48 = "[0];" + NL + "\t\t\t\t\t\tthis.setProperty(\"";
  protected final String TEXT_49 = "\", pattern_";
  protected final String TEXT_50 = " + \";\" + FormatterUtils.format_Date(";
  protected final String TEXT_51 = ", pattern_";
  protected final String TEXT_52 = "));" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tthis.setProperty(\"";
  protected final String TEXT_53 = "\", FormatterUtils.format_Date(";
  protected final String TEXT_54 = ", pattern_";
  protected final String TEXT_55 = "));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\t\tthis.setProperty(\"";
  protected final String TEXT_57 = "\", ";
  protected final String TEXT_58 = ".toString());" + NL + "\t\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_60 = NL + "\t\t}" + NL;
  protected final String TEXT_61 = NL + "\t\tpublic String ";
  protected final String TEXT_62 = ";" + NL + "\t\tpublic String get";
  ...
  protected final String TEXT_67 = ";" + NL + "public ";
  protected final String TEXT_68 = " get";
  protected final String TEXT_69 = "(){" + NL + "\treturn this.";
  protected final String TEXT_70 = ";" + NL + "}";
  protected final String TEXT_71 = NL + "\t}" + NL + "\tprivate ContextProperties context = new ContextProperties();" + NL + "\tpublic ContextProperties getContext() {" + NL + "\t\treturn this.context;" + NL + "\t}" + NL + "\tprivate final String jobVersion = \"";
  protected final String TEXT_72 = "\";" + NL + "\tprivate final String jobName = \"";
  protected final String TEXT_73 = "\";" + NL + "\tprivate final String projectName = \"";
  protected final String TEXT_74 = "\";" + NL + "\tpublic Integer errorCode = null;" + NL + "\tprivate String currentComponent = \"\";";
  ...
  protected final String TEXT_76 = NL + "\tprivate final java.util.Map<String, Long> start_Hash = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Long>());" + NL + "\tprivate final java.util.Map<String, Long> end_Hash = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Long>());" + NL + "\tprivate final java.util.Map<String, Boolean> ok_Hash = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Boolean>());" + NL + "\tprivate final java.util.Map<String, Object> globalMap = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Object>());" + NL + "\tpublic  final java.util.List<String[]> globalBuffer = java.util.Collections.synchronizedList(new java.util.ArrayList<String[]>());";
  protected final String TEXT_77 = NL;
  protected final String TEXT_78 = NL + "private RunStat runStat = new RunStat();";
  protected final String TEXT_79 = NL + "private RunTrace runTrace = new RunTrace();";
  protected final String TEXT_80 = NL + NL + "public boolean isExportedAsOSGI = ";
  protected final String TEXT_81 = ";" + NL + "" + NL + "\t// OSGi DataSource" + NL + "\tprivate final static String KEY_DB_DATASOURCES = \"KEY_DB_DATASOURCES\";" + NL + "" + NL + "\tpublic void setDataSources(java.util.Map<String, javax.sql.DataSource> dataSources) {" + NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> talendDataSources = new java.util.HashMap<String, routines.system.TalendDataSource>();" + NL + "\t\tfor (java.util.Map.Entry<String, javax.sql.DataSource> dataSourceEntry : dataSources.entrySet()) {" + NL + "\t\t\ttalendDataSources.put(dataSourceEntry.getKey(), new routines.system.TalendDataSource(dataSourceEntry.getValue()));" + NL + "\t\t}" + NL + "\t\tglobalMap.put(KEY_DB_DATASOURCES, talendDataSources);" + NL + "\t}" + NL;
  protected final String TEXT_82 = NL + "\tLogCatcherUtils ";
  protected final String TEXT_83 = " = new LogCatcherUtils();";
  protected final String TEXT_84 = NL + "\tStatCatcherUtils ";
  protected final String TEXT_85 = " = new StatCatcherUtils(\"";
  protected final String TEXT_86 = "\", \"";
  protected final String TEXT_87 = "\");";
  protected final String TEXT_88 = NL + "\tMetterCatcherUtils ";
  protected final String TEXT_89 = " = new MetterCatcherUtils(\"";
  protected final String TEXT_90 = "\", \"";
  protected final String TEXT_91 = "\");";
  protected final String TEXT_92 = NL + "\tAssertCatcherUtils ";
  protected final String TEXT_93 = " = new AssertCatcherUtils();";
  protected final String TEXT_94 = NL + NL + "private final java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();" + NL + "private final java.io.PrintStream errorMessagePS = new java.io.PrintStream(new java.io.BufferedOutputStream(baos));" + NL + "" + NL + "public String getExceptionStackTrace() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\terrorMessagePS.flush();" + NL + "\t\treturn baos.toString();" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private java.lang.Exception exception = null;" + NL + "" + NL + "public java.lang.Exception getException() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\treturn this.exception;" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private class TalendException extends java.lang.Exception {" + NL + "" + NL + "\tprivate static final long serialVersionUID = 1L;" + NL + "" + NL + "\tprivate java.util.Map<String, Object> globalMap = null;" + NL + "\tprivate java.lang.Exception e = null;" + NL + "\tprivate String currentComponent = null;" + NL + "" + NL + "\tprivate TalendException(java.lang.Exception e, String errorComponent, final java.util.Map<String, Object> globalMap) {" + NL + "\t\tthis.currentComponent= errorComponent;" + NL + "\t\tthis.globalMap = globalMap;" + NL + "\t\tthis.e = e;" + NL + "\t}" + NL + "" + NL + "\tpublic java.lang.Exception getException() {" + NL + "\t\treturn this.e;" + NL + "\t}" + NL + "" + NL + "\tpublic String getCurrentComponent() {" + NL + "\t\treturn this.currentComponent;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void printStackTrace() {" + NL + "\t\tif (!(e instanceof TalendException || e instanceof TDieException)) {" + NL + "\t\t\t globalMap.put(currentComponent+\"_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\t\tSystem.err.println(\"Exception in component \" + currentComponent);" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TDieException)) {" + NL + "\t\t\tif(e instanceof TalendException){" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t} else {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\te.printStackTrace(errorMessagePS);" + NL + "\t\t\t\t";
  protected final String TEXT_95 = ".this.exception = e;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TalendException)) {" + NL + "\t\ttry {" + NL + "\t\t\tfor (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {" + NL + "\t\t\t\tif (m.getName().compareTo(currentComponent + \"_error\") == 0) {" + NL + "\t\t\t\t\tm.invoke(";
  protected final String TEXT_96 = ".this, new Object[] { e , currentComponent, globalMap});" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tif(!(e instanceof TDieException)){";
  protected final String TEXT_97 = NL + "\t\t\t\t";
  protected final String TEXT_98 = ".addMessage(\"Java Exception\", currentComponent, 6, e.getClass().getName() + \":\" + e.getMessage(), 1);";
  protected final String TEXT_99 = NL + "\t\t\ttry{";
  protected final String TEXT_100 = NL + "\t\t\t\t";
  protected final String TEXT_101 = "Process(globalMap);";
  protected final String TEXT_102 = NL + "\t\t\t}finally{";
  protected final String TEXT_103 = NL + "\t\t\t\t";
  protected final String TEXT_104 = "Process(globalMap);";
  protected final String TEXT_105 = NL + "\t\t\t}";
  protected final String TEXT_106 = NL + "\t\t\t}" + NL + "\t\t} catch (java.lang.SecurityException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.IllegalArgumentException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.IllegalAccessException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.reflect.InvocationTargetException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t}";
  protected final String TEXT_107 = NL + "\t\t\t\tcatch (TalendException e) {" + NL + "\t\t\t\t\t// do nothing" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_108 = NL + "\t\t}" + NL + "\t}" + NL + "}" + NL;
  protected final String TEXT_109 = NL + "\t\t\tpublic void ";
  protected final String TEXT_110 = "_error(java.lang.Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {" + NL + "\t\t\t\tend_Hash.put(\"";
  protected final String TEXT_111 = "\", System.currentTimeMillis());" + NL + "\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\t\t\t\tif(!(exception instanceof TDieException)){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_113 = ".addMessage(pid, projectName, jobName, \"java\", null, \"Failed\", \"Job execution error\", exception.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_114 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_116 = ".addMessage(\"failure\",\"";
  protected final String TEXT_117 = "\", end_Hash.get(\"";
  protected final String TEXT_118 = "\")-start_Hash.get(\"";
  protected final String TEXT_119 = "\"));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_120 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\t\t\t\tif(this.execStat){" + NL + "\t\t\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_123 = "\", 0, \"error\");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_126 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\tif ( !\"failure\".equals(((java.util.Map)threadLocal.get()).get(\"status\")) ) {" + NL + "\t\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"end\");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_128 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\tif (!\"failure\".equals(status)) {" + NL + "\t\t\t\t\t\t\t\t\tstatus = \"end\";" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_129 = NL + NL + "\t\t\t\t\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"failure\");" + NL + "\t\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\tstatus = \"failure\";" + NL + "\t\t\t\t";
  protected final String TEXT_132 = NL + "\t\t\t\t\t";
  protected final String TEXT_133 = "_onSubJobError(exception, errorComponent, globalMap);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\tpublic void ";
  protected final String TEXT_135 = "_onSubJobError(java.lang.Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {";
  protected final String TEXT_136 = NL + NL + "resumeUtil.addLog(\"SYSTEM_LOG\", \"NODE:\"+ errorComponent, \"\", Thread.currentThread().getId()+ \"\", \"";
  protected final String TEXT_137 = "\", \"\", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),\"\");" + NL;
  protected final String TEXT_138 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\t\tif(this.execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_140 = "\", 0, \"error\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t";
  protected final String TEXT_142 = "Process(globalMap);" + NL + "\t\t\t\t\tif ( !\"failure\".equals(((java.util.Map)threadLocal.get()).get(\"status\")) ) {" + NL + "\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"end\");" + NL + "\t\t\t\t\t}";
  protected final String TEXT_143 = NL + "\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_144 = "Process(globalMap);" + NL + "\t\t\t\t\tif (!\"failure\".equals(status)) {" + NL + "\t\t\t\t\t\tstatus = \"end\";" + NL + "\t\t\t\t\t}";
  protected final String TEXT_145 = NL + "\t\t\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t}";
