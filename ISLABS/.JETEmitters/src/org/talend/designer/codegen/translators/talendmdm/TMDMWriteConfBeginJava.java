...
public class TMDMWriteConfBeginJava
{
  ...
  protected final String TEXT_46 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_47 = " = new java.util.concurrent.ConcurrentLinkedQueue<String>();" + NL + "\t";
  protected final String TEXT_48 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_49 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<java.util.Map<String,String>>());" + NL + "\t\tint flowNum_";
  protected final String TEXT_50 = " = 0;" + NL + "\t";
  protected final String TEXT_51 = NL + "\tclass ThreadXMLField_";
  protected final String TEXT_52 = " extends Thread {" + NL + "\t\tjava.util.Queue<String> queue;" + NL + "\t\tjava.util.List<java.util.Map<String,String>> flows;" + NL + "\t\tjava.lang.Exception lastException;" + NL + "\t\tString currentComponent;" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_53 = "(java.util.Queue q) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_54 = "\", queue);" + NL + "\t\t\tlastException = null;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_55 = "(java.util.Queue q, java.util.List<java.util.Map<String,String>> l) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tthis.flows = l;" + NL + "\t\t\tlastException = null;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_56 = "\", queue);" + NL + "\t\t\tglobalMap.put(\"flows_";
  protected final String TEXT_57 = "\", flows);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic java.lang.Exception getLastException() {" + NL + "\t\t\treturn this.lastException;" + NL + "\t\t}" + NL + "\t\tpublic String getCurrentComponent() {" + NL + "\t\t\treturn this.currentComponent;" + NL + "\t\t}" + NL + "\t" + NL + "\t\t@Override" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_58 = "Process(globalMap);" + NL + "\t\t\t} catch (TalendException te) {" + NL + "\t\t\t\tthis.lastException = te.getException();" + NL + "\t\t\t\tthis.currentComponent = te.getCurrentComponent();" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_59 = "_FINISH\", \"true\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_60 = NL + "\t\tThreadXMLField_";
  protected final String TEXT_61 = " txf_";
  protected final String TEXT_62 = " = new ThreadXMLField_";
  protected final String TEXT_63 = "(queue_";
  protected final String TEXT_64 = ", xmlFlowList_";
  protected final String TEXT_65 = ");" + NL + "\t";
  protected final String TEXT_66 = NL + "\t\tThreadXMLField_";
  protected final String TEXT_67 = " txf_";
  protected final String TEXT_68 = " = new ThreadXMLField_";
  protected final String TEXT_69 = "(queue_";
  protected final String TEXT_70 = ");" + NL + "\t";
  protected final String TEXT_71 = NL + "\ttxf_";
  protected final String TEXT_72 = ".start();";
  protected final String TEXT_73 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_74 = " = (java.util.List<java.util.Map<String,String>>)globalMap.get(\"flows_";
  protected final String TEXT_75 = "\");" + NL + "\t\tint flowNum_";
  protected final String TEXT_76 = " = 0;" + NL + "\t";
  protected final String TEXT_77 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_78 = " = (java.util.Queue<String>) globalMap.get(\"queue_";
  protected final String TEXT_79 = "\"); ";
  protected final String TEXT_80 = NL + "\twhile(true) {" + NL + "\t\tif (!queue_";
