...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_31 = "++;" + NL + "\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\twhetherReject_";
  ...
  protected final String TEXT_126 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_155 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_198 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_230 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_263 = ".addBatch();" + NL + "    \t\t";
  protected final String TEXT_264 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_265 = "++;" + NL + "    \t\t";
  protected final String TEXT_266 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_267 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_268 = " = deletedCount_";
  protected final String TEXT_269 = " + pstmt_";
  protected final String TEXT_270 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_281 = NL + "                        rejectedCount_";
  protected final String TEXT_282 = " = rejectedCount_";
  protected final String TEXT_283 = " + 1;";
  protected final String TEXT_284 = NL + "                        ";
  protected final String TEXT_285 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_291 = NL + "\t\t\t\t    " + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_292 = NL + "               \t\t    stmtBuilder_";
  protected final String TEXT_293 = ".append(\"|\");" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_294 = ".append(String.valueOf(";
  protected final String TEXT_295 = ".";
  protected final String TEXT_296 = "));" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_297 = ".append(\"|\"); " + NL + "               \t    ";
  protected final String TEXT_298 = NL + "               \t\t    if(";
  protected final String TEXT_299 = ".";
  protected final String TEXT_300 = " == null){" + NL + "               \t\t        stmtBuilder_";
  protected final String TEXT_301 = ".append(\"\");" + NL + "               \t\t    }else{" + NL + "\t\t\t\t\t\t    stmtBuilder_";
  protected final String TEXT_302 = ".append(\"|\");" + NL + "                \t\t\t        ";
  protected final String TEXT_303 = NL + "                \t\t\t            stmtBuilder_";
  protected final String TEXT_304 = ".append(";
  protected final String TEXT_305 = ".";
  protected final String TEXT_306 = ".replaceAll(\"\\\\|\",\"\\\\\\\\|\"));" + NL + "                \t\t\t            ";
  protected final String TEXT_307 = NL + "                \t\t\t            stmtBuilder_";
  protected final String TEXT_308 = ".append(FormatterUtils.format_Date(";
  protected final String TEXT_309 = ".";
  protected final String TEXT_310 = ", ";
  protected final String TEXT_311 = "));" + NL + "                \t\t\t            ";
  protected final String TEXT_312 = NL + "                \t\t\t            stmtBuilder_";
  protected final String TEXT_313 = ".append(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_314 = ".";
  protected final String TEXT_315 = ")).toString());" + NL + "                \t\t\t            ";
  protected final String TEXT_316 = NL + "                \t\t\t\t\t\t\t";
  protected final String TEXT_317 = NL + "                \t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_318 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_319 = "), null, '.'));\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_320 = NL + "\t\t\t\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_321 = ".";
  protected final String TEXT_322 = " != null) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tBigDecimal decimal_";
  protected final String TEXT_323 = " = new BigDecimal(";
  protected final String TEXT_324 = ".";
  protected final String TEXT_325 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_326 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_327 = "), null, '.'));\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "                \t\t\t\t\t\t\t";
  protected final String TEXT_328 = NL + "                \t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_329 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_330 = ".";
  protected final String TEXT_331 = "), null, '.'));\t\t\t\t\t\t" + NL + "                \t\t\t\t\t\t\t";
  protected final String TEXT_332 = NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_333 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_334 = ".append(String.valueOf(";
  protected final String TEXT_335 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_336 = NL + "                \t\t\t            stmtBuilder_";
  protected final String TEXT_337 = ".append(String.valueOf(";
  protected final String TEXT_338 = ".";
  protected final String TEXT_339 = "));" + NL + "                \t\t\t            ";
  protected final String TEXT_340 = NL + "\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_341 = ".append(\"|\");" + NL + "                \t\t\t    }" + NL + "                \t\t\t    ";
  protected final String TEXT_342 = NL + "\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_343 = ".append(\"";
  protected final String TEXT_344 = "\");" + NL + "\t\t\t";
  protected final String TEXT_345 = NL + "\t\t\t";
  protected final String TEXT_346 = NL + "    \t\t" + NL + "    \t\tnb_line_";
  protected final String TEXT_347 = "++;";
  protected final String TEXT_348 = NL + "    \t\t\tbatchSizeCounter_";
  protected final String TEXT_349 = "++;";
  protected final String TEXT_350 = "    \t\t    \t\t";
  protected final String TEXT_351 = NL + "            if(!whetherReject_";
  protected final String TEXT_352 = ") {";
  protected final String TEXT_353 = NL + "                            ";
  protected final String TEXT_354 = " = new ";
  protected final String TEXT_355 = "Struct();";
  ...
  protected final String TEXT_362 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_363 = " <= batchSizeCounter_";
  protected final String TEXT_364 = ") {                ";
  protected final String TEXT_365 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_367 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_368 = NL + "\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_369 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_370 = ".toString().getBytes());" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_371 = NL + "\t\t\t\t\t    com.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_372 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_373 = ",template_";
  protected final String TEXT_374 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_375 = ".start();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_376 = ".addStream(bais_";
  protected final String TEXT_377 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_378 = ".execute();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_379 = ".finish();" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_381 = ").executeCopyIn(template_";
  protected final String TEXT_382 = ", bais_";
  protected final String TEXT_383 = ");" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_384 = NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_385 = " = null;" + NL + "\t\t\t\t\t\tif (bais_";
  protected final String TEXT_386 = " != null) {" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_387 = ".close();" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_388 = " = null;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_389 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_391 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_392 = " += pstmt_";
  protected final String TEXT_393 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_394 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_395 = " += pstmt_";
  protected final String TEXT_396 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_397 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_398 = " += pstmt_";
  protected final String TEXT_399 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_400 = NL + "            \t    \t\t\tcopiedCount_";
  protected final String TEXT_401 = " += vcs_";
  protected final String TEXT_402 = ".getRowCount();" + NL + "            \t    \t";
  protected final String TEXT_403 = NL + "            \t    \t\t\tcopiedCount_";
  protected final String TEXT_404 = " += stmt_";
  protected final String TEXT_405 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_406 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_407 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_408 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_409 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_410 = NL + "                }";
  protected final String TEXT_411 = "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_412 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_413 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_414 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_415 = " += pstmt_";
  protected final String TEXT_416 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_417 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_418 = " += pstmt_";
  protected final String TEXT_419 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_420 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_421 = " += pstmt_";
  protected final String TEXT_422 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_423 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_424 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_425 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_426 = NL + "                }";
  protected final String TEXT_427 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_428 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_429 = " <= commitCounter_";
  protected final String TEXT_430 = ") {" + NL + "                ";
  protected final String TEXT_431 = NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_432 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_433 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_434 = NL + "\t\t\t\t\t\tif (stmtBuilder_";
  protected final String TEXT_435 = " != null && stmtBuilder_";
  protected final String TEXT_436 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_437 = " start" + NL + "\t\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_438 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_439 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_440 = ").executeCopyIn(template_";
  protected final String TEXT_441 = ", bais_";
  protected final String TEXT_442 = ");" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_443 = " = null;" + NL + "\t\t\t\t\t\t\tif (bais_";
  protected final String TEXT_444 = " != null) {" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_445 = ".close();" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_446 = " = null;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_447 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_451 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_452 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_453 = " += pstmt_";
  protected final String TEXT_454 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_455 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_456 = " += pstmt_";
  protected final String TEXT_457 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_458 = NL + "            \t    \t\t\tcopiedCount_";
  protected final String TEXT_459 = " += stmt_";
  protected final String TEXT_460 = ".getUpdateCount();" + NL + "            \t    \t} // stmtBuilder_";
  protected final String TEXT_461 = " end" + NL + "            \t    \t";
  protected final String TEXT_462 = "             \t    " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_463 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_464 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_465 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_466 = NL + "       \t\t\t\tconn_";
  protected final String TEXT_467 = ".commit();" + NL + "                \tcommitCounter_";
  protected final String TEXT_468 = "=0;" + NL + "                }\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_426);
    	...
    	////////////commit every////////////
    	if(!useExistingConnection && (!"VERTICA_6_0".equals(db_version) || !"COPY".equals(dataAction))) {
    		if(!("").equals(commitEvery) && !("0").equals(commitEvery)) {
