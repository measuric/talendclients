...
public class TFTPConnectionBeginJava
{
  ...
  protected final String TEXT_55 = NL + "  \tif((\"true\").equals(System.getProperty(\"http.proxySet\")) ){" + NL + "  \t\tcom.jcraft.jsch.ProxyHTTP proxy_";
  protected final String TEXT_56 = " = new com.jcraft.jsch.ProxyHTTP(System.getProperty(\"http.proxyHost\"),Integer.parseInt(System.getProperty(\"http.proxyPort\")));" + NL + "  \t\tif(!\"\".equals(System.getProperty(\"http.proxyUser\"))){" + NL + "  \t\t\tproxy_";
  protected final String TEXT_57 = ".setUserPasswd(System.getProperty(\"http.proxyUser\"),System.getProperty(\"http.proxyPassword\"));" + NL + "  \t\t}" + NL + "  \t\tsession_";
  protected final String TEXT_58 = ".setProxy(proxy_";
  protected final String TEXT_59 = ");" + NL + "  \t}" + NL + "\t";
  protected final String TEXT_60 = NL + "  session_";
  protected final String TEXT_61 = ".connect();" + NL + "  com.jcraft.jsch. Channel channel_";
  protected final String TEXT_62 = " = session_";
  protected final String TEXT_63 = ".openChannel(\"sftp\"); " + NL + "  channel_";
  protected final String TEXT_64 = ".connect();" + NL + "  com.jcraft.jsch.ChannelSftp c_";
  protected final String TEXT_65 = " = (com.jcraft.jsch.ChannelSftp)channel_";
  protected final String TEXT_66 = ";" + NL + "  c_";
  protected final String TEXT_67 = ".setFilenameEncoding(";
  protected final String TEXT_68 = ");" + NL + "  globalMap.put(\"conn_";
  protected final String TEXT_69 = "\", c_";
  protected final String TEXT_70 = ");";
  protected final String TEXT_71 = NL + "  class MyTrust_";
  protected final String TEXT_72 = "{" + NL + "" + NL + "    private javax.net.ssl.TrustManager[] getTrustManagers() " + NL + "      throws java.security.KeyStoreException, java.security.NoSuchAlgorithmException, " + NL + "      java.security.cert.CertificateException, java.security.UnrecoverableKeyException," + NL + "      java.io.FileNotFoundException, java.io.IOException{" + NL + "      java.security.KeyStore ks = java.security.KeyStore.getInstance(\"JKS\");" + NL + "      ks.load(new java.io.FileInputStream(";
  protected final String TEXT_73 = "), ";
  protected final String TEXT_74 = ".toCharArray());" + NL + "      javax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "      tmf.init(ks);" + NL + "      return tmf.getTrustManagers();" + NL + "    }" + NL + "  }" + NL + "  javax.net.ssl.SSLContext sslContext = null;" + NL + "  javax.net.ssl.TrustManager[] trustManager = null;" + NL + "  javax.net.ssl.SSLSocketFactory sslSocketFactory = null;" + NL + "  it.sauronsoftware.ftp4j.FTPClient ftp_";
  protected final String TEXT_75 = " =null;" + NL + "  MyTrust_";
  protected final String TEXT_76 = " myTrust_";
  protected final String TEXT_77 = " = null;" + NL + "" + NL + "  try {" + NL + "    sslContext = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "    myTrust_";
  protected final String TEXT_78 = " = new MyTrust_";
  protected final String TEXT_79 = "();" + NL + "    trustManager = myTrust_";
  protected final String TEXT_80 = ".getTrustManagers();" + NL + "    sslContext.init(null, trustManager, new java.security.SecureRandom());" + NL + "    sslSocketFactory = sslContext.getSocketFactory();" + NL + "    ftp_";
  protected final String TEXT_81 = " = new it.sauronsoftware.ftp4j.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_82 = ".setSSLSocketFactory(sslSocketFactory);";
  protected final String TEXT_83 = NL + "    \tftp_";
  protected final String TEXT_84 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS);";
  protected final String TEXT_85 = NL + "    \tftp_";
  protected final String TEXT_86 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES);";
  protected final String TEXT_87 = NL + "    ftp_";
  protected final String TEXT_88 = ".connect(";
  protected final String TEXT_89 = ",";
  protected final String TEXT_90 = ");" + NL + "    ftp_";
  protected final String TEXT_91 = ".login(";
  protected final String TEXT_92 = ", ";
  protected final String TEXT_93 = ");" + NL + "  } catch (java.lang.IllegalStateException e) {" + NL + "    e.printStackTrace();" + NL + "  } catch (java.io.IOException e) {" + NL + "    e.printStackTrace();" + NL + "  } catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) {" + NL + "    e.printStackTrace();" + NL + "  } catch (it.sauronsoftware.ftp4j.FTPException e) {" + NL + "    e.printStackTrace();" + NL + "  }" + NL + "  globalMap.put(\"conn_";
