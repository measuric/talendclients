...
public class TInformixBulkExecBeginJava {
  ...
  protected final String TEXT_70 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_71 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_72 = " = tableNameForSearch_";
  protected final String TEXT_73 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_74 = " = tableNameForSearch_";
  protected final String TEXT_75 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_162 = NL + NL + "\t\tString fileName_";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";" + NL + "\t\tString cmdFile_";
  protected final String TEXT_165 = " = fileName_";
  protected final String TEXT_166 = " + \".cmd\";" + NL + "\t\tString logFile_";
  protected final String TEXT_167 = " = fileName_";
  protected final String TEXT_168 = " + \".log\";" + NL + "\t\t" + NL + " \t\tjava.io.BufferedWriter bw_";
  protected final String TEXT_169 = " = new java.io.BufferedWriter(new java.io.FileWriter(cmdFile_";
  protected final String TEXT_170 = "));" + NL + "    \tjava.io.PrintWriter pw_";
  protected final String TEXT_171 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_172 = " ,false) ;" + NL + "    \t//file \"c:\\informix_bulk.txt\" delimiter \"|\" 7 ;insert into feature9999;" + NL + "    \tpw_";
  protected final String TEXT_173 = ".print(\"FILE \\\"\" + ";
  protected final String TEXT_174 = " + \"\\\"\" );" + NL + "    \tpw_";
  protected final String TEXT_175 = ".print(\" DELIMITER \\\"\" + ";
  protected final String TEXT_176 = " + \"\\\"\");" + NL + "    \tpw_";
  protected final String TEXT_177 = ".println(\" \" + ";
  protected final String TEXT_178 = " +\" ;\" );";
  protected final String TEXT_179 = NL + "\t\tpw_";
  protected final String TEXT_180 = ".println(\"INSERT INTO \" + tableName_";
  protected final String TEXT_181 = " + \"(";
  protected final String TEXT_182 = ");\" );";
  protected final String TEXT_183 = NL + "\tbw_";
  protected final String TEXT_184 = ".close();" + NL + "\tpw_";
  protected final String TEXT_185 = ".close();" + NL + "\t//-----------------------dbload command" + NL + "\tStringBuilder command_";
  protected final String TEXT_186 = " =  new StringBuilder();" + NL + "\t//-------------------------1. add dbload cmd";
  protected final String TEXT_187 = NL + "\tcommand_";
  protected final String TEXT_188 = ".append(\"dbload \");";
  protected final String TEXT_189 = NL + "\tcommand_";
  protected final String TEXT_190 = ".append(\"./dbload \");";
  protected final String TEXT_191 = NL + "\t//-------------------------2.add database name" + NL + "\tcommand_";
  protected final String TEXT_192 = ".append(\"-d \" + dbName_";
  protected final String TEXT_193 = " + \" \");" + NL + "\t//-------------------------3.add command file" + NL + "\tcommand_";
  protected final String TEXT_194 = ".append(\"-c \" + cmdFile_";
  protected final String TEXT_195 = " + \" \");" + NL + "\t//-------------------------4.add  error log file" + NL + "\tcommand_";
  protected final String TEXT_196 = ".append(\"-l \" + logFile_";
  protected final String TEXT_197 = " + \" \");" + NL + "\t//-------------------------5.add  bad rows before abort" + NL + "\tcommand_";
  protected final String TEXT_198 = ".append(\"-e \" + ";
  protected final String TEXT_199 = " + \" \");" + NL + "\t//-------------------------6.add commit interval" + NL + "\tcommand_";
  protected final String TEXT_200 = ".append(\"-n \" + ";
  protected final String TEXT_201 = " + \";\"); " + NL + "\t" + NL + "\t//----------------get envionment variables";
  protected final String TEXT_202 = NL + "\tProcess ev_";
  protected final String TEXT_203 = " = Runtime.getRuntime().exec(\"cmd /c set\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_204 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_205 = ".getInputStream()));";
  protected final String TEXT_206 = NL + NL + "\tProcess ev_";
  protected final String TEXT_207 = " = Runtime.getRuntime().exec(\"env\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_208 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_209 = ".getInputStream()));";
  protected final String TEXT_210 = NL + "\tjava.util.List<String> evPara_";
  protected final String TEXT_211 = " = new java.util.ArrayList();" + NL + "\tString line_";
  protected final String TEXT_212 = " = null;" + NL + "\twhile((line_";
  protected final String TEXT_213 = " = evReader_";
  protected final String TEXT_214 = ".readLine()) != null) {" + NL + "\t   evPara_";
  protected final String TEXT_215 = ".add(line_";
  protected final String TEXT_216 = ");" + NL + "\t}" + NL + "\tevReader_";
  protected final String TEXT_217 = ".close();" + NL + "" + NL + "\tevPara_";
  protected final String TEXT_218 = ".add(\"INFORMIXDIR=\" + ";
  protected final String TEXT_219 = ");" + NL + "\tevPara_";
  protected final String TEXT_220 = ".add(\"INFORMIXSERVER=\" + dbServer_";
  protected final String TEXT_221 = ");" + NL + "\tevPara_";
  protected final String TEXT_222 = ".add(\"DBDATE=\" + \"";
  protected final String TEXT_223 = "\");" + NL + "\t";
  protected final String TEXT_224 = NL + "\tevPara_";
  protected final String TEXT_225 = ".add(\"DBMONEY=\" + ";
  protected final String TEXT_226 = ");";
  protected final String TEXT_227 = NL + "\t//----------------get envionment variables end" + NL + "\t" + NL + "\t//------------------get dbload directory" + NL + "\tjava.io.File dbLoadDirectory_";
  protected final String TEXT_228 = " = new java.io.File (";
  protected final String TEXT_229 = "+\"/bin\");" + NL + "\tdbLoadDirectory_";
  protected final String TEXT_230 = ".exists();" + NL + "\t\t\t\t" + NL + " \tRuntime runtime_";
  protected final String TEXT_231 = " = Runtime.getRuntime();";
  protected final String TEXT_232 = NL + "\tfinal Process ps_";
  protected final String TEXT_233 = " = runtime_";
  protected final String TEXT_234 = ".exec(new String[]{\"cmd.exe\",\"/c\",command_";
  protected final String TEXT_235 = ".toString()}," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_236 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_237 = ");";
  protected final String TEXT_238 = NL + "\tfinal Process ps_";
  protected final String TEXT_239 = " = runtime_";
  protected final String TEXT_240 = ".exec(command_";
  protected final String TEXT_241 = ".toString()," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_242 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_243 = ");";
  protected final String TEXT_244 = NL;
  protected final String TEXT_245 = NL + NL + "Thread normal_";
  ...
  protected final String TEXT_247 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_248 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_249 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_250 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_251 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_252 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_253 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_254 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_255 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_256 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_257 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_258 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_259 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_260 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_261 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_262 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_263 = ".interrupt();" + NL + "error_";
  protected final String TEXT_264 = ".interrupt();" + NL + NL + NL + NL;
