...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_8 = NL + "\t\t\t\tbatchSize_";
  ...
  protected final String TEXT_16 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_17 = "++;";
  protected final String TEXT_18 = NL + "\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_19 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_20 = NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\tnb_line_";
  ...
  protected final String TEXT_24 = ".executeUpdate();" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_35 = NL + "                            rejectedCount_";
  protected final String TEXT_36 = " = rejectedCount_";
  protected final String TEXT_37 = " + 1;";
  protected final String TEXT_38 = NL + "                            ";
  protected final String TEXT_39 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_40 = ";";
  protected final String TEXT_41 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_54 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_55 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_56 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_57 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_58 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_59 = NL + "            try{" + NL + "                nb_line_";
  protected final String TEXT_60 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_61 = " = updatedCount_";
  protected final String TEXT_62 = " + pstmt_";
  protected final String TEXT_63 = ".executeUpdate();" + NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_87 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_88 = " = pstmt_";
  protected final String TEXT_89 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_90 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_91 = ".next())" + NL + "    \t\t{" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_92 = " = rs_";
  protected final String TEXT_93 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_104 = NL + "                try{" + NL + "                    updatedCount_";
  protected final String TEXT_105 = " = updatedCount_";
  protected final String TEXT_106 = " + pstmtUpdate_";
  protected final String TEXT_107 = ".executeUpdate();" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_108 = " = true;";
  protected final String TEXT_109 = NL + "                        throw(e);";
  ...
  protected final String TEXT_118 = NL + "                            rejectedCount_";
  protected final String TEXT_119 = " = rejectedCount_";
  protected final String TEXT_120 = " + 1;";
  protected final String TEXT_121 = NL + "                            ";
  protected final String TEXT_122 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_123 = ";";
  protected final String TEXT_124 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_125 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\telse" + NL + "    \t\t{" + NL + "    \t\t\t";
  protected final String TEXT_126 = NL + "    \t\t\t\t    ";
  protected final String TEXT_127 = NL + "    \t\t\t\t    ";
  protected final String TEXT_128 = NL + "                try{" + NL + "                    insertedCount_";
  protected final String TEXT_129 = " = insertedCount_";
  protected final String TEXT_130 = " + pstmtInsert_";
  protected final String TEXT_131 = ".executeUpdate();" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_142 = NL + "                            rejectedCount_";
  protected final String TEXT_143 = " = rejectedCount_";
  ...
  protected final String TEXT_162 = NL + "    \t" + NL + "            try{" + NL + "                updateFlag_";
  ...
  protected final String TEXT_167 = ";" + NL + "                " + NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_182 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_183 = ";";
  protected final String TEXT_184 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_185 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_192 = ".executeUpdate();" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_200 = NL + "                            rejectedCount_";
  protected final String TEXT_201 = " = rejectedCount_";
  protected final String TEXT_202 = " + 1;";
  protected final String TEXT_203 = NL + "                            ";
  protected final String TEXT_204 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_205 = ";";
  protected final String TEXT_206 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_207 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_217 = NL + "    \t\tpstmt_";
  protected final String TEXT_218 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_219 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_220 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_221 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_222 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_223 = NL + "        try{" + NL + "    \t    deletedCount_";
  protected final String TEXT_224 = " = deletedCount_";
  protected final String TEXT_225 = " + pstmt_";
  protected final String TEXT_226 = ".executeUpdate();" + NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  ...
  protected final String TEXT_237 = NL + "                    rejectedCount_";
  protected final String TEXT_238 = " = rejectedCount_";
  protected final String TEXT_239 = " + 1;";
  ...
  protected final String TEXT_247 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_258 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_259 = " <= batchSizeCounter_";
  protected final String TEXT_260 = ") {                ";
  protected final String TEXT_261 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_262 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_263 = ".executeBatch();                \t" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_264 = ".clearBatch();" + NL + "            \t    \t";
  protected final String TEXT_265 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_266 = " += pstmt_";
  protected final String TEXT_267 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_268 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_269 = " += pstmt_";
  protected final String TEXT_270 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_271 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_272 = " += pstmt_";
  protected final String TEXT_273 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_274 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_275 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_276 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_277 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_278 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_279 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_280 = NL + "                }";
  protected final String TEXT_281 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  ...
  protected final String TEXT_286 = NL + "                try {" + NL + "                \t\tpstmt_";
  protected final String TEXT_287 = ".executeBatch();" + NL + "                \t\tpstmt_";
  protected final String TEXT_288 = ".clearBatch();" + NL + "            \t    \t";
  protected final String TEXT_289 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_290 = " += pstmt_";
  protected final String TEXT_291 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_292 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_293 = " += pstmt_";
  protected final String TEXT_294 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_295 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_296 = " += pstmt_";
  protected final String TEXT_297 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_298 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_300 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_301 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_302 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_303 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_304 = NL + "                }            \t                              ";
  protected final String TEXT_305 = NL + "                \tconn_";
  protected final String TEXT_306 = ".commit();" + NL + "                \tcommitCounter_";
  protected final String TEXT_307 = "=0;" + NL + "                " + NL + "                }\t" + NL + "    " + NL + "    \t";
