...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_137 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_143 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_144 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_145 = " = tableNameForSearch_";
  protected final String TEXT_146 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_147 = " = tableNameForSearch_";
  protected final String TEXT_148 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_168 = ".equals";
  protected final String TEXT_169 = "IgnoreCase";
  ...
  protected final String TEXT_174 = "(dbschema_";
  ...
  protected final String TEXT_193 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_198 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_205 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_215 = NL + "                if(whetherExist_";
  protected final String TEXT_216 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_219 = ".execute(\"";
  protected final String TEXT_220 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_221 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_222 = " = conn_";
  protected final String TEXT_223 = ".createStatement();";
  ...
  protected final String TEXT_233 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_243 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_244 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_245 = "            ";
  protected final String TEXT_246 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_247 = " = conn_";
  protected final String TEXT_248 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_249 = ".executeUpdate(\"";
  protected final String TEXT_250 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_251 = ".close();";
  protected final String TEXT_252 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_255 = " = stmtTruncCount_";
  protected final String TEXT_256 = ".executeQuery(\"";
  protected final String TEXT_257 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_258 = " = conn_";
  protected final String TEXT_259 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_260 = ".executeUpdate(\"";
  protected final String TEXT_261 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_262 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_263 = " += rsTruncCount_";
  protected final String TEXT_264 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_265 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_266 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_267 = ".close();            ";
  protected final String TEXT_268 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_271 = " = stmtTruncCount_";
  protected final String TEXT_272 = ".executeQuery(\"";
  protected final String TEXT_273 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_274 = " = conn_";
  protected final String TEXT_275 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_276 = ".executeUpdate(\"";
  protected final String TEXT_277 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_278 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_279 = " += rsTruncCount_";
  protected final String TEXT_280 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_281 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_282 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_283 = ".close();";
  protected final String TEXT_284 = NL + "\t    String insert_";
  protected final String TEXT_285 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_286 = " + \"\\\" (";
  protected final String TEXT_287 = ") VALUES (";
  protected final String TEXT_288 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_289 = " = conn_";
  protected final String TEXT_290 = ".prepareStatement(insert_";
  protected final String TEXT_291 = ");" + NL + "\t    ";
  protected final String TEXT_292 = NL + "\t    String update_";
  protected final String TEXT_293 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_302 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_307 = ") VALUES (";
  protected final String TEXT_308 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_309 = " = conn_";
  protected final String TEXT_310 = ".prepareStatement(insert_";
  protected final String TEXT_311 = ");" + NL + "\t    String update_";
  protected final String TEXT_312 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_313 = " + \"\\\" SET ";
  protected final String TEXT_314 = " WHERE ";
  protected final String TEXT_315 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_316 = " = conn_";
  protected final String TEXT_317 = ".prepareStatement(update_";
  protected final String TEXT_318 = ");" + NL + "\t    ";
  protected final String TEXT_319 = NL + "\t    String update_";
  protected final String TEXT_320 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_321 = " + \"\\\" SET ";
  protected final String TEXT_322 = " WHERE ";
  protected final String TEXT_323 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_324 = " = conn_";
  protected final String TEXT_325 = ".prepareStatement(update_";
  protected final String TEXT_326 = ");" + NL + "\t    String insert_";
  protected final String TEXT_327 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_328 = " + \"\\\" (";
  protected final String TEXT_329 = ") VALUES (";
  protected final String TEXT_330 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_331 = " = conn_";
  protected final String TEXT_332 = ".prepareStatement(insert_";
  protected final String TEXT_333 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_334 = NL + "\t    String delete_";
  protected final String TEXT_335 = " = \"DELETE  FROM \\\"\" + tableName_";
  protected final String TEXT_336 = " + \"\\\" WHERE ";
  protected final String TEXT_337 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_338 = " = conn_";
  protected final String TEXT_339 = ".prepareStatement(delete_";
  protected final String TEXT_340 = ");" + NL + "\t    ";
  protected final String TEXT_341 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_342 = " = null;" + NL + "       \t";
  protected final String TEXT_343 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_349 = ".split(\"\\\\?\");";
  protected final String TEXT_350 = NL + "\t\t\tupdate_";
  protected final String TEXT_351 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_352 = " = update_";
  protected final String TEXT_353 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_354 = " = insert_";
  protected final String TEXT_355 = ".split(\"\\\\?\");";
  protected final String TEXT_356 = NL + "\t\t\tdelete_";
  protected final String TEXT_357 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_358 = " = delete_";
  protected final String TEXT_359 = ".split(\"\\\\?\");";
  protected final String TEXT_360 = NL + "\t\t\treplace_";
  protected final String TEXT_361 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_362 = " = replace_";
  protected final String TEXT_363 = ".split(\"\\\\?\");";
  protected final String TEXT_364 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_365 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_366 = " = insertIgnore_";
  protected final String TEXT_367 = ".split(\"\\\\?\");";
  protected final String TEXT_368 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_369 = " = insert_";
  protected final String TEXT_370 = ".split(\"\\\\?\");";
  protected final String TEXT_371 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_372 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_373 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
