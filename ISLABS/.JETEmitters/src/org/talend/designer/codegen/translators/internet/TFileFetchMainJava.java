...
public class TFileFetchMainJava
{
  ...
  protected final String TEXT_129 = " = false;" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tthrow new java.lang.Exception(\"Method failed: \" + method_";
  ...
  protected final String TEXT_147 = " != org.apache.commons.httpclient.HttpStatus.SC_OK) {      " + NL + "\t\t\t\tthrow new java.lang.Exception(\"Method failed: \" + method_";
  protected final String TEXT_148 = ".getStatusLine());" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_149 = NL + "\t} catch(java.lang.Exception e) {" + NL + "\t\t";
  ...
  protected final String TEXT_202 = ".delete();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\tfileName_";
  ...
  protected final String TEXT_268 = ".delete();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\tfileName_";
  ...
  protected final String TEXT_271 = ".getInputStream());" + NL + "\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t";
  ...
  protected final String TEXT_337 = " " + NL + "\t} catch (java.lang.Exception e) {" + NL + "\t\tSystem.err.println(e.getMessage());" + NL + "\t}";
