...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_23 = ".executeUpdate();" + NL + "" + NL + "                nb_line_";
  protected final String TEXT_24 = "++;" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_36 = ".errorMessage = e.getMessage();";
  protected final String TEXT_37 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_38 = NL + "            }";
  protected final String TEXT_39 = NL + "                query_";
  protected final String TEXT_40 = " = new String(update_";
  ...
  protected final String TEXT_69 = ".errorMessage = e.getMessage();";
  protected final String TEXT_70 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_71 = NL + "            }";
  protected final String TEXT_72 = NL + "    " + NL + "    \t    ";
  protected final String TEXT_73 = NL + "                    ";
  protected final String TEXT_74 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_75 = " = pstmt_";
  protected final String TEXT_76 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_77 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_78 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_79 = " = rs_";
  protected final String TEXT_80 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_81 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_82 = NL + "                    query_";
  protected final String TEXT_83 = " = new String(update_";
  ...
  protected final String TEXT_99 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_111 = ".errorMessage = e.getMessage();";
  protected final String TEXT_112 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_113 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_114 = NL + "                    query_";
  protected final String TEXT_115 = " = new String(insert_";
  ...
  protected final String TEXT_122 = "_QUERY\", query_";
  protected final String TEXT_123 = ");";
  protected final String TEXT_124 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_125 = " = insertedCount_";
  protected final String TEXT_126 = " + pstmtInsert_";
  protected final String TEXT_127 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_140 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_141 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_142 = "++;" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_143 = NL + "                query_";
  protected final String TEXT_144 = " = new String(update_";
  protected final String TEXT_145 = ");";
  protected final String TEXT_146 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_157 = "_QUERY\", query_";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_164 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_176 = ".errorMessage = e.getMessage();";
  protected final String TEXT_177 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_178 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_179 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_180 = NL + "                    query_";
  protected final String TEXT_181 = " = new String(insert_";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL + "                        ";
  protected final String TEXT_184 = NL + "                            query_";
  protected final String TEXT_185 = " = ";
  protected final String TEXT_186 = ";";
  protected final String TEXT_187 = NL + "                    globalMap.put(\"";
  protected final String TEXT_188 = "_QUERY\", query_";
  protected final String TEXT_189 = ");";
  protected final String TEXT_190 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_191 = " = insertedCount_";
  protected final String TEXT_192 = " + pstmtInsert_";
  protected final String TEXT_193 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_206 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_207 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  protected final String TEXT_208 = "++;";
  protected final String TEXT_209 = NL + "                query_";
  protected final String TEXT_210 = " = new String(delete_";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "                    ";
  protected final String TEXT_213 = NL + "                        query_";
  protected final String TEXT_214 = " = ";
  protected final String TEXT_215 = ";";
  protected final String TEXT_216 = NL + "                globalMap.put(\"";
  protected final String TEXT_217 = "_QUERY\", query_";
  protected final String TEXT_218 = ");";
  protected final String TEXT_219 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_220 = " = deletedCount_";
  protected final String TEXT_221 = " + pstmt_";
  protected final String TEXT_222 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_234 = ".errorMessage = e.getMessage();";
  protected final String TEXT_235 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_236 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_237 = "++;" + NL + "    \t";
  protected final String TEXT_238 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_249 = NL + "                    commitCounter_";
  protected final String TEXT_250 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_251 = " <= commitCounter_";
  protected final String TEXT_252 = ") {   " + NL + "                        conn_";
  protected final String TEXT_253 = ".commit();                \t" + NL + "                        commitCounter_";
