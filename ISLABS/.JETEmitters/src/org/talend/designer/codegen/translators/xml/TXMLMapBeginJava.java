...
public class TXMLMapBeginJava {
  ...
  protected final String TEXT_171 = ").equals(FormatterUtils.format(";
  ...
  protected final String TEXT_177 = "\t" + NL + "\t\t\t\t\tif(groupbyList.size()<=";
  protected final String TEXT_178 = "){" + NL + "\t\t\t\t\t\tgroupbyList.add(new java.util.ArrayList<String>());" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_179 = ").clear();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_181 = ").add(FormatterUtils.format(";
  protected final String TEXT_182 = ",";
  protected final String TEXT_183 = "));";
  protected final String TEXT_184 = NL + "\t\t\t\t\tisNewElement=true;" + NL + "\t\t\t\t\tif(groupElementList.size()<=";
  protected final String TEXT_185 = "){" + NL + "\t\t\t\t\t\tgroupElementList.add(group";
  protected final String TEXT_186 = "_);" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupElementList.set(";
  protected final String TEXT_187 = ",group";
  protected final String TEXT_188 = "_);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tsubTreeRootParent=groupElementList.get(";
  protected final String TEXT_189 = ");" + NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "class NestXMLTool_";
  ...
  protected final String TEXT_192 = " nestXMLTool_";
  protected final String TEXT_193 = " = new NestXMLTool_";
  protected final String TEXT_194 = "();" + NL;
  protected final String TEXT_195 = NL + "class GenerateDocument_";
  protected final String TEXT_196 = " {" + NL;
  protected final String TEXT_197 = NL + "\t\tTreeNode_API_";
  protected final String TEXT_198 = " treeNodeAPI = null;";
  protected final String TEXT_199 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\troutines.system.DocumentGenerateOrderHelper orderHelper = new routines.system.DocumentGenerateOrderHelper(";
  protected final String TEXT_200 = ");" + NL + "\t\t" + NL + "\torg.dom4j.Document doc = null;" + NL + "\t" + NL + "\tNestXMLTool_";
  protected final String TEXT_201 = " nestXMLTool = null;" + NL + "\t" + NL + "\torg.dom4j.Element root4Group = null;" + NL + "\t" + NL + "\torg.dom4j.io.OutputFormat format = null;" + NL + "\t" + NL + "\tjava.util.List<java.util.List<String>> groupbyList = null;" + NL + "\tjava.util.List<org.dom4j.Element> groupElementList = null;" + NL + "\tint order = 0;" + NL + "\t" + NL + "\tboolean isFirst = true;" + NL + "\t" + NL + "\tboolean\tneedRoot = true;";
  protected final String TEXT_202 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_203 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tnestXMLTool = new NestXMLTool_";
  protected final String TEXT_204 = "();" + NL + "    \t" + NL + "    \tgroupbyList =  new java.util.ArrayList<java.util.List<String>>();" + NL + "\t\tgroupElementList = new java.util.ArrayList<org.dom4j.Element>();" + NL + "    \t" + NL + "    \tdoc = org.dom4j.DocumentHelper.createDocument();" + NL + "    \tformat = org.dom4j.io.OutputFormat.createPrettyPrint();" + NL + "    \tformat.setTrimText(false);" + NL + "    }" + NL + "    " + NL + "    public org.dom4j.Document getDocument(){" + NL + "\t\tgenerateOk();" + NL + "    \treturn this.doc;" + NL + "    }" + NL + "    " + NL + "    //do some work after document has been generated" + NL + "    private void generateOk() {" + NL + "    \tnestXMLTool.replaceDefaultNameSpace(this.doc.getRootElement(),null);";
  protected final String TEXT_205 = NL + "\t\tnestXMLTool.removeEmptyElement(this.doc.getRootElement());";
  protected final String TEXT_206 = NL + "    }" + NL + "\t" + NL + "\t//We generate the TreeNode_API object only if there is a document in the main input table." + NL + "    void generateElements(";
  protected final String TEXT_207 = "TreeNode_API_";
  protected final String TEXT_208 = " treeNodeAPI,";
  protected final String TEXT_209 = "boolean isInnerJoin";
  protected final String TEXT_210 = ", ";
  protected final String TEXT_211 = " ";
  protected final String TEXT_212 = NL + "\t";
  protected final String TEXT_213 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_214 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_215 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_216 = NL + "\t\t}" + NL + "    }" + NL;
  protected final String TEXT_217 = NL;
  protected final String TEXT_218 = NL + "\t            class SortableRow_";
  protected final String TEXT_219 = " implements Comparable<SortableRow_";
  protected final String TEXT_220 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_221 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  protected final String TEXT_222 = " exprKey_";
  ...
  protected final String TEXT_230 = NL + "\t\t\t        public void fillFrom(";
  protected final String TEXT_231 = " ";
  protected final String TEXT_232 = "Struct ";
  protected final String TEXT_233 = " ";
  protected final String TEXT_234 = " exprKey_";
  ...
  protected final String TEXT_243 = "this.exprKey_";
  protected final String TEXT_244 = "__";
  protected final String TEXT_245 = " = exprKey_";
  protected final String TEXT_246 = "__";
  protected final String TEXT_247 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_248 = NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        public void copyDataTo(";
  protected final String TEXT_249 = "Struct ";
  protected final String TEXT_250 = ") {" + NL + "\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_251 = ".";
  protected final String TEXT_252 = " = this.";
  protected final String TEXT_253 = "__";
  protected final String TEXT_254 = ";" + NL + "\t\t\t\t            \t";
  protected final String TEXT_255 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_257 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_259 = "__";
  protected final String TEXT_260 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_261 = "__";
  protected final String TEXT_262 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_264 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_265 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_266 = "__";
  protected final String TEXT_267 = ", other.exprKey_";
  protected final String TEXT_268 = "__";
  protected final String TEXT_269 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  protected final String TEXT_270 = NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "\t\t\t                returnValue = ((Comparable) object1).compareTo(object2);" + NL + "\t\t\t            } else if (object1 != null && object2 != null) {" + NL + "\t\t\t                returnValue = compareStrings(object1.toString(), object2" + NL + "\t\t\t                        .toString());" + NL + "\t\t\t            } else if (object1 == null && object2 != null) {" + NL + "\t\t\t                returnValue = 1;" + NL + "\t\t\t            } else if (object1 != null && object2 == null) {" + NL + "\t\t\t                returnValue = -1;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                returnValue = 0;" + NL + "\t\t\t            }" + NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int compareStrings(String string1, String string2) {" + NL + "\t\t\t            return string1.compareTo(string2);" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t\t\tpublic void readData(ObjectInputStream dis) {" + NL + "\t\t\t\t\t\tsynchronized(";
  protected final String TEXT_271 = "Struct.commonByteArrayLock_";
  protected final String TEXT_272 = "_";
  protected final String TEXT_273 = ") {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\t\t            this.";
  protected final String TEXT_275 = "__";
  protected final String TEXT_276 = " = dis.read";
  protected final String TEXT_277 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_279 = "__";
  protected final String TEXT_280 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_281 = "Struct.commonByteArray_";
  protected final String TEXT_282 = "_";
  protected final String TEXT_283 = ".length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_284 = "Struct.commonByteArray_";
  protected final String TEXT_285 = "_";
  protected final String TEXT_286 = ".length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_287 = "Struct.commonByteArray_";
  protected final String TEXT_288 = "_";
  protected final String TEXT_289 = " = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  ...
  protected final String TEXT_295 = ", 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_296 = "__";
  protected final String TEXT_297 = " = new String(";
  protected final String TEXT_298 = "Struct.commonByteArray_";
  protected final String TEXT_299 = "_";
  protected final String TEXT_300 = ", 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_301 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_302 = "__";
  protected final String TEXT_303 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.";
  protected final String TEXT_304 = "__";
  protected final String TEXT_305 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_307 = "__";
  protected final String TEXT_308 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_309 = "__";
  protected final String TEXT_310 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_311 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_312 = "__";
  protected final String TEXT_313 = " = (";
  protected final String TEXT_314 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_319 = " = dis.read";
  protected final String TEXT_320 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t            ";
  protected final String TEXT_322 = NL + "\t\t\t\t            this.exprKey_";
  protected final String TEXT_323 = "__";
  protected final String TEXT_324 = " = dis.read";
  protected final String TEXT_325 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_327 = "__";
  protected final String TEXT_328 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.exprKey_";
  protected final String TEXT_329 = "__";
  protected final String TEXT_330 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_331 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_332 = "__";
  protected final String TEXT_333 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_334 = "Struct.commonByteArray_";
  protected final String TEXT_335 = "_";
  protected final String TEXT_336 = ".length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_337 = "Struct.commonByteArray_";
  protected final String TEXT_338 = "_";
  protected final String TEXT_339 = ".length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_340 = "Struct.commonByteArray_";
  protected final String TEXT_341 = "_";
  protected final String TEXT_342 = " = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_343 = "Struct.commonByteArray_";
  protected final String TEXT_344 = "_";
  protected final String TEXT_345 = " = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_346 = "Struct.commonByteArray_";
  protected final String TEXT_347 = "_";
  protected final String TEXT_348 = ", 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_349 = "__";
  protected final String TEXT_350 = " = new String(";
  protected final String TEXT_351 = "Struct.commonByteArray_";
  protected final String TEXT_352 = "_";
  protected final String TEXT_353 = ", 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_355 = "__";
  protected final String TEXT_356 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_357 = "__";
  protected final String TEXT_358 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_360 = "__";
  protected final String TEXT_361 = " = (";
  protected final String TEXT_362 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_364 = "__";
  protected final String TEXT_365 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_366 = "__";
  protected final String TEXT_367 = " = dis.read";
  protected final String TEXT_368 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_370 = NL + "\t\t\t\t";
  protected final String TEXT_371 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\t            \tdos.write";
  protected final String TEXT_374 = "(this.";
  protected final String TEXT_375 = "__";
  protected final String TEXT_376 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_378 = "__";
  protected final String TEXT_379 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_380 = "__";
  protected final String TEXT_381 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_383 = "__";
  protected final String TEXT_384 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_385 = "__";
  protected final String TEXT_386 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_388 = "__";
  protected final String TEXT_389 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_390 = "__";
  protected final String TEXT_391 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_392 = "__";
  protected final String TEXT_393 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_395 = "__";
  protected final String TEXT_396 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_398 = "__";
  protected final String TEXT_399 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  ...
  protected final String TEXT_404 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_405 = "(this.exprKey_";
  protected final String TEXT_406 = "__";
  protected final String TEXT_407 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_409 = "__";
  protected final String TEXT_410 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_411 = "__";
  protected final String TEXT_412 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_414 = "__";
  protected final String TEXT_415 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_416 = "__";
  protected final String TEXT_417 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_418 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_419 = "__";
  protected final String TEXT_420 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_421 = "__";
  protected final String TEXT_422 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_423 = "__";
  protected final String TEXT_424 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  protected final String TEXT_426 = "__";
  protected final String TEXT_427 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_429 = "__";
  protected final String TEXT_430 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_431 = "(this.exprKey_";
  protected final String TEXT_432 = "__";
  protected final String TEXT_433 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_434 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_435 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
