...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_43 = NL + "\t\tjava.sql.Savepoint  sp_";
  protected final String TEXT_44 = " = null;" + NL + "\t";
  protected final String TEXT_45 = "\t" + NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");    " + NL + "    String url_";
  protected final String TEXT_46 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_47 = "+\":\"+";
  protected final String TEXT_48 = "+\"/\"+";
  protected final String TEXT_49 = ";    " + NL + "    String dbUser_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";" + NL + "    String dbPwd_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";    " + NL + "    conn_";
  protected final String TEXT_54 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_55 = ",dbUser_";
  protected final String TEXT_56 = ",dbPwd_";
  protected final String TEXT_57 = ");";
  protected final String TEXT_58 = NL + "    \tjava.sql.Savepoint  sp_";
  protected final String TEXT_59 = " = null;" + NL + "\t";
  protected final String TEXT_60 = NL + "        conn_";
  protected final String TEXT_61 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_62 = " = ";
  protected final String TEXT_63 = ";            " + NL + "        int commitCounter_";
  protected final String TEXT_64 = " = 0;";
  protected final String TEXT_65 = NL;
  protected final String TEXT_66 = NL + "    if(conn_";
  protected final String TEXT_67 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\"); " + NL + "    }";
  protected final String TEXT_68 = NL;
  protected final String TEXT_69 = NL + "   int batchSize_";
  protected final String TEXT_70 = " = ";
  protected final String TEXT_71 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_72 = "=0;";
  protected final String TEXT_73 = " " + NL;
  protected final String TEXT_74 = NL + "int count_";
  ...
  protected final String TEXT_80 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_81 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_103 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_104 = " = conn_";
  protected final String TEXT_105 = ".createStatement();";
  ...
  protected final String TEXT_115 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_126 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_127 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_128 = "+\"][\"+";
  protected final String TEXT_129 = "+\"][\"+";
  protected final String TEXT_130 = "+\"][\"+";
  protected final String TEXT_131 = "+\"][\"+";
  protected final String TEXT_132 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_133 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_134 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_137 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_138 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_139 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_140 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_141 = ")== null){";
  protected final String TEXT_142 = "              ";
  protected final String TEXT_143 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_146 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_147 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_148 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_149 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_150 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  protected final String TEXT_151 = ".close();";
  protected final String TEXT_152 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_156 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_157 = " = tableNameForSearch_";
  protected final String TEXT_158 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_159 = " = tableNameForSearch_";
  protected final String TEXT_160 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_161 = " = dbMetaData_";
  protected final String TEXT_162 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_163 = ", tableNameForSearch_";
  protected final String TEXT_164 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_165 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_166 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_167 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_188 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_196 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_197 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_198 = " = rsTable_";
  protected final String TEXT_199 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_200 = ".equalsIgnoreCase(";
  protected final String TEXT_201 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_202 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_227 = NL + "                if(whetherExist_";
  protected final String TEXT_228 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_229 = " = conn_";
  protected final String TEXT_230 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_231 = ".execute(\"";
  protected final String TEXT_232 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_233 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_234 = " = conn_";
  protected final String TEXT_235 = ".createStatement();";
  ...
  protected final String TEXT_255 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_256 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_257 = "            ";
  protected final String TEXT_258 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_259 = " = conn_";
  protected final String TEXT_260 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_261 = ".executeUpdate(\"";
  protected final String TEXT_262 = "\");" + NL + "            stmtClear_";
  ...
  protected final String TEXT_280 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_281 = " = conn_";
  protected final String TEXT_282 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_283 = " = stmtTruncCount_";
  protected final String TEXT_284 = ".executeQuery(\"";
  protected final String TEXT_285 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_286 = " = conn_";
  protected final String TEXT_287 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_288 = ".executeUpdate(\"";
  protected final String TEXT_289 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_290 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_291 = " += rsTruncCount_";
  protected final String TEXT_292 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_293 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_294 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_295 = ".close();";
  protected final String TEXT_296 = NL + "\t    String insert_";
  protected final String TEXT_297 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_298 = " + \"\\\" (";
  protected final String TEXT_299 = ") VALUES (";
  protected final String TEXT_300 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_301 = " = conn_";
  protected final String TEXT_302 = ".prepareStatement(insert_";
  protected final String TEXT_303 = ");" + NL + "\t    ";
  protected final String TEXT_304 = NL + "\t    String update_";
  protected final String TEXT_305 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_306 = " + \"\\\" SET ";
  protected final String TEXT_307 = " WHERE ";
  ...
  protected final String TEXT_312 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_313 = " = conn_";
  protected final String TEXT_314 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_315 = " + \"\\\" WHERE ";
  protected final String TEXT_316 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_317 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_318 = " + \"\\\" (";
  protected final String TEXT_319 = ") VALUES (";
  protected final String TEXT_320 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_321 = " = conn_";
  protected final String TEXT_322 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_326 = " WHERE ";
  protected final String TEXT_327 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_328 = " = conn_";
  protected final String TEXT_329 = ".prepareStatement(update_";
  protected final String TEXT_330 = ");\t" + NL + "\t    ";
  protected final String TEXT_331 = NL + "\t    String update_";
  protected final String TEXT_332 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_333 = " + \"\\\" SET ";
  protected final String TEXT_334 = " WHERE ";
  protected final String TEXT_335 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".prepareStatement(update_";
  ...
  protected final String TEXT_342 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_343 = " = conn_";
  protected final String TEXT_344 = ".prepareStatement(insert_";
  protected final String TEXT_345 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_346 = NL + "\t    String delete_";
  protected final String TEXT_347 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_348 = " + \"\\\" WHERE ";
  protected final String TEXT_349 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_350 = " = conn_";
  protected final String TEXT_351 = ".prepareStatement(delete_";
  protected final String TEXT_352 = ");" + NL + "\t    ";
  protected final String TEXT_353 = NL + "        StringBuffer query_";
  protected final String TEXT_354 = " = null;" + NL + "       \t";
  protected final String TEXT_355 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_356 = " = insert_";
  protected final String TEXT_357 = ".split(\"\\\\?\");";
  protected final String TEXT_358 = NL + "\t\t\tupdate_";
  protected final String TEXT_359 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_360 = " = update_";
  protected final String TEXT_361 = ".split(\"\\\\?\");";
  protected final String TEXT_362 = NL + "\t\t\tupdate_";
  protected final String TEXT_363 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_364 = " = update_";
  protected final String TEXT_365 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_366 = " = insert_";
  protected final String TEXT_367 = ".split(\"\\\\?\");";
  protected final String TEXT_368 = NL + "\t\t\tdelete_";
  protected final String TEXT_369 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_370 = " = delete_";
  protected final String TEXT_371 = ".split(\"\\\\?\");";
  protected final String TEXT_372 = NL + "\t\t\treplace_";
  protected final String TEXT_373 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_374 = " = replace_";
  protected final String TEXT_375 = ".split(\"\\\\?\");";
  protected final String TEXT_376 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_377 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_378 = " = insertIgnore_";
  protected final String TEXT_379 = ".split(\"\\\\?\");";
  protected final String TEXT_380 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_381 = " = insert_";
  protected final String TEXT_382 = ".split(\"\\\\?\");";
  protected final String TEXT_383 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_384 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_385 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_386 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_387 = " = true;" + NL + "    \t";
  protected final String TEXT_388 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_389 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_390 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
