...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_65 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_66 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_67 = " = tableNameForSearch_";
  protected final String TEXT_68 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_69 = " = tableNameForSearch_";
  protected final String TEXT_70 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_106 = ".equals";
  protected final String TEXT_107 = "IgnoreCase";
  ...
  protected final String TEXT_159 = NL + "        String action_";
  protected final String TEXT_160 = " = \"";
  protected final String TEXT_161 = "\";" + NL + "        java.sql.CallableStatement callStmt_";
  protected final String TEXT_162 = " = null;" + NL + "        String sql_";
  protected final String TEXT_163 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        String param_";
  protected final String TEXT_164 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_165 = " + \"\\\" OF ";
  protected final String TEXT_166 = " DEL MODIFIED BY COLDEL\"+ ";
  protected final String TEXT_167 = " + " + NL + "        \t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_168 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_169 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_170 = " +\"\\\" ";
  protected final String TEXT_171 = " \" +" + NL + "        \t\t\t\t action_";
  protected final String TEXT_172 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_173 = " + \"\\\" ";
  protected final String TEXT_174 = "\";     \t\t\t" + NL + "        callStmt_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".prepareCall(sql_";
  protected final String TEXT_177 = ");" + NL + "        callStmt_";
  protected final String TEXT_178 = ".setString(1, param_";
  protected final String TEXT_179 = ");" + NL + "        callStmt_";
  protected final String TEXT_180 = ".execute();        " + NL + "        callStmt_";
  protected final String TEXT_181 = ".close();";
  protected final String TEXT_182 = NL + "            int keyCount_";
  protected final String TEXT_183 = " = ";
  protected final String TEXT_184 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_185 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_186 = " = tableName_";
  protected final String TEXT_187 = ";" + NL + "            tableName_";
  protected final String TEXT_188 = " = \"tmp_";
  protected final String TEXT_189 = "\" + \"_\" + pid; " + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".createStatement();" + NL + "            " + NL + "" + NL + "            " + NL + "            stmtCreateTmp_";
  protected final String TEXT_192 = ".execute(\"";
  protected final String TEXT_193 = "\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_194 = ".close();" + NL + "                        " + NL + "        \tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_195 = " = null;" + NL + "        \tString sql_";
  protected final String TEXT_196 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        \tString param_";
  protected final String TEXT_197 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_198 = ".replace(\"\\\\\",\"/\") + \"\\\" OF ";
  protected final String TEXT_199 = " DEL MODIFIED BY COLDEL\" + ";
  protected final String TEXT_200 = " + " + NL + "        \t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_201 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_202 = "+ \"\\\" timestampformat=\\\"\" + ";
  protected final String TEXT_203 = "+\"\\\"\" + " + NL + "        \t\t\t\t\t\t\t\" ";
  protected final String TEXT_204 = " INSERT INTO \\\"\"  + tableName_";
  protected final String TEXT_205 = " + \"\\\" ";
  protected final String TEXT_206 = "\"; \t        \t\t\t" + NL + "        \t" + NL + "        \tcallStmt_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".prepareCall(sql_";
  protected final String TEXT_209 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_210 = ".setString(1, param_";
  protected final String TEXT_211 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_212 = ".execute();        " + NL + "        \tcallStmt_";
  protected final String TEXT_213 = ".close();            " + NL + "                    \t\t\t" + NL + "            tableName_";
  protected final String TEXT_214 = " = tmpTableName_";
  protected final String TEXT_215 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_216 = " = \"tmp_";
  protected final String TEXT_217 = "\"+ \"_\" + pid;             " + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".createStatement();" + NL + "                        " + NL + "            stmtUpdateBulk_";
  protected final String TEXT_220 = ".executeUpdate(\"";
  protected final String TEXT_221 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_222 = ".close();           " + NL + "            " + NL + "            tableName_";
  protected final String TEXT_223 = " = \"tmp_";
  protected final String TEXT_224 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_227 = ".execute(\"";
  protected final String TEXT_228 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_229 = ".close();";
  protected final String TEXT_230 = NL + NL + NL + NL + NL + NL;
