...
public class TOracleBulkExecEndJava {
  ...
  protected final String TEXT_11 = ".close();" + NL + "    }finally{" + NL + "        tableName_";
  protected final String TEXT_12 = " = \"tmp_";
  protected final String TEXT_13 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtTmpDrop_";
