...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_152 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_153 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_154 = " = tableNameForSearch_";
  protected final String TEXT_155 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_156 = " = tableNameForSearch_";
  protected final String TEXT_157 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_203 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_208 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_211 = ".execute(\"";
  protected final String TEXT_212 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_213 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_219 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_222 = ".executeUpdate(\"";
  protected final String TEXT_223 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_224 = ".close();";
  protected final String TEXT_225 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_228 = " = stmtTruncCount_";
  protected final String TEXT_229 = ".executeQuery(\"";
  protected final String TEXT_230 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_233 = ".executeUpdate(\"";
  protected final String TEXT_234 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_235 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_236 = " += rsTruncCount_";
  protected final String TEXT_237 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_238 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_239 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_240 = ".close();            ";
  protected final String TEXT_241 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_242 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_243 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_244 = NL + "\t";
  protected final String TEXT_245 = NL + "\tString ctlf_";
  protected final String TEXT_246 = " = ";
  protected final String TEXT_247 = ";" + NL + "\tString logf_";
  protected final String TEXT_248 = " = ";
  protected final String TEXT_249 = "+\".log\";" + NL + "\t";
  protected final String TEXT_250 = NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_251 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_252 = ".append(\"OPTIONS (\");";
  protected final String TEXT_253 = NL + "    \t\toptionClause_";
  protected final String TEXT_254 = ".append(\", \");" + NL + "    \t\t";
  protected final String TEXT_255 = NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_256 = ".append(\"";
  protected final String TEXT_257 = "=(";
  protected final String TEXT_258 = ")\");" + NL + "    \t\t\t\t";
  protected final String TEXT_259 = NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_260 = ".append(\"";
  protected final String TEXT_261 = "=";
  protected final String TEXT_262 = "\");" + NL + "    \t\t\t\t";
  protected final String TEXT_263 = NL + "    \t\t\tif(";
  protected final String TEXT_264 = ".split(\",\").length>1){" + NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_265 = ".append(\"";
  protected final String TEXT_266 = "=(\"+";
  protected final String TEXT_267 = "+\")\");" + NL + "    \t\t\t}else{" + NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_268 = ".append(\"";
  protected final String TEXT_269 = "=\"+";
  protected final String TEXT_270 = ");" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_271 = NL + "    \t\t\toptionClause_";
  protected final String TEXT_272 = ".append(\"";
  protected final String TEXT_273 = "=";
  protected final String TEXT_274 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_275 = NL + "\t\t    \toptionClause_";
  protected final String TEXT_276 = ".append(\"";
  protected final String TEXT_277 = "='\"+";
  protected final String TEXT_278 = "+\"'\");" + NL + "\t\t    \t";
  protected final String TEXT_279 = NL + "    \t\t\toptionClause_";
  protected final String TEXT_280 = ".append(\"";
  protected final String TEXT_281 = "=";
  protected final String TEXT_282 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_283 = NL + "\t\t    \toptionClause_";
  protected final String TEXT_284 = ".append(\"";
  protected final String TEXT_285 = "=\"+";
  protected final String TEXT_286 = ");" + NL + "\t\t    \t";
  protected final String TEXT_287 = NL + "    optionClause_";
  protected final String TEXT_288 = ".append(\")\");";
  protected final String TEXT_289 = NL + "    String dataf_";
  protected final String TEXT_290 = " = ";
  protected final String TEXT_291 = ";" + NL + "    " + NL + "    String ctlf_";
  protected final String TEXT_292 = " = dataf_";
  protected final String TEXT_293 = " + \".ctl\";" + NL + "    " + NL + "    String badf_";
  protected final String TEXT_294 = " = dataf_";
  protected final String TEXT_295 = " + \".bad\";" + NL + "    " + NL + "    String dscf_";
  protected final String TEXT_296 = " = dataf_";
  protected final String TEXT_297 = " + \".dsc\";" + NL + "    " + NL + "    String logf_";
  protected final String TEXT_298 = " = dataf_";
  protected final String TEXT_299 = " + \".log\";" + NL + "    " + NL + "    java.io.File badFile_";
  protected final String TEXT_300 = " = new java.io.File(badf_";
  protected final String TEXT_301 = ");" + NL + "    " + NL + "    if(badFile_";
  protected final String TEXT_302 = ".exists()){" + NL + "    \t" + NL + "        badFile_";
  protected final String TEXT_303 = ".delete();" + NL + "    \t" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_304 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_305 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_306 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_307 = " ,false) ;" + NL + "    " + NL + "    pw_";
  protected final String TEXT_308 = ".println(optionClause_";
  protected final String TEXT_309 = ".toString());" + NL + "  " + NL + "    pw_";
  protected final String TEXT_310 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_311 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_312 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_313 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_314 = " + \"'\");" + NL + "        ";
  protected final String TEXT_315 = NL + "\t\tbw_";
  protected final String TEXT_316 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_317 = NL + "    " + NL + "    " + NL + "    ";
  protected final String TEXT_318 = NL + "        bw_";
  protected final String TEXT_319 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_320 = " + \"'\\\"\");";
  protected final String TEXT_321 = NL + "        bw_";
  protected final String TEXT_322 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_323 = " + \"\\\"\");";
  protected final String TEXT_324 = NL + "        bw_";
  protected final String TEXT_325 = ".write(\" \\\"var \" + ";
  protected final String TEXT_326 = " + \"\\\"\");";
  protected final String TEXT_327 = NL + "    pw_";
  protected final String TEXT_328 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_329 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_330 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_331 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_332 = " + \"'\");";
  protected final String TEXT_333 = NL + "        pw_";
  protected final String TEXT_334 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_335 = NL + "        bw_";
  protected final String TEXT_336 = ".write(";
  protected final String TEXT_337 = ");";
  protected final String TEXT_338 = NL + "\t\t\tpw_";
  protected final String TEXT_339 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_340 = ");" + NL + "\t\t\tpw_";
  protected final String TEXT_341 = ".println(\"INSERT\");";
  protected final String TEXT_342 = NL + "            pw_";
  protected final String TEXT_343 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_344 = ");" + NL + "            pw_";
  protected final String TEXT_345 = ".println(\"";
  protected final String TEXT_346 = "\");";
  protected final String TEXT_347 = NL + "                pw_";
  protected final String TEXT_348 = ".println(\"WHEN \" + ";
  protected final String TEXT_349 = ");";
  protected final String TEXT_350 = NL + "            bw_";
  protected final String TEXT_351 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_352 = "\");";
  protected final String TEXT_353 = NL + "            bw_";
  protected final String TEXT_354 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_355 = " + \"\\\"\");";
  protected final String TEXT_356 = NL + "                bw_";
  protected final String TEXT_357 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_358 = NL + "                bw_";
  protected final String TEXT_359 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_360 = NL + "            bw_";
  protected final String TEXT_361 = ".write(\"'\" + ";
  protected final String TEXT_362 = " + \"'\");";
  protected final String TEXT_363 = NL + "                bw_";
  protected final String TEXT_364 = ".write(\" AND '\" + ";
  protected final String TEXT_365 = " + \"'\");";
  protected final String TEXT_366 = NL + "            pw_";
  protected final String TEXT_367 = ".println(\"\");";
  protected final String TEXT_368 = NL + "            pw_";
  protected final String TEXT_369 = ".println(\"\");";
  protected final String TEXT_370 = NL + "            pw_";
  protected final String TEXT_371 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_372 = NL + "\t        pw_";
  protected final String TEXT_373 = ".println(\"";
  protected final String TEXT_374 = "\");";
  protected final String TEXT_375 = NL + "    bw_";
  protected final String TEXT_376 = ".close();" + NL + "    pw_";
  protected final String TEXT_377 = ".close();";
  protected final String TEXT_378 = NL + NL + "String command_";
  protected final String TEXT_379 = " = \"sqlldr '\" + username_";
  protected final String TEXT_380 = " + \"/\" + password_";
  protected final String TEXT_381 = " + \"@\" + serviceUrl_";
  protected final String TEXT_382 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_383 = " + \"' LOG='\" + logf_";
  protected final String TEXT_384 = " + \"'\";" + NL;
  protected final String TEXT_385 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_386 = " = conn_";
  protected final String TEXT_387 = ".createStatement();" + NL + "    stmtCreateTmp_";
  protected final String TEXT_388 = ".execute(\"";
  protected final String TEXT_389 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_390 = ".close();" + NL + "\t";
  protected final String TEXT_391 = NL + "    final Process process_";
  protected final String TEXT_392 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_393 = ");";
  protected final String TEXT_394 = NL + "\t\tjava.util.ArrayList<String> envParam_";
  protected final String TEXT_395 = "=new java.util.ArrayList<String>();" + NL + "\t\tjava.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_396 = " = System.getenv();" + NL + "\t\tfor (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_397 = ".entrySet())" + NL + "\t\t{" + NL + "\t\t   envParam_";
  protected final String TEXT_398 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "\t\t}";
  protected final String TEXT_399 = NL + "\t\tenvParam_";
  protected final String TEXT_400 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_401 = "\");";
  protected final String TEXT_402 = NL + "\t\tenvParam_";
  protected final String TEXT_403 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_404 = "\");";
  protected final String TEXT_405 = NL + "\t\t\tenvParam_";
  protected final String TEXT_406 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_407 = "\");";
  protected final String TEXT_408 = NL + "        envParam_";
  protected final String TEXT_409 = ".add(\"";
  protected final String TEXT_410 = "=";
  protected final String TEXT_411 = "\");";
  protected final String TEXT_412 = NL + "    final Process process_";
  protected final String TEXT_413 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_414 = ",envParam_";
  protected final String TEXT_415 = ".toArray(new String[0]));";
  protected final String TEXT_416 = " " + NL + "" + NL + "//System.out.println(command_";
  protected final String TEXT_417 = ");" + NL + "" + NL + "Thread normal_";
  ...
  protected final String TEXT_419 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t        ";
  protected final String TEXT_420 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_421 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_422 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_423 = "_OUTPUT\") + \"\\n\" + line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_424 = NL + "\t\t        }" + NL + "\t\t    } finally {" + NL + "\t\t         reader.close();" + NL + "\t\t    }" + NL + "\t    }catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_425 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_426 = " = new Thread() {" + NL + "    public void run() {" + NL + "\t   try {" + NL + "\t\t   java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_427 = ".getErrorStream()));" + NL + "\t\t   String line = \"\";" + NL + "\t\t   try {" + NL + "\t\t\t   while((line = reader.readLine()) != null) {" + NL + "\t\t\t   \t  globalMap.put(\"";
  protected final String TEXT_428 = "_SQLLOAD_ERROR\", \"true\");\t" + NL + "\t\t\t       ";
  protected final String TEXT_429 = NL + "\t\t\t\t\t   System.err.println(line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_430 = NL + "\t\t\t\t\t   globalMap.put(\"";
  protected final String TEXT_431 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_432 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_433 = NL + "\t\t\t   }" + NL + "\t\t    } finally {" + NL + "\t\t\t    reader.close();" + NL + "\t\t    }" + NL + "\t    } catch(java.io.IOException ioe) {" + NL + "\t\t   ioe.printStackTrace();" + NL + "        }" + NL + "\t}" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_434 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_435 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_436 = " = process_";
  protected final String TEXT_437 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_438 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_439 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_440 = "_SQLLOAD_ERROR\"))) {" + NL + "\tthrow new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_441 = "\" , globalMap);" + NL + "} " + NL + "\t" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_442 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_443 = "));" + NL + "int nb_line_data_";
  protected final String TEXT_444 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_445 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_446 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_447 = " = 0;" + NL + "" + NL + "/*\t1.get log file all lines count\t" + NL + "\t2.get \"Total logical records read\" line number from file end.\t" + NL + "\t3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_448 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_449 = " =0;//log file lines count" + NL + "//1" + NL + "boolean isEnglish_";
  protected final String TEXT_450 = " = false;" + NL + "while ((tempLine_";
  protected final String TEXT_451 = " = lr_";
  protected final String TEXT_452 = ".readLine() )!= null) {" + NL + "\tcountLines_";
  protected final String TEXT_453 = "++;" + NL + "\tif(!isEnglish_";
  protected final String TEXT_454 = " && tempLine_";
  protected final String TEXT_455 = ".contains(\"Total logical records\")){" + NL + "\t\tisEnglish_";
  protected final String TEXT_456 = " = true;" + NL + "\t}" + NL + "}" + NL + "lr_";
  protected final String TEXT_457 = ".close();" + NL + "//need new instance to readLine ." + NL + "lr_";
  protected final String TEXT_458 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_459 = "));" + NL + "if(isEnglish_";
  protected final String TEXT_460 = "){" + NL + "\tfor (int i_";
  protected final String TEXT_461 = "=0; i_";
  protected final String TEXT_462 = "<= countLines_";
  protected final String TEXT_463 = "; i_";
  protected final String TEXT_464 = "++) {" + NL + "\t\ttempLine_";
  protected final String TEXT_465 = " = lr_";
  protected final String TEXT_466 = ".readLine();" + NL + "\t\tif(tempLine_";
  protected final String TEXT_467 = ".contains(\"Rows successfully loaded\")){" + NL + "\t\t\tnb_line_inserted_";
  protected final String TEXT_468 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_469 = ".substring(0,tempLine_";
  protected final String TEXT_470 = ".indexOf(\"Rows successfully loaded\")).trim());" + NL + "\t\t}" + NL + "\t\tif(tempLine_";
  protected final String TEXT_471 = ".contains(\"Total logical records read\")){" + NL + "\t\t\tnb_line_data_";
  protected final String TEXT_472 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_473 = ".substring(tempLine_";
  protected final String TEXT_474 = ".indexOf(\":\") + 1).trim());" + NL + "\t\t}" + NL + "\t\tif(tempLine_";
  protected final String TEXT_475 = ".contains(\"Total logical records rejected\")){" + NL + "\t\t\tnb_line_bad_";
  protected final String TEXT_476 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_477 = ".substring(tempLine_";
  protected final String TEXT_478 = ".indexOf(\":\") + 1).trim());" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t}" + NL + "}else{" + NL + "//2" + NL + "for (int i_";
  protected final String TEXT_479 = "=0; i_";
  protected final String TEXT_480 = "<= countLines_";
  protected final String TEXT_481 = " - 10; i_";
  protected final String TEXT_482 = "++) {" + NL + "\tlr_";
  protected final String TEXT_483 = ".readLine();" + NL + "}" + NL + "//3.Total logical records read" + NL + "tempLine_";
  protected final String TEXT_484 = " = lr_";
  protected final String TEXT_485 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_486 = " != null) {" + NL + "\tnb_line_data_";
  protected final String TEXT_487 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_488 = ".substring(tempLine_";
  protected final String TEXT_489 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "//3.Total logical records rejected" + NL + "tempLine_";
  protected final String TEXT_490 = " = lr_";
  protected final String TEXT_491 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_492 = " != null) {" + NL + "\tnb_line_bad_";
  protected final String TEXT_493 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_494 = ".substring(tempLine_";
  protected final String TEXT_495 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "tempLine_";
  protected final String TEXT_496 = " = lr_";
  protected final String TEXT_497 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_498 = " != null) {" + NL + "\tnb_line_discarded_";
  protected final String TEXT_499 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_500 = ".substring(tempLine_";
  protected final String TEXT_501 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "\tnb_line_inserted_";
  protected final String TEXT_502 = " = nb_line_data_";
  protected final String TEXT_503 = " - nb_line_bad_";
  protected final String TEXT_504 = " - nb_line_discarded_";
  protected final String TEXT_505 = ";" + NL + "}" + NL + "lr_";
  protected final String TEXT_506 = ".close();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_507 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_508 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_509 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_510 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_511 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_512 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_513 = "_RETURN_CODE\", exitCode_";
