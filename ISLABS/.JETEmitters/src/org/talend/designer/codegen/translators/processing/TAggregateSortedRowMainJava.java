...
public class TAggregateSortedRowMainJava
{
  ...
  protected final String TEXT_827 = NL + "if(true){" + NL + "\tthrow new java.lang.Exception(\"In column ";
  ...
  protected final String TEXT_891 = "if(true){" + NL + "\tthrow new java.lang.Exception(\"In column ";
  ...
  protected final String TEXT_893 = "if(true){" + NL + "\tthrow new java.lang.Exception(\"In column ";
  ...
  protected final String TEXT_1387 = "if(true){" + NL + "\tthrow new java.lang.Exception(\"In column ";
  ...
  protected final String TEXT_1451 = "if(true){" + NL + "\tthrow new java.lang.Exception(\"In column ";
  ...
  protected final String TEXT_1453 = "if(true){" + NL + "\tthrow new java.lang.Exception(\"In column ";
