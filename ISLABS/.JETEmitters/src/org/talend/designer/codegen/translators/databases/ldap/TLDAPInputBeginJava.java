...
public class TLDAPInputBeginJava
{
  ...
  protected final String TEXT_71 = ".get(\"namingcontexts\");" + NL + "    }" + NL + "\t\tbaseDN_";
  ...
  protected final String TEXT_79 = NL + "\t\tbaseDN_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";";
  protected final String TEXT_82 = NL + "    // Set the page size and initialize the cookie that we pass back in subsequent pages" + NL + "    int pageSize_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "    byte[] cookie_";
  protected final String TEXT_85 = " = null;" + NL + "    // Request the paged results control" + NL + "    javax.naming.ldap.Control[] ctls_";
  protected final String TEXT_86 = " = new javax.naming.ldap.Control[] { new javax.naming.ldap.PagedResultsControl(pageSize_";
  protected final String TEXT_87 = ", true) };" + NL + "    ctx_";
  protected final String TEXT_88 = ".setRequestControls(ctls_";
  protected final String TEXT_89 = ");" + NL + "    " + NL + "do {";
  protected final String TEXT_90 = NL + NL + "    javax.naming.NamingEnumeration answer_";
  ...
  protected final String TEXT_97 = ");" + NL + "    while (answer_";
  protected final String TEXT_98 = " .hasMoreElements()) {//a";
  protected final String TEXT_99 = NL + "    \t\t";
  protected final String TEXT_100 = " = null;\t\t\t";
  protected final String TEXT_101 = NL + "    \t";
  protected final String TEXT_102 = "_NB_LINE++;" + NL + "    \tjavax.naming.directory.Attributes attrs_";
  protected final String TEXT_103 = " = null;";
  protected final String TEXT_104 = NL + "\t\t";
  protected final String TEXT_105 = " = new ";
  protected final String TEXT_106 = "Struct(); " + NL + "\ttry{";
  protected final String TEXT_107 = NL + NL + "            javax.naming.directory.SearchResult sr_";
  protected final String TEXT_108 = "  = (javax.naming.directory.SearchResult) answer_";
  protected final String TEXT_109 = ".next();" + NL + "    \t\tglobalMap.put(\"";
  protected final String TEXT_110 = "_RESULT_NAME\",sr_";
  protected final String TEXT_111 = ".getName());" + NL + "            attrs_";
  protected final String TEXT_112 = " = sr_";
  protected final String TEXT_113 = ".getAttributes();" + NL + "     \t\t// for output";
  protected final String TEXT_114 = "          " + NL + "        if (attrs_";
  protected final String TEXT_115 = " != null) {//b";
  protected final String TEXT_116 = NL + "\t\t\t\t\t\t\tif(attrs_";
  protected final String TEXT_117 = ".get(\"";
  protected final String TEXT_118 = "\") !=null){" + NL + "                            \t";
  protected final String TEXT_119 = ".";
  protected final String TEXT_120 = " = (byte[])attrs_";
  protected final String TEXT_121 = ".get(\"";
  protected final String TEXT_122 = "\").get();" + NL + "    \t\t\t\t\t\t} else {" + NL + "                           \t\t";
  protected final String TEXT_123 = ".";
  protected final String TEXT_124 = " = null;" + NL + "    \t\t\t\t\t\t}";
  protected final String TEXT_125 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = " = (\"\".equals(sr_";
  protected final String TEXT_128 = ".getName())?sr_";
  protected final String TEXT_129 = ".getName():(sr_";
  protected final String TEXT_130 = ".getName()+ \",\")) + baseDN_";
  protected final String TEXT_131 = ";";
  protected final String TEXT_132 = NL + "\t\t\tjavax.naming.directory.Attribute attr_";
  protected final String TEXT_133 = "_";
  protected final String TEXT_134 = " = attrs_";
  protected final String TEXT_135 = ".get(\"";
  protected final String TEXT_136 = "\");" + NL + "\t\t\tif(attr_";
  protected final String TEXT_137 = "_";
  protected final String TEXT_138 = " != null){";
  protected final String TEXT_139 = "\t\t\t" + NL + "\t\t\t\t\tList list_";
  protected final String TEXT_140 = " = new java.util.ArrayList();" + NL + "\t\t\t\t\tfor (javax.naming.NamingEnumeration e_";
  protected final String TEXT_141 = " = attr_";
  protected final String TEXT_142 = "_";
  protected final String TEXT_143 = ".getAll(); e_";
  protected final String TEXT_144 = ".hasMore();){" + NL + "    \t\t\t\t \tlist_";
  protected final String TEXT_145 = ".add(e_";
  protected final String TEXT_146 = ".next());" + NL + "    \t\t\t\t}" + NL + "    \t\t\t\t";
  protected final String TEXT_147 = ".";
  protected final String TEXT_148 = " = list_";
  protected final String TEXT_149 = ";";
  protected final String TEXT_150 = NL + "    \t\t\tStringBuilder attrStr_";
  protected final String TEXT_151 = " = new StringBuilder();" + NL + "    \t\t\tfor (javax.naming.NamingEnumeration e_";
  protected final String TEXT_152 = " = attr_";
  protected final String TEXT_153 = "_";
  protected final String TEXT_154 = ".getAll(); e_";
  protected final String TEXT_155 = ".hasMore();){" + NL + "    \t\t\t\tif(attrStr_";
  ...
  protected final String TEXT_159 = ".append(e_";
  protected final String TEXT_160 = ".next().toString());" + NL + "    \t\t\t}" + NL + "    \t\t\t";
  ...
  protected final String TEXT_166 = " = null;" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_167 = NL + "\t\t}//b" + NL + "\t} catch (java.lang.Exception e) {" + NL;
  ...
  protected final String TEXT_183 = NL + "                System.err.println(e.getMessage());";
  protected final String TEXT_184 = NL + "                ";
  protected final String TEXT_185 = " = null;";
  protected final String TEXT_186 = NL + "            \t";
  protected final String TEXT_187 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
