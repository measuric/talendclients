...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_95 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_96 = " + \":\" + ";
  protected final String TEXT_97 = " + \"/\" + ";
  protected final String TEXT_98 = ";";
  protected final String TEXT_99 = NL + "\t\t            url_";
  protected final String TEXT_100 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_101 = " + \":\" + ";
  protected final String TEXT_102 = " + \"/\" + ";
  protected final String TEXT_103 = ";";
  protected final String TEXT_104 = NL + "\t\t            url_";
  protected final String TEXT_105 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = " + \"/\" + ";
  protected final String TEXT_108 = ";";
  protected final String TEXT_109 = NL + "\t\t            url_";
  protected final String TEXT_110 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_111 = " + \":\" + ";
  protected final String TEXT_112 = " + \"/\" + ";
  protected final String TEXT_113 = ";";
  protected final String TEXT_114 = NL + "\t\t        url_";
  protected final String TEXT_115 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_116 = " + \"/\" + ";
  protected final String TEXT_117 = ";";
  protected final String TEXT_118 = NL + "\t\t\t\turl_";
  protected final String TEXT_119 = " = \"jdbc:hsqldb:mem:\" + ";
  ...
  protected final String TEXT_126 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_127 = " = null;";
  protected final String TEXT_128 = NL + "\t\t        conn_";
  protected final String TEXT_129 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_133 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_134 = " = dataSources_";
  protected final String TEXT_135 = ".get(";
  protected final String TEXT_136 = ").getConnection();" + NL + "\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_137 = "\", conn_";
  protected final String TEXT_138 = ");" + NL + "\t\t        }";
  protected final String TEXT_139 = NL + NL + "\t\t    ";
  protected final String TEXT_140 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_141 = " = ";
  protected final String TEXT_142 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_143 = "_QUERY\",dbquery_";
  protected final String TEXT_144 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_145 = " = stmt_";
  protected final String TEXT_146 = ".executeQuery(dbquery_";
  protected final String TEXT_147 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_148 = " = rs_";
  protected final String TEXT_149 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_150 = " = rsmd_";
  protected final String TEXT_151 = ".getColumnCount();" + NL;
  protected final String TEXT_152 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_153 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_154 = ".setDbmsId(\"";
  protected final String TEXT_155 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_156 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_157 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_158 = ".add(\"";
  protected final String TEXT_159 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_160 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_161 = " = ";
  protected final String TEXT_162 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_163 = "; i <= rsmd_";
  protected final String TEXT_164 = ".getColumnCount()-";
  protected final String TEXT_165 = "; i++) {" + NL + "                if (!(listSchema_";
  ...
  protected final String TEXT_204 = " = null;" + NL + "\t\t    int column_index_";
  protected final String TEXT_205 = " =1;" + NL + "\t\t    while (rs_";
  protected final String TEXT_206 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_207 = "++;" + NL + "\t\t        ";
  protected final String TEXT_208 = NL + "\t\t                        column_index_";
  protected final String TEXT_209 = " = ";
  protected final String TEXT_210 = " + dcg_";
  protected final String TEXT_211 = ".getColumnCount(); " + NL + "\t\t                    ";
  protected final String TEXT_212 = NL + "\t\t                        column_index_";
  ...
  protected final String TEXT_228 = ".getObject(column_index_";
  ...
  protected final String TEXT_232 = ".getObject(column_index_";
  ...
  protected final String TEXT_275 = ".getObject(column_index_";
