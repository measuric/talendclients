...
public class TSAPInputBeginJava
{
  ...
  protected final String TEXT_289 = ");" + NL + "\t    }catch (java.lang.Exception e_";
  ...
  protected final String TEXT_295 = ");" + NL + "\t\t}catch (java.lang.Exception e_";
  ...
  protected final String TEXT_343 = NL + "\t\t\t    \tif (true) {" + NL + "\t\t\t    \t\tthrow new java.lang.Exception(\"The connection for schema ";
  protected final String TEXT_344 = " is with problem, they must be the same name.\");" + NL + "    \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_345 = NL + "\t" + NL + "\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t    \tif (true) {" + NL + "\t\t\t    \t\tthrow new java.lang.Exception(\"Please make sure to configure the \\\"Outputs->Mapping->Schema XpathQuerys\\\" for schema ";
